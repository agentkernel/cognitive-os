...
- **[User guide](./user/README.md)** — install, first conversation, CLI, secrets,
  the Pi shell, the resource model, operations, security, limitations.
...
中文版入口：[`handbook/zh-CN/`](../zh-CN/README.md)。Machine metadata:
[`handbook/_meta/manifest.json`](../_meta/manifest.json). Dynamic project status
