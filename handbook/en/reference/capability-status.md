...
| Governed tool execution (all six registered families) | partial | all six families have a production request carrier; WorkspaceRead, WorkspaceSearch, and WorkspaceWrite/Patch dispatch through the periodic caller, while ProcessCheck and HttpFetchReadOnly stage through fail-closed carriers (no supervised-process registry / empty origin allowlist) |
