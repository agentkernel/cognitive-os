...
| `GET` | `/task/resource/v1/consumption` | task | Return the latest daemon-authored redacted Memory/Skill consumption pins for one task_ref; query_text and skill_binding_id are rejected as restatement. |
