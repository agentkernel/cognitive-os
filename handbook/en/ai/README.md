...
Machine-readable companions: [`handbook/_meta/manifest.json`](../../_meta/manifest.json)
(document inventory), [`handbook/_meta/source-map.json`](../../_meta/source-map.json)
(change → docs routing), [`handbook/_meta/source-coverage.json`](../../_meta/source-coverage.json)
