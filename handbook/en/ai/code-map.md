...
| `crates/cognitive-store` | SQLite WAL adapter: migrations v1–v24 (+installation v1–v4), scheduler leases, Memory/Skill/Context/Artifact stores, backup planning | `sqlite/`, `migration.rs`, `personal_db.rs` (`prepare_personal_databases`), `scheduler.rs` |
