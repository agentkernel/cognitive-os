...
| 受治理工具执行（全部六个已登记族） | partial | 六族都有生产请求载体；WorkspaceRead、WorkspaceSearch 与 WorkspaceWrite/Patch 经周期调用者派发，ProcessCheck 与 HttpFetchReadOnly 经 fail-closed 载体 staging（无受监督进程 registry / 空 origin 白名单） |
