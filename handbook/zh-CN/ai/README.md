...
机器可读伴侣：[`handbook/_meta/manifest.json`](../../_meta/manifest.json)（文档清单）、
[`handbook/_meta/source-map.json`](../../_meta/source-map.json)（变更 → 文档路由）、
[`handbook/_meta/source-coverage.json`](../../_meta/source-coverage.json)（全树分类），
