...
[`RFC-0001`](../../../docs/architecture/cognitiveos/RFC-0001-cognitiveos-governance-context-access.md)、
[`docs/standards/`](../../../docs/standards/normative-source-and-versioning.md)），后者又优先于 informative 白皮书
（[`docs/architecture/cognitiveos/CognitiveOS-Architecture.md`](../../../docs/architecture/cognitiveos/CognitiveOS-Architecture.md)）。不可变公理只存在于
