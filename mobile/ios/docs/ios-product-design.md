...
- 规范已登记：273 个 requirements、55 个 error codes、61 个 schemas、5 份 transition tables。
- conformance vectors：84 份，当前全局分布为 46 `pass` / 38 `not-run`；均不是 iOS 平台证据。
...
| Existing vector evidence | runner 是否真实执行既有向量 | 全局分布见 PROGRESS；iOS 平台 evidence 仍为 `none` |
...
- Canonical：[CONSOLE-IOS-V1-DEC-001](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-001)
...
- Canonical：[CONSOLE-IOS-V1-DEC-002](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-002)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-003](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-003)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-004](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-004)
...
- Canonical：[CONSOLE-IOS-V1-DEC-005](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-005)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-006](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-006)
...
- Canonical：[CONSOLE-IOS-V1-DEC-007](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-007)
...
- Canonical：[CONSOLE-IOS-V1-DEC-008](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-008)
...
- Canonical：[CONSOLE-IOS-V1-DEC-009](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-009)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-010](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-010)
...
- Canonical：[CONSOLE-IOS-V1-DEC-011](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-011)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-012](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-012)
...
- Canonical：[CONSOLE-IOS-V1-DEC-013](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-013)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-014](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-014)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-015](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-015)
- 状态：`accepted`
...
- Canonical：[CONSOLE-IOS-V1-DEC-016](../../shared/docs/mobile-platform-decision-log.md#console-ios-v1-dec-016)
- 状态：`accepted`
...
- 当前固定声明：implementation not-implemented；platform evidence none；Profile not implemented；全局向量结果不得外推为 iOS 证据。
...
所有 PoC 当前 `execution = not-run`、`evidence = none`。这些 ID 是产品计划，不是 conformance vectors。执行清单骨架：[ios-poc-runbook.md](ios-poc-runbook.md)。
...
- 当前全局 conformance 分布以 PROGRESS 为准；iOS 平台专属证据仍为 `none`。
