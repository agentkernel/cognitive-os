 ...
 * each space's redesign wave lands (Providers → W2; Tasks → W4/W5).
 * These pages intentionally keep their original styling hooks (styles.css)
...
/* ---------- Providers (verbatim from App.tsx @74eea38) ---------- */
