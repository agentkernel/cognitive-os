...
- **canonical 入口**（B2 已迁入本子树）：
  - [Console README](https://github.com/agentkernel/cognitive-os/blob/main/apps/cognitiveos-console/README.md) 与 [PRODUCT-DESIGN](https://github.com/agentkernel/cognitive-os/blob/main/apps/cognitiveos-console/PRODUCT-DESIGN.md)（兼容入口）；
