...
- **内容**：
  - 遥测/脱敏/留存政策：`telemetry-redaction-retention-policy.md`（迁移批 B4 新建，届时补链接）；
...
- **gate**：遥测提供方/驻留/retention 是未冻结产品选择（PRODUCT-DESIGN §20.2），实现受 [Console 实现 gate](../../../../docs/platforms/README.md#console-实现-gate) 阻断。
