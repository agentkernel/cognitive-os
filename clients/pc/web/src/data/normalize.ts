...
export const KNOWN_ROUTES: readonly KnownRoute[] = [
  ...
  { method: "POST", path: "/management/settings/v1/connection.connect", channel: "management" },
  { method: "GET", path: "/management/settings/v1/diagnostics", channel: "management" },
  { method: "GET", path: "/management/settings/v1/notifications", channel: "management" },
  ...
  { method: "GET", path: "/management/project/v1/assistant.status", channel: "management" },
  ...
  { method: "POST", path: "/management/project/v1/preview.narrow", channel: "management" },
  { method: "POST", path: "/management/project/v1/confirm", channel: "management" },
  { method: "POST", path: "/management/project/v1/roster.register", channel: "management" },
  { method: "POST", path: "/management/project/v1/employee.seat.request", channel: "management" },
  { method: "POST", path: "/management/project/v1/employee.seat.confirm", channel: "management" },
  { method: "GET", path: "/management/project/v1/pending-previews", channel: "management" },
  { method: "GET", path: "/management/project/v1/outputs", channel: "management" },
  { method: "GET", path: "/management/project/v1/outputs.detail", channel: "management" },
  { method: "GET", path: "/management/project/v1/outputs.open", channel: "management" },
  { method: "POST", path: "/management/project/v1/outputs.export", channel: "management" },
  { method: "POST", path: "/management/project/v1/attempt.artifact.stage-test", channel: "management" },
  { method: "POST", path: "/management/project/v1/run.acceptance.request", channel: "management" },
  { method: "GET", path: "/management/project/v1/publication.packet", channel: "management" },
  { method: "POST", path: "/management/project/v1/publication.external-send.request", channel: "management" },
  { method: "GET", path: "/management/project/v1/vault.index", channel: "management" },
  { method: "GET", path: "/management/project/v1/vault.conflicts", channel: "management" },
  { method: "POST", path: "/management/project/v1/vault.import", channel: "management" },
  { method: "POST", path: "/management/project/v1/vault.index.rebuild", channel: "management" },
  ...
  { method: "POST", path: "/management/project/v1/dsh.hosted.attempt.run", channel: "management" },
  { method: "GET", path: "/management/host/v1/status", channel: "management" },
  { method: "POST", path: "/management/host/v1/close.request", channel: "management" },
