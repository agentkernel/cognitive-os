...
>
> Agent Hub 关系：Direct Takeover 与第三方 Agent 接管是一条独立于本路线图的产品线，其里程碑/DAG/gate 在 [clients/agent-hub/docs/planning/README.md](../../agent-hub/docs/planning/README.md) 与 [clients/agent-hub/plan/agent-hub-development-plan.md](../../agent-hub/plan/agent-hub-development-plan.md)，同样受 Console/M5/平台/AGPL gate 阻断。
