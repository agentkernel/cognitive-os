...
>
> Agent Hub 关系：本文覆盖 Governed Windows v1 旅程。Direct Takeover 与第三方 Agent 接管旅程/页面在 [agent-hub/product/journeys-and-screens.md](../../../agent-hub/docs/product/journeys-and-screens.md)，使用独立 `CONSOLE-AGENTHUB-V1-JRN/PAGE-*` ID，不与本文 `CONSOLE-V2-*` 混编。
