...
>
> Agent Hub 关系：本简报聚焦 Governed（完整治理）方向。第三方 Agent 的 Direct Takeover 与两部署模式设计在 [agent-hub/product/product-design.md](../../../agent-hub/docs/product/product-design.md)，扩展而非改写本文的 persona/JTBD/边界。
