...
>
> 交付状态：`planned / implementation not-implemented / platform evidence none / Profile not implemented`
> 官方资料查询日期：2026-07-20
...
- 相关全局 conformance 分布以 PROGRESS 为准；已执行的合同/内核行为不得外推为 Linux 平台证据。
