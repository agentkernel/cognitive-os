...
- **边界**：全局 conformance 计数以 [PROGRESS](https://github.com/agentkernel/cognitive-os/blob/main/docs/plan/PROGRESS.md) 实测为准（2026-07-26：85 份 60 `pass` / 25 `not-run`），但 PC 平台端到端测试仍未执行；本目录不复制 gate 矩阵正文。
