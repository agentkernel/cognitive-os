...
>
> Agent Hub 关系：本文覆盖 Governed R0/R1 信任模型。Direct Takeover 的接管威胁模型、本机控制面、凭据与电脑控制在 [agent-hub/security/](../../../agent-hub/docs/security/)，其 `host-managed`/`*-observed` 事实来源不得升级为 authority。
