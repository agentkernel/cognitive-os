...
>
> canonical 设计在 [clients/agent-hub/docs/](../README.md)。本文只登记 **Direct Takeover 接管能力** 的跨平台差异，作为既有 [桌面 parity](../../../pc/docs/platforms/desktop-parity-matrix.md) 与 [移动 parity](../../../mobile/shared/docs/mobile-parity-matrix.md) 的补充；不改写既有平台 canonical 决策、ID 或 anchor。
...
平台事实来源见 [clients/agent-hub/docs/sources/platform-security-ledger.md](../sources/platform-security-ledger.md)。
...
移动无障碍验收见 [clients/agent-hub/docs/product/states-content-and-accessibility.md](../product/states-content-and-accessibility.md#4-跨端无障碍验收未来门禁)。
