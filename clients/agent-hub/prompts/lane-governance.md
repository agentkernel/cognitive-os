...
- canonical：[apps/cognitiveos-console/docs/agent-hub/GOVERNANCE.md](../docs/GOVERNANCE.md)、[decisions/decision-log.md](../docs/decisions/decision-log.md)
- 计划：[docs/plan/agent-hub/lane-governance.md](../plan/lane-governance.md)
