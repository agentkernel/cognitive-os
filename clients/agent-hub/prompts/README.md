...
2. 先读 canonical 文档（[apps/cognitiveos-console/docs/agent-hub/README.md](../docs/README.md)）、Master 计划（[../../plan/agent-hub-development-plan.md](../plan/agent-hub-development-plan.md)）与对应车道计划。
