...
>
> 目标：Windows 首发桌面客户端，覆盖单 Agent 全旅程与所有页面状态。设计见 [product/journeys-and-screens.md](../docs/product/journeys-and-screens.md)、[states-content-and-accessibility.md](../docs/product/states-content-and-accessibility.md)。
