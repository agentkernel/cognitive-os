...
所有任务用 [任务模板](../docs/templates/development-task.md)：ID `AH-<lane>-<seq>`，含 owner/lane/depends_on/blocked_by/允许禁止路径/交付物/失败测试/安全负例/oracle/evidence/commit/文档/handoff。
