...
>
> 目标：Open PoC 执行、发布 gate、Direct→Governed evidence-only 迁移。设计见 [relay-pairing-and-migration.md §6](../docs/architecture/relay-pairing-and-migration.md#6-direct--governed-迁移evidence-only)、[evidence-index](../docs/traceability/evidence-index.md)。
