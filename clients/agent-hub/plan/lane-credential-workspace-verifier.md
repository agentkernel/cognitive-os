...
>
> 目标：opaque credential handle、多账号 profile、worktree/workspace、固定 checks verifier。设计见 [security-and-credentials.md](../docs/security/security-and-credentials.md)、[collaboration/lead-workers.md](../docs/collaboration/lead-workers.md)。
