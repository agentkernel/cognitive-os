...
| P0-2 | Lane-CON 仓库联动 + 计数修正（原分叉分支误占 D-012；集成时由 D-019 记录改号与 61/84 对齐） | `8e1de44150c3ded0a7561fd69a7cbf1f7df89ad4` |
...
| I1 | squash 集成到远端 M5 gate 基线；保留远端 M1–M4/F-011 真相，闭合 D-019 编号/计数漂移，排除独立 personal-blog 历史 | 本集成 PR |
