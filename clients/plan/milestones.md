...
| CL-M2 macOS / Linux parity | 桌面 parity 切片 | `blocked` | 同上 + [macOS](../../docs/platforms/macos-product-design.md#13-open-poc-and-ga-gates) / [Linux](../../docs/platforms/linux-product-design.md#13-open-poc-and-ga-gates) PoC |
