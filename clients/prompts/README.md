...
- **持续开发执行**：[continuous-development-execution.md](continuous-development-execution.md)——按 [development-plan](../plan/development-plan.md) 自主推进 Phase 0–4 的委托执行提示词（2026-07-26 仓库拆分后重写：新增独立仓库环境、"本仓库当前零代码"事实、拆分遗留 5 项未决治理问题、三阶段可执行范围；gate 纪律与 PoC 豁免边界内嵌）。
