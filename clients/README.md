...
| `clients/pc/docs/` | PC | Windows v1 产品文档与 macOS/Linux 平台切片落位（B2 批迁入；canonical 正文现仍在 `apps/cognitiveos-console/docs/` 与 `docs/platforms/`） | `planned`；implementation `not-implemented`；platform tests `none` | Lane-CON | [Console README](../apps/cognitiveos-console/README.md)；[Windows v1 范围](pc/docs/platforms/windows/windows-v1-scope.md) | Console 依赖组 1/2/7、M5、真实平台 PoC、技术栈 ADR | accessibility/quality/release 缺内容子目录已有薄 README |
