...
- Status: design trace only; architecture/formal-plan/handbook reconciliation
  pending; current interaction prototype is owner-approved v9 (2026-08-30); v8 is the prior approved baseline (not overwritten); v5–v7 and archived pre-v5 / V2 are historical chrome only
