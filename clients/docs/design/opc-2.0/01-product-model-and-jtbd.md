...
- Status: current interaction prototype is post journey-subtraction
  `personal-20-opc-e2e`; archived V2 is historical chrome only
...
- A Project Member Runtime definition persists responsibility, configuration,
  grants, Conversation, Memory, and history for one Project. Members are not
  shared across Projects; only Role Runtime Templates may be reused.
