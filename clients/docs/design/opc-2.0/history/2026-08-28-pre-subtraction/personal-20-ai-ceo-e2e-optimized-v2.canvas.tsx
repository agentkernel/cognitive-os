 ...
 *
 * Working-tree alignment against current product docs (HEAD 756a5e3b, disk
 * clean 2026-08-28): Settings names Cost & Alerts and Privacy & Recovery;
 * Memory lifecycle includes promote; Operations shows the close-window
 * choice sample; Today/Projects empty CTA is Create Project.
        ...
        <section className="work-surface">
          ...
          <section className="close-window" aria-label="Close window choice sample">
            ...
            <Notice title="Choice not executable here" tone="info">
              Affected sample: X content operation · audience research occurrence. No Continue or Pause button is shown; those actions are Requires-backend.
            </Notice>
          </section>
          <Gap>
