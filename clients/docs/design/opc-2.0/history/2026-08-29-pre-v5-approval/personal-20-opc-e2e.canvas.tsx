/**
 * PERSONAL 2.0 OPC INTERACTION PROTOTYPE — archived post-subtraction source
 *
 ...
 * personal-20-opc-e2e-optimized-v5. Visual tokens and shell craft were reused
 * from archived V2 so this still looked like the same product.
 *
 * Design artifact:
 * d:\agent-kernel\clients\docs\design\opc-2.0\history\2026-08-29-pre-v5-approval\personal-20-opc-e2e.canvas.tsx
 * Cursor-openable archived copy (IDE detection path; not a second baseline):
 * C:\Users\wuron\.cursor\projects\d-agent-kernel\canvases\history\2026-08-29-pre-v5-approval\personal-20-opc-e2e.canvas.tsx
