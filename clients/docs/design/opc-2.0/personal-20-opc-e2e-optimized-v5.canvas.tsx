/**
 * PERSONAL 2.0 OPC INTERACTION PROTOTYPE — optimized v5
 *
 ...
 *
 * v5 delta: ③ current-init panel shows progress + the single current item
 * title (not all six runtime cards). Generation walks slots locally; full
 * recipe stays on the config page. v4 seating, test gate, and maintenance
 * config are unchanged. No Install/Connect; Loop/Harness are not default chrome.
 *
 * Design artifact:
 * d:\agent-kernel\clients\docs\design\opc-2.0\personal-20-opc-e2e-optimized-v5.canvas.tsx
...
export default function Personal20OpcE2eOptimizedV5() {
    ...
    <div className="opc-e2e" style={variables}>
      ...
      <header className="prototype-bar">
        <div className="prototype-title">
          <h1>Personal 2.0 · OPC 端到端原型 · v5</h1>
          <span>③ 当前初始化只显示进度与当前项标题</span>
        </div>
