...
- [macOS v1 产品设计](./macos-product-design.md)
- [Linux v1 产品设计](./linux-product-design.md)
- [iPhone-only v1 产品设计](./ios-product-design.md)
- [Android phone v1 产品设计](./android-product-design.md)
- [桌面平台 parity matrix](./desktop-parity-matrix.md)
- [移动平台 parity matrix](./mobile-parity-matrix.md)
...
3. 目标平台文档的 Open PoC 与 GA gates 使用真实 API/真实 OS 行为完成并留下可复现实测证据：
   - [macOS Open PoC 与 GA gates](./macos-product-design.md#13-open-poc-and-ga-gates)
   - [Linux Open PoC 与 GA gates](./linux-product-design.md#13-open-poc-and-ga-gates)
   - [iPhone Open PoC 与 GA gates](./ios-product-design.md#18-open-poc-与-ga-gates)
   - [Android phone Open PoC 与 GA gates](./android-product-design.md#18-open-poc-与-ga-gates)
4. 技术栈 ADR 已批准；
