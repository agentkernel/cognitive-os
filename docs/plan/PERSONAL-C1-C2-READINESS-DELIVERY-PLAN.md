...
- Status: complete (packages 1–5 product evidence; 6–9 assessment only); no evaluation campaign is active
...
- Current product task: none; P2-T37 closed via PR [#246](https://github.com/agentkernel/cognitive-os/pull/246) at
  `main@286f7538148ba0d22f496f1f44d1af46f0f44aa0`
...
| C2a-C2d public O-arm | complete (product evidence) | Public C1 Read/Search (P2-T36) and C2a Write/Patch (P2-T37) completed the authority chain. C2b reconfirms merged P2-T23 public Memory/Skill consumption/resume. C2c reconfirms merged P2-T24 Effect fault/reconciliation. C2d reconfirms P2-T14/P2-T21 terminal evidence through those public routes. No new product gap. | Packages 6–9 remain preparation/assessment; no new EVAL. | A newly preregistered B0 may be requested. |
| Pure-Pi P arm and frozen paired assets | assessment only | No new runner, corpus, broker, oracle, or campaign asset is in use. Product O-arm packages 1–5 now have supported evidence. | New EVAL activation remains owner-only. | Do not begin a live EVAL; freeze assets only under a future owner preregistration. |
| New C1/C2 campaign | assessment complete / inactive | EVAL-004 through EVAL-010 remain closed and isolated. Product O-arm is ready for a future B0 request. | No new EVAL ID, preregistration, root, port, SecretStore item, denominator, or sample is authorized by this plan. | A newly preregistered B0 may be requested. No paired benchmark, performance, Agent-benefit, Gate, release, Profile, or B01 conclusion has been produced. |
...
|---|---|---|---|---|
| 0. Navigation and ownership | complete | P2-T37 closed via PR [#246](https://github.com/agentkernel/cognitive-os/pull/246) at `main@286f7538`. Active task lease is `none`. Public Write and Patch lifecycle evidence is in the P2-T37 report. | Current revision, closed lease, report, and next action reconcile. | Packages 6–9 remain preparation/assessment only. |
...
| 10. C2 and paired-benchmark readiness | assessment complete | C1 and C2a public O-arm are merged. C2b–d reconfirm existing P2-T23/P2-T24/P2-T14/P2-T21 evidence with no new product gap. P-arm, frozen assets, and B0 fairness remain future owner-activated EVAL work. | Every section 4 package has supported evidence or an explicit preparation/assessment disposition. | A newly preregistered B0 may be requested. |
...
| 2 | C2a mutation O-arm | WorkspaceWrite/Patch carry schema-bound input and expected preimage through public authority; Intent/Effect, original-key reconcile, independent verification, and acceptance close the Task. | **Complete:** P2-T37 merged as PR [#246](https://github.com/agentkernel/cognitive-os/pull/246) at `main@286f7538`; public Write and Patch Tasks completed the full chain. |
| 3 | C2b governed session-2 | A real user path proves daemon-authorized Memory/Skill consumption and resume without forged governance state or private helper use. | **Reconfirmed (no new live cell):** merged P2-T23 PR [#222](https://github.com/agentkernel/cognitive-os/pull/222) at `main@795bfac8`. Public remember/review/forget and import/inspect/bind plus `GET /task/resource/v1/consumption`; session-2 GET resume after restart with zero restatement; forged-prompt/digest fail closed. Exact Linux `79764387`: 8/8 public consumption/resume tests including `public_session_two_resumes_from_durable_state_after_restart_without_restatement`. Report: [P2-T23](../checkpoints/20260816-personal-p2-t23-memory-skill-consumption-resume-report.md). No new product gap. |
| 4 | C2c recovery | Controlled fixture crash/OUTCOME_UNKNOWN cases query by original key, reconcile, independently verify, and then accept or honestly remain unresolved. | **Reconfirmed (no new live cell):** merged P2-T24 PR [#223](https://github.com/agentkernel/cognitive-os/pull/223) at `main@2b803e0f`. Persisted-profile original-key restart reconciles once (mutation count 1); `dispatch_before` stays Indeterminate with mutation 0; default-off/unauthorized profiles never inject. Exact Linux: `p2_t24_d02` 3/3, `fault_profile` 5/5, P2-T17 15/15. Report: [P2-T24](../checkpoints/20260816-personal-p2-t24-effect-fault-reconciliation-report.md). No new product gap. |
| 5 | C2d public closure | Public observations distinguish admission, receipt, Effect closure, verification, and daemon acceptance, and demonstrate that acceptance closes the Task. | **Reconfirmed (no new live cell):** P2-T14 daemon-authored `acceptance_decision` CAS plus `complete_task_from_persisted_verification` ([P2-T14](../checkpoints/20260813-personal-p2-t14-verified-completion-report.md)); P2-T21 `GET /task/evidence` and `admin-cli evidence` ([P2-T21](../checkpoints/20260816-personal-p2-t21-governed-candidate-terminal-evidence-report.md)); C1/C2a public O4/O5 observed `lease_acquired`, Effect stage, verification passed/current, and `ACCEPTANCE_GRANTED` on completed Tasks. No new product gap. |
| 6 | Pure-Pi P arm | A same-fixture adapter works without daemon, Extension, Task, Context, Memory, Skill, retry, cache, or verifier; its credential route is approved and secret-safe. | **Assessment only:** no live P-arm cell in this delivery. A future owner-activated EVAL must provision a new root/port/SecretStore and a secret-safe credential route. Closed EVAL roots/ports/`/12`–`/19` are not reusable. |
| 7 | Frozen paired assets | Runner, fixture corpus, oracle, redactor, analysis, reset, cleanup, command manifests, seeds, retry=0, timeout, arm order, and all digests are frozen. | **Assessment only:** no campaign samples, frozen manifests, or digest ledger were created. Freeze only under a future owner preregistration. |
| 8 | B0 fairness readiness | A fresh B0 can prove P/O equality of tool set, input bytes, workspace, oracle, Provider/model, timeout, retry=0, environment, and cleanup. | **Assessment only:** fairness observation is `not-run` until packages 6–7 exist under a new EVAL ID. Product O-arm packages 1–5 do not substitute for P/O equality. |
| 9 | New campaign readiness assessment | A non-claim assessment references all supported evidence, allocation strategy for a new root/port/SecretStore item, Provider budget, B1-B5 freezes, and cleanup. | **Complete as assessment:** a newly preregistered B0 may be requested. No paired benchmark, performance, Agent-benefit, Gate, release, Profile, or B01 conclusion has been produced. |
