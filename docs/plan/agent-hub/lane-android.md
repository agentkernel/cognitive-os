...
>
> 目标：Android phone remote companion（后于 iPhone）。设计见 [states-content-and-accessibility.md §4.3](../../../apps/cognitiveos-console/docs/agent-hub/product/states-content-and-accessibility.md#43-android-phone)。
