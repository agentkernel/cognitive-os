...
>
> 目标：Managed E2EE Relay + LAN/VPN、配对、设备身份、扩权确认、恢复。设计见 [relay-pairing-and-migration.md](../../../apps/cognitiveos-console/docs/agent-hub/architecture/relay-pairing-and-migration.md)。
