...
| P1-T08 | 可检查 Linux bundle installer 与 user service | P0-T03, P1-T01, P1-T04, P1-T06, P1-T07 | verifier、interruption、rollback 测试 | in-progress | 2026-07-28；`lane/personal-p1-t08-attestation-verifier`；`development_track: experimental-local-only`。P1-T07 已完成，依赖解除。第二个失败优先批在 `cognitive-runtime::linux_bundle` 固定 ADR-0028 的离线 Ed25519 detached signature、JCS canonical closed statement、产品拥有的 versioned keyring、revocation、strict HTTPS provenance 与 bounded regular-file inputs；staging 在写入前重新校验 artifact digest。focused WSL (`windows_wsl2_linux_guest`) attestation tests **14/14 passed**，strict Clippy 与 formatting 通过。覆盖 valid/wrong/unknown/revoked/self-selected key、signature/statement tamper、unknown/duplicate fields、non-canonical JSON/base64、manifest binding、HTTPS/userinfo/unsafe/colliding paths、post-verification artifact tamper、symlink、interruption、health rollback、prior-version/data preservation。此批不含 production signing key、release attestation、downloader、inspected installer、systemd user service、uninstall 或 Linux-native Gate；不得将本机或 fixture 结果写为 B01/Gate/Profile/release claim。 |
