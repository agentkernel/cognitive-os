...
| P8-T05 | Context compaction 与自适应预算 | P8-T01, P3-T04 | daemon-owned 会话/Context 压缩与汇总策略；预算自适应；压缩产物走 digest 绑定与显式损失记录；UCR-01 可复验收益观察 | in-progress | 2026-08-11；`lease/personal/P8-T05/context-compaction` on `personal/P8-T05-context-compaction`. D01 digest-bound compaction. |
