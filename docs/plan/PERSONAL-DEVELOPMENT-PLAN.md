...
> **状态：active（P0-T01..T07、P1-T01..T09、P2-T01..T08、P3-T01..T06、P4-T01..T06、P5-T01、P5-T02、P5-T05、P7-T01、P7-T02、P7-T03、P7-T04、P8-T01、P8-T02 已完成；P8-T04 `in-progress`；B02/B04/B05/B12 MVP `pass` under ADR-0046；B09 MVP `pass` under ADR-0047；B06/B07 仍为 non-claim observation，B08/GMVP-LINUX 正式验收尚未完成）**
> **最后更新：2026-08-11**
...
| Phase 8 - 通用 Agent 适配与设计基线 | 6 | 2 | 1 | 0 | 3 | post-1.0；沿用 B09 模式逐 agent 资格化 |
...
| P8-T04 | Harness 扩展原语：确定性 hooks 与分级加载 | P8-T01, P2-T08 | daemon-owned 生命周期拦截点（admission/pre-dispatch/post-effect/verification 事件）与 owner 可编程确定性 hooks；Skill/规则按 context 成本分级加载；hooks 不得放松任何公理边界 | in-progress | 2026-08-11；`lease/personal/P8-T04/harness-hooks` on `personal/P8-T04-harness-hooks` / Draft PR #188. D01–D03 complete; D04 acceptance/merge pending. |
