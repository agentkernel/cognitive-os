...
| Phase 5 - Agent sidecar 与 Tool 生态 | 5 | 3 | 1 | 0 | 1 | G5 / B09、B10 |
...
| P5-T03 | Post-1.0 MCP Tool adapter qualification | P2-T05, P2-T08 | MCP 不成为 authority；protocol/manifest drift、timeout、direct-bypass 测试；不阻塞 1.0 | in-progress | 2026-08-11；`lease/personal/P5-T03/mcp-tool-adapter` on `personal/P5-T03-mcp-tool-adapter`. D01 in progress: fixture manifest + transport-only initialize. |
