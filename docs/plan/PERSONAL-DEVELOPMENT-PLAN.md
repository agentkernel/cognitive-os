...
> **状态：in-progress（P7-T04 当前进行中；P0-T01..T07、P1-T01..T09、P2-T01..T07、P3-T01..T06、P4-T01..T06、P5-T01 已完成；B06/B07 仍为 non-claim observation，B09/GMVP-LINUX 正式验收尚未完成）**
> **最后更新：2026-08-10**
...
| Phase 7 - 产品化与发布 | 8 | 0 | 1 | 0 | 7 | GMVP-LINUX / G7 / RC |
| **合计** | **53** | **36** | **1** | **0** | **16** | — |
...
| P7-T04 | 完整性能 campaign 与回归地板 | P3-T06, P4-T05, P5-T05 | 模块级确定性 benchmark、阶段级真实治理耗时、B06/B07 non-claim raw observation、固定环境 A/B 非劣化、性能回归地板与可审计阈值；不把 B06/B07 升级为 Linux 1.0 硬门禁 | in-progress | `P7-T04/D01` done at `e0c8c38` with exact native Linux and required CI; `P7-T04/D02` in-progress on Draft PR #179; B06/B07 仍为观察项 |
