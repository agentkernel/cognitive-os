...
| Phase 4 - Memory 与 Skill | 6 | 3 | 1 | 0 | 2 | G4 / B08 |
...
| P4-T04 | Skill package、revision、local import 与 binding | P3-T02 | local package/revision/digest/import；Agent/Task/workspace binding；Skill 不自授权或直接成为 authority | in-progress | `P4-T04/D01` owns the daemon-private immutable local package/revision import and scope-bound eligibility baseline; public API/projection and Context/Task consumption remain separate. |
...
| `P4-T04/D03` | P4-T04 | immutable same-package revision supersession preserves exact binding pins and prevents competing replacement lineage | `P4-T04/D01` revision facts | failure-first unknown/cross-package/duplicate supersede and pinned-binding stability tests; exact native Linux focused store tests and Clippy; required Ubuntu/Windows CI; no public API/projection, Context/Task consumption, B08, Gate, release, or Profile claim |
