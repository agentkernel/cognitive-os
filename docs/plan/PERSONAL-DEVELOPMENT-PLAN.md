...
| Phase 4 - Memory 与 Skill | 6 | 2 | 1 | 0 | 3 | G4 / B08 |
...
| P4-T03 | Memory lifecycle、retention 与 forget | P4-T01 | version/update/conflict/expire/forget/tombstone/audit 可验证；派生索引可完整失效 | in-progress | `P4-T03/D01` started on 2026-08-09 under `lease/personal/P4-T03/memory-lifecycle`, branch `personal/P4-T03-memory-lifecycle`; implementation-only private forget/tombstone slice, no public contract change. |
