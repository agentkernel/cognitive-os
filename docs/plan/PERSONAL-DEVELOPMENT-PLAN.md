...
> **状态：active（P0-T01..T07、P1-T01..T09、P2-T01..T08、P3-T01..T06、P4-T01..T06、P5-T01、P5-T02、P5-T05、P7-T01、P7-T02、P7-T03、P7-T04、P8-T01、P8-T02、P8-T04、P8-T05、P8-T06 已完成；P8-T03 `in-progress`；B02/B04/B05/B12 MVP `pass` under ADR-0046；B09 MVP `pass` under ADR-0047；B06/B07 仍为 non-claim observation，B08/GMVP-LINUX 正式验收尚未完成）**
> **最后更新：2026-08-11**
...
| Phase 8 - 通用 Agent 适配与设计基线 | 6 | 5 | 1 | 0 | 0 | post-1.0；沿用 B09 模式逐 agent 资格化 |
...
| P8-T03 | 首个非 Pi Agent 适配与独立资格化 | P8-T02, P5-T05 | 选定一个主流 CLI agent 走完整 acquisition/install/activation/rollback/uninstall 生命周期与 sidecar 资格化；证据独立于 Pi；B09 模式泛化 campaign | in-progress | 2026-08-11；`lease/personal/P8-T03/non-pi-agent` on `personal/P8-T03-non-pi-agent` / Draft PR #191. Selected: OpenAI Codex CLI fixture. D01–D03 Linux through `b41f06f`; D04 acceptance. |
