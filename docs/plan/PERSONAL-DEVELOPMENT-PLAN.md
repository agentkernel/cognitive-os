...
> **状态：in-progress（P0-T01、P0-T02、P0-T04、P0-T05、P0-T07、P1-T01、P1-T02、P1-T03、P1-T04 已完成；P1-T05 in-progress；其余任务尚未开始）**
> **最后更新：2026-07-25**
...
| Phase 1 - 安装到首次对话 | 9 | 4 | 1 | 0 | 4 | G1 / B01 |
...
| P1-T05 | Readiness、status 与 doctor 应用服务 | P1-T03, P1-T04 | blocked/degraded/ready 事实区分 | in-progress | 2026-07-25 开始；分支 `lane/personal-p1-t05-readiness-doctor`。实现：`apps/kernel-server/src/personal/readiness.rs` + management-auth `GET /personal/status|readiness|doctor`；ADR-0023。单元测试覆盖 blocked/degraded/ready/redaction；进程测试 `p1_t05_personal_readiness`。本机 Windows GNU linker exit 121 不可执行 Rust 测试；验收待 CI Ubuntu/Windows-MSVC。非 G0/B01-B12/Profile。 |
