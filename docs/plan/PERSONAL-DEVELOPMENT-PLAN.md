...
| P5-T05 | B09 managed Pi + sidecar qualification | P5-T02 | 只负责 Pi + sidecar acquisition/install/registration/instance/process/lifecycle/recovery qualification；Pi 证据不资格化其他 adapter；任务完成与 B10 解耦 | in-progress | 2026-08-11；`lease/personal/P5-T05/b09-managed-pi` on `personal/P5-T05-b09-managed-pi`. D01 process-bound SidecarSession is the unique in-progress slice. B09 remains `not-run` until the formal campaign disposition. |
