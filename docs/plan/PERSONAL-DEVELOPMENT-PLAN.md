...
| Phase 3 - Context Resource Value | 6 | 2 | 1 | 0 | 3 | G3 / B03、B06、B07 |
...
| P3-T03 | 唯一 Artifact CAS | P3-T02 | filesystem CAS + authority metadata；digest/partial-write/GC/access 测试；不得建立第二 artifact store | in-progress | `P3-T03/D01` is active under `lease/personal/P3-T03/artifact-cas`; required Rust validation routes to exact-revision native Linux and required CI. |
