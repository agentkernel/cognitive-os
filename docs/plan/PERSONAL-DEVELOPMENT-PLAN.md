...
> **状态：active（P0-T01..T07、P1-T01..T09、P2-T01..T08、P3-T01..T06、P4-T01..T06、P5-T01、P5-T02、P5-T05、P7-T01、P7-T02、P7-T03、P7-T04、P8-T01、P8-T02、P8-T04 已完成；P8-T05 `in-progress`；B02/B04/B05/B12 MVP `pass` under ADR-0046；B09 MVP `pass` under ADR-0047；B06/B07 仍为 non-claim observation，B08/GMVP-LINUX 正式验收尚未完成）**
> **最后更新：2026-08-11**
...
| Phase 8 - 通用 Agent 适配与设计基线 | 6 | 3 | 1 | 0 | 2 | post-1.0；沿用 B09 模式逐 agent 资格化 |
...
| P8-T05 | Context compaction 与自适应预算 | P8-T01, P3-T04 | daemon-owned 会话/Context 压缩与汇总策略；预算自适应；压缩产物走 digest 绑定与显式损失记录；UCR-01 可复验收益观察 | in-progress | 2026-08-11；`lease/personal/P8-T05/context-compaction` on `personal/P8-T05-context-compaction` / Draft PR #189. D01 digest-bound compaction Linux at `8544b1e`; D02 adaptive budgets Linux at `0f0f65c`; D03 non-claim benefit observation in progress. |
