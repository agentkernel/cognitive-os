...
> **状态：active（P0-T01..T07、P1-T01..T09、P2-T01..T08、P3-T01..T06、P4-T01..T06、P5-T01、P5-T02、P5-T05、P7-T01、P7-T02、P7-T03、P7-T04、P8-T01 已完成；P8-T02 `in-progress`；B02/B04/B05/B12 MVP `pass` under ADR-0046；B09 MVP `pass` under ADR-0047；B06/B07 仍为 non-claim observation，B08/GMVP-LINUX 正式验收尚未完成）**
> **最后更新：2026-08-11**
...
| P8-T02 | 通用 Agent Adapter Contract 与 adapter framework 实现 | P8-T01, P5-T02 | AKP 为唯一适配协议的 adapter 能力声明/注册/生命周期实现；candidate-only 与通道隔离负例；对齐 A2A Agent Card 发现语义而不引入公网 listener；Lane-CTR 登记 `agent-adapter-manifest` 合同 | in-progress | 2026-08-11；`lease/personal/P8-T02/agent-adapter-contract` on `personal/P8-T02-agent-adapter-contract` / Draft PR #187. D01–D03 complete; D04 acceptance/merge pending. |
