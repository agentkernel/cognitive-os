...
| P5-T03 | Post-1.0 MCP Tool adapter qualification | P2-T05, P2-T08 | MCP 不成为 authority；protocol/manifest drift、timeout、direct-bypass 测试；不阻塞 1.0 | in-progress | 2026-08-11；`lease/personal/P5-T03/mcp-tool-adapter` / PR #195. D01–D03 closed at `a83bdb8` (Linux 4/4 + Clippy). D04 acceptance/closure in progress. No B10/Gate/release/Profile claim. |
