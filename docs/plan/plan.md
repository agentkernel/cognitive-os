...
- **硬门:** 适用 Phase 11 四条。
- **status:** in-progress (`P11-T11/D01`); lease `lease/personal/P11-T11/memory`; unique next = Linux `p11_t11_memory` + kernel-server p11_t11 HTTP on the pushed SHA. Claim ceiling `hypothesis`. Do not merge until Linux/CI.
