...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | EVAL-011 **closed**. P2-T32/T33/T34 **done**. P7-T07 remains blocked on B01-W prerequisites. Campaign closure does not resume development by itself |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-011` **closed** (2026-08-18). Pin `106cfcc0`. Long root `/home/hal9001/perfeval011-20260818` / daemon `48300` stopped / SecretStore `/20` cleared. Freeze **pass**. B0 C1-search **partial** (`b0-0` missing companion mjs; `b0-1` adapter `missing field parameters_digest`). Remaining C1/C2 / P-arm / B1–B5 `not-run`. Cleanup **pass**. Evaluation routing OFF. `PERSONAL-PERF-EVAL-010`, `PERSONAL-PERF-EVAL-009`, `PERSONAL-PERF-EVAL-008`, `PERSONAL-PERF-EVAL-007`, `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Final: [personal-performance-assessment-20260818-eval-011.md](../evaluation/personal-performance-assessment-20260818-eval-011.md). Preregistration: [20260818-personal-perf-eval-011-preregistration.md](../checkpoints/20260818-personal-perf-eval-011-preregistration.md). Do not reopen EVAL-004/005/006/007/008/009/010/011. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — closed; product follow-up is a new task/freeze |
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-011 **closed**; PERSONAL-PERF-EVAL-010 **closed**; PERSONAL-PERF-EVAL-009 **closed**; PERSONAL-PERF-EVAL-008 **closed**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T34 adapter unit pass ≠ real adapter C1/C2. `b0-1` skip is omitted `parameters_digest` key. Claim ceiling hypothesis/`not_reviewed` | do not reopen EVAL-004/005/006/007/008/009/010/011 |
| Active task lease | `none` | EVAL-011 lease closed 2026-08-18 | wait for an explicit owner delivery instruction before claiming any implementation task |
...
| `P2-T34/D03` | `done` | Merged PR [#241](https://github.com/agentkernel/cognitive-os/pull/241) at `main@106cfcc0`. CI `32088236313` Ubuntu+Windows SUCCESS at `5d91713b`. linux-002 adapter protocol 17/17 + Clippy + fmt at `a60ceed5`. Stub ≠ C1/C2 | retain closure; EVAL-011 measured omitted-key skip and is closed |
