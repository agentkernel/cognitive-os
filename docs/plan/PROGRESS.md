...
| Active task lease | `none` | `PERSONAL-PERF-EVAL-004` closed 2026-08-17 after remaining required cells; evaluation lease released | do not claim a development task until a fresh owner delivery instruction |
