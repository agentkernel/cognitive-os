...
| Active task lease | `lease/personal/P2-T29/c1-c2-enablement` | Owner 2026-08-17 delivery after EVAL-004 closure. Draft PR [#230](https://github.com/agentkernel/cognitive-os/pull/230). `df39b49c` Ubuntu `31998669185` failed `-D warnings` dead_code on test-only `ResourceApi::new`; `#[cfg(test)]` fix in flight | re-push, Ubuntu supporting CI, exact-revision `DEV-LINUX-NATIVE-01` |
