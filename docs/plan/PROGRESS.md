...
| Active task lease | `lease/personal/P2-T17/a7-unknown-outcome-observation` | P2-T17 implementation is on `personal/P2-T17-a7-unknown-outcome-observation` at `b122cce1`, Draft PR #212. Exact native Linux focused suite 10/10 plus Clippy/fmt at that revision. P2-T13 is merged on `main`; P2-T14 remains a separate completion-authority dependency and is not modified | required CI on Draft PR #212; keep Draft until P2-T14 and any carrier dependency are on `main` |
