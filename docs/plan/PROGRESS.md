...
| Active task lease | `lease/personal/EVAL-005/c1-c2-paired-freeze` | Owner-directed `PERSONAL-PERF-EVAL-005` after P2-T29 merge. Measurement-only. Writable: `docs/evaluation/`, EVAL-005 preregistration, `docs/plan/PROGRESS.md`. Guest `/home/hal9001/perfeval005-20260817`; daemon `48288`; SecretStore `/14`; do not reuse EVAL-004 `perfeval004`, `48286`/`48386`, or items `/12`/`/13` | adapter frozen; two B0 C1-search O-arm samples retained in `DRAFT`; next capture private-candidate skip or disposition remaining C1/C2 paired `not-run` |
