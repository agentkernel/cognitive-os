...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | P2-T31 merged. Next owner-authorized step is EVAL-007 C1/C2 re-measure. P7-T07 remains blocked on B01-W prerequisites |
...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | EVAL-006 B0 partial on live-daemon skip. P2-T31 merged at `main@da6fca2e`. Do not reuse EVAL-004/005/006 roots, ports, or SecretStore `/12`/`/13`/`/14`/`/15`. Claim ceiling hypothesis/`not_reviewed` | next: EVAL-007 freeze (new root/port/SecretStore) |
| Active task lease | `none` | P2-T31 closed | next: EVAL-007 C1/C2 paired freeze (new root/port/SecretStore); do not reuse EVAL-004/005/006 assets |
