...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | continue `P7-T02/D02` on `personal/P7-T02-lifecycle-backup` |
| Active task lease | `lease/personal/P7-T02/lifecycle-backup` | P7-T02 owns personal_backup/store lib + plan/checkpoint paths on Draft PR #185. | validate D02 on exact native Linux; then enter D03 restore preflight |
...
| P7-T02 Transactional lifecycle, Memory/Skill backup/restore | `in-progress` | `lease/personal/P7-T02/lifecycle-backup` on `personal/P7-T02-lifecycle-backup` / Draft PR #185. D01 done (Linux 3/3 + Clippy at `8750666`, required CI `31430152517`). D02 digest-bound Memory/Skill/bindings export planner implemented; Linux validation pending. | exact native Linux `personal_backup` + Clippy for D02; then D03 |
...
slice `P7-T02/D02`. Formal task completion remains independent from every
...
| `P7-T02/D02` | `in-progress` | digest-bound Memory/Skill/bindings export over D01 inventory; secret-contamination and missing-binding negatives added | exact native Linux focused `personal_backup` + Clippy; then required CI |
