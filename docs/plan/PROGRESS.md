...
| `P2-T37/D02` | `in-progress` | Public launcher and Extension mapping now expose WorkspaceWrite/Patch beside C1 tools without granting Pi-native filesystem/process tools. Required CI `32272661185` failed on a stale two-tool allowlist assertion. | Repair that assertion, push, then run separate fresh public WorkspaceWrite and WorkspacePatch Tasks on exact native Linux. |
