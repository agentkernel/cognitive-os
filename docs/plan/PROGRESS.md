...
| Active task lease | `lease/personal/EVAL-013/execution-plan-b0` | `PERSONAL-PERF-EVAL-013` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | B0 C2a Write/Patch O then P; then C2b–d |
