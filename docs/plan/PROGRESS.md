...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | Execute P9-T08/D02 (package 6 P-arm broker + equivalent Workspace* fixture adapter) on `DEV-LINUX-NATIVE-01`. Do not activate EVAL-012. Do not auto-resume unrelated backlog. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | C1/C2 readiness delivery **reopened / incomplete** (2026-08-20 owner instruction) under [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). This is **not** an EVAL ID. Packages 1–5 remain historical O-arm product evidence. Packages 6–14 are remaining **readiness delivery**. Packages 15–17 are the future measurement campaign. `PERSONAL-PERF-EVAL-012` is **reserved, not active**. Evaluation routing OFF. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Amendment: [20260820-personal-c1-c2-readiness-programme-amendment.md](../checkpoints/20260820-personal-c1-c2-readiness-programme-amendment.md). Prior assessment (superseded as a completion claim): [20260820-personal-c1-c2-readiness-delivery-assessment.md](../checkpoints/20260820-personal-c1-c2-readiness-delivery-assessment.md). Do not reopen EVAL-004/005/006/007/008/009/010/011. Do not reuse those roots, ports `48286`–`48298` / `48386`–`48398` / `48383`, SecretStore `/12`–`/19`, or P2-T37 roots `p2-t37-c2a-write-20260820` / `p2-t37-c2a-patch-20260820`. Claim ceiling `hypothesis`; `not_reviewed` | unique next action: P9-T08/D02 package 6 P-arm delivery. Do not start B01 samples. |
...
| Active task lease | `lease/personal/P9-T08/c1-c2-paired-readiness` | P9-T08/D01 on `personal/P9-T08-c1-c2-paired-readiness`. Writable: the readiness plan, formal plan, personal-trace, PROGRESS Current snapshot, amendment/running checkpoints, and `tools/personal/c1-c2-paired/`. | heartbeat; execute D02 after D01 is durable |
...
|---|---|---|---|
| `P9-T08/D01` | `in-progress` | Owner 2026-08-20 instruction: packages 6–8 as assessment-only and “may request B0” are insufficient. Amended programme requires real P-arm, freeze, fairness checker, B01 procedure, rewritten C1/C2 gates, secret bind runbook, environment-checklist exit, housekeeping, and EVAL scaffolding before any sample. | Durable D01 docs, then execute D02 package 6. No EVAL activation. |
| `P9-T08/D02` | `ready` | not started | after D01: secret-safe pure-Pi broker + equivalent Workspace* fixture adapter on non-B01 Linux |
