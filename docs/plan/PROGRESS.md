...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | EVAL-011 **active** (C1/C2 freeze at `main@106cfcc0` after P2-T34). P2-T32/T33/T34 **done**. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-011` **active** (2026-08-18). Pin `106cfcc0` (`main` after P2-T34). Long root `/home/hal9001/perfeval011-20260818` / daemon `48300` pid 291495 / SecretStore `/20`. Freeze **pass**. B0 C1-search `b0-0` **partial** (missing `private_candidate_provider.mjs`). Evaluation routing ON. `PERSONAL-PERF-EVAL-010`, `PERSONAL-PERF-EVAL-009`, `PERSONAL-PERF-EVAL-008`, `PERSONAL-PERF-EVAL-007`, `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260818-personal-perf-eval-011-preregistration.md](../checkpoints/20260818-personal-perf-eval-011-preregistration.md). Running report: [personal-performance-assessment-20260818-eval-011.md](../evaluation/personal-performance-assessment-20260818-eval-011.md). Do not reopen EVAL-004/005/006/007/008/009/010. Do not reuse those roots, ports `48286`/`48288`/`48290`/`48292`/`48294`/`48296`/`48298`/`48386`/`48388`/`48390`/`48392`/`48394`/`48396`/`48398`, or SecretStore `/12`–`/19`. Claim ceiling `hypothesis`; `not_reviewed` | copy `private_candidate_provider.mjs` onto the EVAL-011 root; then B0 C1-search `b0-1`; do not retry `b0-0` |
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-011 **active**; PERSONAL-PERF-EVAL-010 **closed**; PERSONAL-PERF-EVAL-009 **closed**; PERSONAL-PERF-EVAL-008 **closed**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T34 adapter unit pass ≠ real adapter C1/C2. Claim ceiling hypothesis/`not_reviewed` | copy missing O-arm companion mjs; B0 C1-search `b0-1`; do not reuse EVAL-004/005/006/007/008/009/010 runtime |
| Active task lease | `lease/personal/EVAL-011/c1-c2-paired-freeze` | `PERSONAL-PERF-EVAL-011` C1/C2 paired freeze after P2-T34; branch `evaluation/EVAL-011-freeze` | copy `private_candidate_provider.mjs`; B0 C1-search `b0-1` on `127.0.0.1:48300` |
...
| Benchmark readiness product train | `P2-T21` **done** … `P2-T34` **done** (`main@106cfcc0`) | Public launcher + stub Workspace* on a long root leaves DRAFT and acquires a lease. EVAL-010 measured the digest skip; P2-T34 recomputes JSON-fallback digests. Claim ceiling `hypothesis` | EVAL-011 B0 C1-search `b0-1` after companion mjs copy; no Gate/B01 promotion |
...
| P2-T34 Private-candidate parameters digest | **done** | Merged PR [#241](https://github.com/agentkernel/cognitive-os/pull/241) at `main@106cfcc0`. JSON-fallback recomputes digest from parameters, including empty digest. linux-002 at `a60ceed5`: protocol **17/17**, Clippy `-D warnings`, fmt. CI `32088236313` Ubuntu+Windows SUCCESS at `5d91713b`. Claim ceiling `hypothesis`. Stub ≠ real adapter. | retain closure; C1/C2 真机 is EVAL-011 |
...
| `P2-T34/D03` | `done` | Merged PR [#241](https://github.com/agentkernel/cognitive-os/pull/241) at `main@106cfcc0`. CI `32088236313` Ubuntu+Windows SUCCESS at `5d91713b`. linux-002 adapter protocol 17/17 + Clippy + fmt at `a60ceed5`. Stub ≠ C1/C2 | retain closure; EVAL-011 is the next freeze |
