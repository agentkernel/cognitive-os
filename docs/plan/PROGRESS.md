...
| Active task lease | `none` | P2-T14 lease closed after PR [#217](https://github.com/agentkernel/cognitive-os/pull/217) merged; the closed row is archived in Parallel Lanes. No active formal task; remaining work continues through separately owned branches/leases | retain P2-T14 closure evidence; select the next ready Personal task |
