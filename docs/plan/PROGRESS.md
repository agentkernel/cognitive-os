...
| Active task lease | `none` | P4-T03 merged and its lease is closed; no task currently owns writable implementation paths | select the next unblocked, implementation-ready Personal task and claim a non-overlapping lease |
