...
| `EVAL-012/B0` | `in-progress` | Owner activated `PERSONAL-PERF-EVAL-012`. Lease `lease/personal/EVAL-012/c1-c2-paired-b0` on `evaluation/EVAL-012-freeze`. Product pin `370b26fc`. Guest identity/freeze/Pi pin/E9/doctor **pass**. SecretStore `/24`. Daemon `48300` pid 326605. No B0 sample started. | Run B0 C1 O-arm (3 warmups + counted seed `sha256:a194b2f561562663`) |
