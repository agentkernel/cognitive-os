...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0 C0 qualification **pass** (9/9 retained, 7/9 oracle both arms; G6/G9 both-fail). SecretStore `/12`, Pi `0.81.1`, broker `48386` pid 201300. C1/C2 fixtures `not-run`. Claim ceiling hypothesis/non-claim. Old `48284`/`48181`/`48383` untouched | freeze C1/C2 fixtures or keep `not-run`; B1 forbidden while reviewer `not_reviewed` |
