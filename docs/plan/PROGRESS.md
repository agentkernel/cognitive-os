...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | continue `P7-T03/D01` on `personal/P7-T03-six-resource-doctor` |
| Active task lease | `lease/personal/P7-T03/six-resource-doctor` | P7-T03 owns personal six-resource doctor + plan/checkpoint paths on Draft PR (pending). | validate D01 on exact native Linux; continue D02 while CI runs |
...
| P7-T03 Six-resource doctor, headless vault, sidecar/process/effect support | `in-progress` | `lease/personal/P7-T03/six-resource-doctor` on `personal/P7-T03-six-resource-doctor`. D01 redacted six-resource doctor health wired into `/personal/doctor`. | exact native Linux focused tests + Clippy; then D02 |
...
`P7-T02` is `done` (PR #185 merged). `P7-T03` is `in-progress` with unique
slice `P7-T03/D01`. Formal task completion remains independent from every
...
| `P7-T03/D01` | `in-progress` | redacted six-resource doctor health on `/personal/doctor`; secret/authority-claim negatives | exact native Linux focused tests + Clippy; required CI |
| `P7-T03/D02` | `ready` | not started | waits for D01 |
| `P7-T03/D03` | `ready` | not started | waits for D02 |
| `P7-T03/D04` | `ready` | not started | waits for D03; final acceptance |
