...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | EVAL-009 **closed**. EVAL-008 **closed**. P2-T33 **in-progress** (lease closed; pending Windows merge of PR [#240](https://github.com/agentkernel/cognitive-os/pull/240) at product pin `289eebad`). P2-T32 remains in-progress pending Windows merge (lease already closed). P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-009` **closed** (2026-08-18). Same pin `fb85cfff` as EVAL-008; short root `/home/hal9001/e009` / daemon `48296`. UNIX_PATH_MAX hypothesis **confirmed** (socket created). B0 C1-search **partial** (`private_pi_candidate_adapter_rejected_the_request`; Task `DRAFT`; `lease_acquired` 0; real adapter spawned). Evaluation routing OFF. `PERSONAL-PERF-EVAL-008`, `PERSONAL-PERF-EVAL-007`, `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260818-personal-perf-eval-009-preregistration.md](../checkpoints/20260818-personal-perf-eval-009-preregistration.md). Final: [personal-performance-assessment-20260818-eval-009.md](../evaluation/personal-performance-assessment-20260818-eval-009.md). Do not reopen EVAL-004/005/006/007/008/009. Do not reuse those roots, ports `48286`/`48288`/`48290`/`48292`/`48294`/`48296`/`48386`/`48388`/`48390`/`48392`/`48394`/`48396`, or SecretStore `/12`–`/18`. Claim ceiling `hypothesis`; `not_reviewed` | next measurement is a new EVAL freeze after this P2-T33 lease close; do not reopen EVAL-009 |
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-009 **closed**; PERSONAL-PERF-EVAL-008 **closed**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T33 stub pass ≠ real adapter C1/C2. Product pin `289eebad` binds short completion sockets and retains redacted adapter stderr. Claim ceiling hypothesis/`not_reviewed` | do not reuse EVAL-004/005/006/007/008/009 assets |
| Active task lease | `none` | P2-T33 lease closed 2026-08-18 so a new EVAL freeze can own `PROGRESS.md`; task remains in-progress pending Windows merge of PR [#240](https://github.com/agentkernel/cognitive-os/pull/240) | claim EVAL-010 on `evaluation/EVAL-010-freeze` at pin `289eebad` |
...
| Benchmark readiness product train | `P2-T21` **done** … `P2-T31` **done**; `P2-T32` **in-progress** (lease closed) at `fb85cfff` / PR [#239](https://github.com/agentkernel/cognitive-os/pull/239); `P2-T33` **in-progress** (lease closed) at `289eebad` / PR [#240](https://github.com/agentkernel/cognitive-os/pull/240) | Public launcher + stub Workspace* on a long root leaves DRAFT and acquires a lease (linux-002 + Ubuntu). Real adapter C1/C2 is EVAL-010. Claim ceiling `hypothesis` | EVAL-010 freeze at pin `289eebad`; P2-T32/T33 Windows required-ci is merge-only; no Gate/B01 promotion |
