...
| Active task lease | `lease/personal/P2-T31/live-daemon-scheduler-lease` | P2-T31 live `kernel-server` HTTP admit → scheduler lease; branch `personal/P2-T31-live-daemon-scheduler-lease` | D03: linux-002 at `5d073398` focused 1/1, fmt, bins 337/337; workspace/Clippy + Ubuntu CI then ready/merge |
...
| `P2-T31/D03` | `in-progress` | exact-revision linux-002 at `5d073398`: focused 1/1, fmt **pass**; bin/workspace/Clippy running | finish bin, workspace, Clippy `-D warnings`; Ubuntu CI; then ready/merge |
