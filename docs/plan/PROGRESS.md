...
| Active task lease | `lease/personal/P2-T03/scheduler-runtime-closure` | The dedicated P2-T03 task branch owns only the final acceptance mapping, closure evidence, and task-status reconciliation paths. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | complete P2-T03's full acceptance mapping, required delivery checks, and task closure |
