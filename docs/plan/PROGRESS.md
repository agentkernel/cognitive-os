...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-010` **active**. EVAL-009 **closed**. EVAL-008 **closed**. P2-T33 remains in-progress pending Windows merge (lease already closed). P2-T32 remains in-progress pending Windows merge (lease already closed). P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-010` **active** (2026-08-18). Pin `289eebad` (P2-T33 host path). Long root `/home/hal9001/perfeval010-20260818` / daemon `48298` / SecretStore `/19`. Measurement-only. Evaluation routing ON. `PERSONAL-PERF-EVAL-009`, `PERSONAL-PERF-EVAL-008`, `PERSONAL-PERF-EVAL-007`, `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260818-personal-perf-eval-010-preregistration.md](../checkpoints/20260818-personal-perf-eval-010-preregistration.md). Running: [personal-performance-assessment-20260818-eval-010.md](../evaluation/personal-performance-assessment-20260818-eval-010.md). Do not reopen EVAL-004/005/006/007/008/009. Do not reuse those roots, ports `48286`/`48288`/`48290`/`48292`/`48294`/`48296`/`48386`/`48388`/`48390`/`48392`/`48394`/`48396`, or SecretStore `/12`–`/18`. Claim ceiling `hypothesis`; `not_reviewed` | freeze exact `289eebad` onto the new long root and run B0 C1 WorkspaceSearch O-arm |
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-010 **active**; PERSONAL-PERF-EVAL-009 **closed**; PERSONAL-PERF-EVAL-008 **closed**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T33 stub pass ≠ real adapter C1/C2. Long-root freeze tests the UNIX_PATH_MAX product fix. Claim ceiling hypothesis/`not_reviewed` | do not reuse EVAL-004/005/006/007/008/009 assets |
| Active task lease | `lease/personal/EVAL-010/c1-c2-paired-freeze` | PERSONAL-PERF-EVAL-010 C1/C2 paired freeze after P2-T33; branch `evaluation/EVAL-010-freeze` | freeze binaries at `289eebad` then B0 C1-search |
