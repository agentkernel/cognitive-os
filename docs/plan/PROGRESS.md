...
| `P2-T03/D05` | `ready` | D03/D04 durable binding and fenced closure exits are done; no BoundedHarness worker/recovery evidence exists yet | start the scheduler-to-BoundedHarness worker/recovery vertical slice; no additional helper-only slice |
