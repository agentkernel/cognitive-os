...
| Active task lease | `lease/personal/P8-T15/dsh-native-web-panel` on `personal/P8-T15-dsh-native-web-panel` @ `14aadf27` | Writable: admin-cli dsh + client, dsh-akp-adapter scripts, kernel-server apply/remap + scheduler recovery, plan/PROGRESS, P8-T15 checkpoint, mapped handbook. Clients Apply is PR #4 (separate repo). | linux-002 daemon **499615** `:48681`; Cos `:3080` Flash overlay. Do not auto-claim P6 / P7-T06 / P7-T07 |
| P8-T15 Native dsh Web UI | **in-progress** | D04 routing+overlay **pass** at `14aadf27`: leftover grok-on-DeepSeek Path B is Cos 400 `PERSONAL_PROVIDER_BINDING_MISMATCH` (not DeepSeek allowlist). Native settings/patch overlay Cos model+catalog. Flash Path B **200** pong. No grok-capable Cos account. Report: [P8-T15 report](../checkpoints/20260823-personal-p8-t15-dsh-native-web-panel-report.md). Claim ceiling `hypothesis`. | Owner adds grok-capable account then bind+Apply; or accept settings/patch overlay as Models proof. Keep **499615**. Do not auto-claim P6 / P7-T06 / P7-T07 |
