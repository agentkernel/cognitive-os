...
| Active task lease | `none` | The 2026-08-13 EVAL-20260813 performance-evaluation-002-recovery lease closed with the phase-3 recovery and B5 8 h closure records and is archived in the [Parallel Lanes](PARALLEL-LANES.md) closed table. All earlier `PERSONAL-PERF-EVAL-002` leases remain closed; P7-T07 remains blocked on B01-W prerequisites | awaiting a fresh owner delivery instruction; do not auto-claim `P*-T*` work from campaign closure |
