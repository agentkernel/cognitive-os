...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-012` **closed**. `P2-T38`, `P9-T09`, and `P9-T10` **done**. **P9-T11/D03** required CI and ready/merge. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-012` **closed** (2026-08-20) on `evaluation/EVAL-012-freeze` @ `177669b7`. Evaluation routing OFF. B0 fairness **fail** (`system_task_prompt_bytes`) blocked B1/B2. C2a O Patch fail retained. Cleanup **pass**. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Report and freeze live on `evaluation/EVAL-012-freeze` (`docs/evaluation/personal-performance-assessment-20260820-eval-012.md`, `docs/checkpoints/20260820-personal-perf-eval-012-preregistration.md`). Product pin `370b26fcc05976c7c1c97e5510a99ed3ebc23f2c`. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — product follow-up is P9-T11 |
| Owner-directed C1/C2 campaign | `PERSONAL-PERF-EVAL-012` closed. B0 did not pass fairness. C1 O/P and C2a Write ran; C2a Patch O fail retained. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | P9-T11 comparable C2a Patch unified-diff; do not reopen EVAL-012 |
| Active task lease | `lease/personal/P9-T11/c2a-patch-unified-diff` | unique in-progress slice `P9-T11/D03`; evaluation routing OFF | required CI then ready/merge of the P9-T11 Draft PR |
| Benchmark readiness product train | `P2-T21` … `P2-T38` **done**; **P9-T08 done**; **P9-T09 done**; **P9-T10 done**; **P9-T11 D01–D02 done / D03 in-progress**; `PERSONAL-PERF-EVAL-012` **closed** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Packages 1–14 delivered. P-arm WorkspacePatch now applies the same unified-diff payload as O-arm. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | close P9-T11; do not activate a new EVAL until after closure |
| P9-T11 Comparable C2a Patch unified-diff | **in-progress** (`P9-T11/D03`) | Branch `personal/P9-T11-c2a-patch-unified-diff`. Lease `lease/personal/P9-T11/c2a-patch-unified-diff`. Local `c1_c2_paired_p_arm` **19/19**. Replacement bytes refused; frozen C2a unified diff reaches the oracle. Running report: [P9-T11 validation](../checkpoints/20260820-personal-p9-t11-c2a-patch-unified-diff-report.md). | required CI, then ready/merge/lease/branch/main |
...
| `P9-T11/D03` | `in-progress` | Local tests **19/19**. Running report: [P9-T11 validation](../checkpoints/20260820-personal-p9-t11-c2a-patch-unified-diff-report.md). | required CI, then ready/merge/lease/branch/main |
