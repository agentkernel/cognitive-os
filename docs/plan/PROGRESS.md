...
| `P3-T06/D01` | `done` | At `afffb24072c78dc2f93958bc14e164f2681aea95`, a deterministic non-claim evaluator accepts only complete authorized/current/required-source/no-false-completion observations and rejects authority-shaped fields. Focused Node tests, consistency, and required Ubuntu/Windows CI passed; native Linux validation was not run because the host could not acquire the exact revision from GitHub. | P3-T06 remains blocked pending a formal supported B03 campaign; D01 cannot set B03 state |
