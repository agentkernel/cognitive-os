...
| Benchmark readiness product train | `P2-T21` … `P2-T35` **done** (`main@9cefd92c`); `P2-T36` **in-progress** | The durable navigation is [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). EVAL-010 proves only the real-adapter C1 Search sample stayed `DRAFT`; P2-T34/T35 unit and CI evidence is not an end-to-end C1 claim. P2-T36 adds the minimal C1 public product path without opening a campaign or touching B01. Claim ceiling `hypothesis` | complete C1 WorkspaceRead/Search real-Pi production path and supported non-B01 Linux validation |
