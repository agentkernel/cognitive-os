...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **paused before B1; evaluation lease closed** | B0 target and runtime readiness were qualified without any B1/B2/B3/B4 sample. The campaign discovered a product gap: the private candidate carrier persists only parameters_digest, while the production WorkspaceSearch/WorkspaceWrite/WorkspacePatch router requires canonical governed parameters. EVAL-002 remains closed and unchanged; claim ceiling remains hypothesis/non-claim | P2-T26 D01+D02 authored on `personal/P2-T26-bounded-os-observation`. EVAL-004 re-freeze only after BR-02..BR-08 are merged; no prior campaign asset or SecretStore entry is reused |
| Benchmark readiness product train | `P2-T21` **done** at `5d1f5c2643d82807eb96f2c615d460dbdca749c3` / PR #220; `P2-T22` **done** at `03bc530d692649a00efa7918bfeadddf8ba0ebea` / PR [#221](https://github.com/agentkernel/cognitive-os/pull/221); `P2-T23` **done** at `795bfac8d8ee77b1b3be4137d33399fc817d20eb` / PR [#222](https://github.com/agentkernel/cognitive-os/pull/222); `P2-T24` **done** at `2b803e0fb955d03374e10569b4d9aecd0b4162d7` / PR [#223](https://github.com/agentkernel/cognitive-os/pull/223); `P2-T25` **done** at `4b10db9a64584bda42ae249bd1df289475bd6324` / PR [#224](https://github.com/agentkernel/cognitive-os/pull/224); `P2-T26` D03 recorded at `e083b259` / Draft PR [#225](https://github.com/agentkernel/cognitive-os/pull/225); `P2-T27..P2-T28` registered and not started | Owner instruction 2026-08-15 approved BR-01..BR-08 and the Linux-only product-validation route. Ubuntu is supporting CI; exact pushed-revision `DEV-LINUX-NATIVE-01` is required acceptance evidence for these product tasks; `B01-Desktop-Linux-002` remains owner-directed EVAL-004-only. Windows is `not-run by owner-directed Linux-only route`. This is product implementation evidence only, not EVAL/Gate/release/Profile/B01 evidence | push P2-T26 Draft PR and Ubuntu supporting CI. EVAL-004 re-freeze happens only after every BR product task is merged |
...
| Active task lease | `lease/personal/P2-T26/bounded-os-observation` | P2-T25 merged via PR #224 at `main@4b10db9a`. P2-T26 D03 matrix recorded at `e083b259` on Draft PR [#225](https://github.com/agentkernel/cognitive-os/pull/225). Unique in-progress slice `P2-T26/D03`. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched (EVAL-004-only) | ready/merge PR #225 after the D03 report head is on CI |
...
| P2-T26 Bounded OS observation plane | **in-progress** | D03 matrix recorded at `e083b259` on Draft PR [#225](https://github.com/agentkernel/cognitive-os/pull/225): Ubuntu `31934786837` green; `DEV-LINUX-NATIVE-01` observation 27/27, HTTP 1/1, P2-T17 15/15, bins 329/329, workspace 0-failed, Clippy `-D warnings`, fmt. Claim ceiling `hypothesis`; no Gate/release/Profile/B01/EVAL promotion | ready/merge PR #225 |
...
| `P2-T26/D03` | `in-progress` | Exact-revision `DEV-LINUX-NATIVE-01` at `e083b259`: observation 27/27, HTTP 1/1, P2-T17 15/15, bins 329/329, workspace 0-failed, Clippy `-D warnings`, fmt. Ubuntu `31934786837` green. Residue `/tmp/cos-p2t26-*` removed. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched | ready/merge PR #225 |
| `P2-T27/D01` | `ready` | Registered formal slice; implementation has not started | waits for P2-T26 closure and its own task lease |
