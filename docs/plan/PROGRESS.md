...
| Active task lease | `lease/personal/P8-T15/dsh-native-web-panel` on `personal/P8-T15-dsh-native-web-panel` | Writable: admin-cli dsh + client, dsh-akp-adapter scripts, kernel-server dsh apply/remap, plan/PROGRESS, P8-T15 checkpoint, mapped handbook. Not P7-T05 SPA/clients. | linux-002: Cos dsh web **492396/492382** `:3080`, daemon **465376** `:48681`. D04 apply/remap. Do not auto-claim P6 / P7-T06 / P7-T07 |
| P8-T15 Native dsh Web UI | **in-progress** | D04: Path B remaps native catalog ids to the Cos dsh binding; `op=apply`; CLI `cognitive dsh apply`; SPA Apply button in clients. D02 Cos panel **pass**. Report: [P8-T15 report](../checkpoints/20260823-personal-p8-t15-dsh-native-web-panel-report.md). Claim ceiling `hypothesis`. | linux-002: push, replace daemon, Apply grok, Path B probe, Flash regression. Do not auto-claim P6 / P7-T06 / P7-T07 |
...
| `P8-T15/D04` | `in-progress` | Apply Cos dsh binding to running web: Path B remaps request model to the dsh binding; `POST /personal/dsh/runtime` `op=apply`; CLI `cognitive dsh apply`; SPA Apply button. | linux-002: replace daemon with this HEAD, Apply grok, Path B probe, Flash regression. Do not auto-claim P6 / P7-T06 / P7-T07 |
