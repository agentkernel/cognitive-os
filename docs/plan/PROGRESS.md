...
| `P2-T37/D03` | `in-progress` | D02 public Write/Patch evidence is in the running report. Clippy `expect_used` on the production-sink fixture test is the remaining CI repair. | Required CI green on the merge HEAD, then ready/merge #246 and lease/branch/main closure. |
