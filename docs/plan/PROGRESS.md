...
| Active task lease | `none` | EVAL-006 closed; evaluation routing OFF | claim the next ready Personal task (live-daemon C1/C2 scheduler skip); do not collide with P2-T29/T30 |
