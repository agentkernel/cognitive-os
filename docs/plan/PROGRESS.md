...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0/B1/B2 C0 **pass**. UJ3/T-GOV/B4 local **pass**; MS-AUTH **partial**; B3 **partial**; B5 1 h/8 h **pass**; B5 24 h **`not-run`**. UJ4 **pass** (30/30 admitted, 0 completions). T2 **pass** (65/65). UJ3 task-channel watch **partial** (20/20 HTTP 403). C1/C2 paired adapter `not-run`. Claim ceiling hypothesis/non-claim | UJ2 cold with `--bind`, then UJ6/cleanup |
