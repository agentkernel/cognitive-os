...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-012` and `PERSONAL-PERF-EVAL-013` **closed**. `P9-T12` **done**. Do not reopen EVAL-012/013. Do not claim P7-T07 (blocked on B01-W) or jump to post-1.0 P6 / P7-T05 / P7-T06. Next B1/B2 needs an owner-activated EVAL |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-013` **closed** (2026-08-20) on `evaluation/EVAL-013-freeze`. Evaluation routing OFF. B0 C1/C2a P/O fairness **pass**; B1/B2 **not-run** pending a live paired executor, now delivered by **P9-T12**. EVAL-012 remains **closed**. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Product pin at P9-T12 merge `main@39cf8019`. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — a later owner-activated EVAL may run B1/B2 |
| Owner-directed C1/C2 campaign | EVAL-012 closed (B0 fairness fail). EVAL-013 closed (B0 C1/C2a pass; B1/B2 not-run). Live paired executor **P9-T12 done**. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | owner-activated new EVAL preregistration; do not auto-start EVAL-014 |
| Active task lease | `none` | `P9-T12` merged; evaluation routing OFF | owner-activated new EVAL before B1/B2; do not claim P6 / P7-T05 / P7-T06 / P7-T07 |
| Benchmark readiness product train | `P2-T21` … `P2-T38` **done**; **P9-T08 done**; **P9-T09 done**; **P9-T10 done**; **P9-T11 done**; **P9-T12 done**; `PERSONAL-PERF-EVAL-012` and `PERSONAL-PERF-EVAL-013` **closed** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Live paired executor is merged. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | new EVAL with new freeze/seeds/roots/ports/SecretStore |
