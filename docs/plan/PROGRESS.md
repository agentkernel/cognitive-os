...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-013` **active** (2026-08-20) on `evaluation/EVAL-013-freeze`. Evaluation routing ON. Product pin `6c415625c0ca12e9f8e51d139da601eb475ee231`. Isolation: `/home/hal9001/perfeval013-20260820`, daemon `48302`, broker `48402`, SecretStore `/25`. EVAL-002 and EVAL-004 through EVAL-012 remain **closed**. | Preregistration: [EVAL-013 freeze](../checkpoints/20260820-personal-perf-eval-013-preregistration.md), [EVAL-013 preregistration](../evaluation/personal-perf-eval-013-preregistration.md). Running report: [EVAL-013 assessment](../evaluation/personal-performance-assessment-20260820-eval-013.md). Claim ceiling `hypothesis`; `not_reviewed` | freeze on `B01-Desktop-Linux-002`, then B0; do not open B1 until B0 fairness passes |
...
| Active task lease | `lease/personal/EVAL-013/execution-plan-b0` | `PERSONAL-PERF-EVAL-013` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | complete freeze (archive/binaries/SecretStore `/25`/doctor), then B0 |
