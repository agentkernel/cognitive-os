...
| Active task lease | `lease/personal/P2-T32/public-daemon-start-scheduler` | P2-T32/D02 on `personal/P2-T32-public-daemon-start-scheduler` | Ubuntu CI / linux-002 focused `p2_t32_*`; do not run EVAL |
