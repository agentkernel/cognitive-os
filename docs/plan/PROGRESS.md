...
| Active task lease | `lease/personal/P8-T15/dsh-native-web-panel` on `personal/P8-T15-dsh-native-web-panel` | Writable: admin-cli dsh, dsh-akp-adapter scripts, plan/PROGRESS, P8-T15 checkpoint, handbook pages routed by cli-product + dsh-akp-adapter. Not P7-T05 SPA/clients. Not `PARALLEL-LANES.md`. | linux-002: 487821/487806 :3080, 465376 :48681, Firefox 471883. Do not auto-claim P6 / P7-T06 / P7-T07 |
| P8-T15 Native dsh Web UI | **in-progress** | Operational follow-up: both UIs **200**; OpenURL ok; Firefox tabs include `:3080` ×3 and Personal `/ui#/bindings`. HTTP management session from bootstrap file **200**; Providers list **1** `openai_compatible`. `#/providers` not in sessionstore. Report: [P8-T15 report](../checkpoints/20260823-personal-p8-t15-dsh-native-web-panel-report.md). Claim ceiling `hypothesis`. | desktop: open Models on :3080; click Providers on the existing Personal tab. Do not auto-claim P6 / P7-T06 / P7-T07 |
...
| `P8-T15/D02` | `in-progress` | Web still **487821/487806**. Follow-up: GET both UIs **200**; OpenURL ok; HTTP Providers list **1**. Firefox sessionstore has `:3080` and `/ui#/bindings`, not `#/providers`. | desktop Models + click Providers. Keep processes. Do not auto-claim P6 / P7-T06 / P7-T07 |
