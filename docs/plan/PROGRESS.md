...
| Active task lease | `lease/personal/P8-T01/doc-restructure` | `P8-T01/D03` on `personal/P8-T01-doc-restructure` at `e55b048274bfad600bee3d6feb4f23d45ae84bb2`; Draft PR #180. D01-D02 complete; D03 awaiting required CI then task reconciliation. Documentation-only. | wait for required Ubuntu/Windows CI on PR #180, then complete ready/merge/lease closure |
...
| `P8-T01/D03` | `in-progress` | acceptance mapping and closure checkpoint drafted; pushed `e55b048274bfad600bee3d6feb4f23d45ae84bb2` on Draft PR #180; required Ubuntu/Windows CI not-run pending | wait for required CI, then ready/merge and lease/branch/main reconciliation |
