...
| Personal P0-T06 | **Pi compatibility pin + RPC fixtures in progress** | `lane/run-personal-p0-t06-pi-compat` | Pi 0.81.1/SRI/source pin; `pi --version` fail-closed before scoped key read; strict-LF focused tests 5 pass under WSL. Extension PoC and provenance verification remain pending; no G0/Profile claim. |
