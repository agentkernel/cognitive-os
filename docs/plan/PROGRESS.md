...
| Active task lease | `lease/personal/P2-T14/verified-task-completion` — `P2-T14/D01` on `personal/P2-T14-verified-completion` | P2-T13 merged through PR #210 at `main@326f97728ab6aaaacceaedd2156d953231b32e01`. Draft PR [#217](https://github.com/agentkernel/cognitive-os/pull/217). Native `22c3f502`: scheduler 53/53, verification executor 12/12, Clippy pass. Public C1 reaches `COMPLETED`. Remaining D02 open-Effect/superseded-report/missing-CAS negatives are authored | push remaining D02 negatives, exact native scheduler/Clippy, then stale fixed-post-state negative and required CI |
...
| `P2-T14/D01` | `in-progress` | Native `22c3f502` scheduler 53/53, verification 12/12 and Clippy pass, including public C1 `COMPLETED`; open-Effect/superseded-report/missing-CAS negatives authored | push those negatives, exact native scheduler/Clippy, then the remaining stale fixed-post-state negative |
