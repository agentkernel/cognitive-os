...
| Active task lease | `none` | no active implementation lease after P3-T05 closure; the ignored local `/artifacts/` directory remains protected from modification, deletion, commitment, or implicit use. | select the next ready formal task after task closure |
