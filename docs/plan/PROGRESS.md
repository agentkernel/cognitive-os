...
| Active task lease | `lease/personal/EVAL-013/execution-plan-b0` | `PERSONAL-PERF-EVAL-013` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | C2d then remaining B0 checklist; B1 only after B0 pass |
