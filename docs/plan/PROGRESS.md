...
| Active task lease | `lease/personal/P8-T15/dsh-native-web-panel` on `personal/P8-T15-dsh-native-web-panel` | Writable: admin-cli dsh, dsh-akp-adapter scripts, plan/PROGRESS, P8-T15 checkpoint, handbook pages routed by cli-product + dsh-akp-adapter. Not P7-T05 SPA/clients. Not `PARALLEL-LANES.md`. | linux-002: Cos dsh web **492396/492382** `:3080`, daemon **465376** `:48681`, Firefox **471883**. Do not auto-claim P6 / P7-T06 / P7-T07 |
| P8-T15 Native dsh Web UI | **in-progress** | Cos-installed panel **pass**: `dsh_root=/home/hal9001/p8t10-a17edfad/dsh` pin `528c682e…`, cmdline Cos `bin.js --profile web`, `GET :3080` **200**, status ACTIVE. HTTP dsh remove/set **pass** (stale CAS 409; pro rev 6; Flash rev 7 / `binding`). Path B probe **200** pong. SPA CAS follow-on is clients PR [#4](https://github.com/agentkernel/cognitiveos-clients/pull/4) @ `afc5b04` (live `/ui/` `index--sTzcxFP.js`). Report: [P8-T15 report](../checkpoints/20260823-personal-p8-t15-dsh-native-web-panel-report.md). Claim ceiling `hypothesis`. | desktop Bindings: paste bootstrap if gated; confirm remove+set in the new SPA. Keep processes. Do not auto-claim P6 / P7-T06 / P7-T07 |
...
| `P8-T15/D02` | `in-progress` | Cos-installed `:3080` **492396/492382** ACTIVE; HTTP remove/set + Path B **pass**. Overlay pair stopped. Live `/ui/` serves CAS SPA `index--sTzcxFP.js`. | desktop Bindings confirm in new SPA. Keep processes. Do not auto-claim P6 / P7-T06 / P7-T07 |
