...
| Active task lease | `lease/personal/P2-T04/private-worker-composition`; `lease/personal/P2-T05/native-tool-registry-validation`; `lease/personal/P3-T01/context-request-binding` | P2-T04/D01 is active under its narrow private-worker-composition lease, and P2-T05 owns the native catalog/validator review boundary. P3-T01/D01 owns the ContextRequest binding/persistence prerequisite. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | complete supported CI without entering P2-T06 execution/supervision |
