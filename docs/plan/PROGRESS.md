...
| Active task lease | `lease/personal/P5-T05/b09-managed-pi` | Active lease owns P5-T05 B09 managed Pi on `personal/P5-T05-b09-managed-pi` / Draft PR #183. | implement and validate `P5-T05/D01` process-bound SidecarSession |
...
| P5-T05 B09 managed Pi + sidecar qualification | `in-progress` | Claimed after P2-T08 closure. D01 process-bound SidecarSession is the unique in-progress slice. B09 remains `not-run`. | implement D01 fenced process-attempt binding + health process_bound=true |
...
| `P5-T05/D01` | `in-progress` | Process-bound SidecarSession fenced process-attempt binding | implement activate/health/stop binding + failure-first negatives |
