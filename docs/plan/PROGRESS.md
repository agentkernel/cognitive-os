...
| Active task lease | `lease/personal/P5-T05/b09-managed-pi` | Active lease owns P5-T05 B09 managed Pi on `personal/P5-T05-b09-managed-pi`. | implement and validate `P5-T05/D01` process-bound SidecarSession |
