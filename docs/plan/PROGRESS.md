...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-006` **active**. Frozen product target `main@103fe776` (P2-T30 closed). C1/C2 paired B0 not yet started. Claim ceiling `hypothesis`; `not_reviewed`. Evaluation routing ON. Measurement-only: no product-code patch. `PERSONAL-PERF-EVAL-005` and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260817-personal-perf-eval-006-preregistration.md](../checkpoints/20260817-personal-perf-eval-006-preregistration.md). Running report: [personal-performance-assessment-20260817-eval-006.md](../evaluation/personal-performance-assessment-20260817-eval-006.md). Do not reuse EVAL-004/005 roots, ports `48286`/`48288`/`48386`/`48388`, or SecretStore `/12`/`/13`/`/14` | freeze new guest root/port/SecretStore then run C1/C2 B0 |
...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-006 **active**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | EVAL-006: C1/C2 paired not yet started. Do not reuse EVAL-004/005 roots, ports, or SecretStore `/12`/`/13`/`/14`. Claim ceiling hypothesis/`not_reviewed` | freeze then B0 C1/C2 paired |
| Active task lease | `lease/personal/EVAL-006/c1-c2-paired-freeze` | `PERSONAL-PERF-EVAL-006` C1/C2 paired freeze on `evaluation/EVAL-006-freeze`; product `main@103fe776` | freeze new root/port/SecretStore; then C1/C2 B0 |
