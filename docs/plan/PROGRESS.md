...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | continue `P7-T02/D01` on `personal/P7-T02-lifecycle-backup` |
| Active task lease | `lease/personal/P7-T02/lifecycle-backup` | P7-T02 owns personal_backup/store lib + plan/checkpoint paths on Draft PR #185. | continue D01 after Linux 3/3 + Clippy at `8750666`; enter D02 Memory/Skill export |
...
| P7-T02 Transactional lifecycle, Memory/Skill backup/restore | `in-progress` | `lease/personal/P7-T02/lifecycle-backup` on `personal/P7-T02-lifecycle-backup` / Draft PR #185. D01 secret-excluding backup inventory planner; exact native Linux `personal_backup` 3/3 + Clippy at `8750666`. | enter D02 Memory/Skill/bindings export |
...
slice `P7-T02/D01`. Formal task completion remains independent from every
...
| `P7-T02/D01` | `in-progress` | secret-excluding Personal backup inventory planner; Linux `personal_backup` 3/3 + Clippy at `8750666` | enter D02 after required CI; or continue D02 while CI runs |
| `P7-T02/D02` | `ready` | not started | waits for D01 |
