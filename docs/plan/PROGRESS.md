...
| P2-T28 End-to-end journey and capability truth | **in-progress** | Unique slice `P2-T28/D01` freeze at `aafe45a5` / Draft PR [#227](https://github.com/agentkernel/cognitive-os/pull/227). Local Node 6/6. D02 public-caller smoke authored. Web UI/Multi-Agent stay scope-excluded. Windows `not-run by owner-directed Linux-only route`. Claim ceiling `hypothesis`; no Gate/release/Profile/B01/EVAL promotion | Ubuntu supporting CI on PR [#227](https://github.com/agentkernel/cognitive-os/pull/227), then linux-002 D02/D03 |
