...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-012` **closed**. Evaluation routing OFF. Do not claim a `P*-T*` task until the owner gives a fresh delivery instruction. P7-T07 remains blocked on B01-W prerequisites. |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-012` **closed** (2026-08-20). Measurement-only. Evaluation routing OFF. B0 fairness **fail** (retained) blocked B1/B2. Parent-plan remainder dispositioned `not-run`/`not_available`. Cleanup **pass**. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Plan: [personal-perf-eval-012-preregistration.md](../evaluation/personal-perf-eval-012-preregistration.md). Freeze: [20260820-personal-perf-eval-012-preregistration.md](../checkpoints/20260820-personal-perf-eval-012-preregistration.md). Running report: [personal-performance-assessment-20260820-eval-012.md](../evaluation/personal-performance-assessment-20260820-eval-012.md). Product pin `370b26fcc05976c7c1c97e5510a99ed3ebc23f2c`. Isolation was root `/home/hal9001/perfeval012-20260820`, daemon `127.0.0.1:48300`, broker `127.0.0.1:48400` (25 forwards), SecretStore `/24` cleared. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — wait for an explicit owner delivery instruction before claiming any implementation task |
| Owner-directed C1/C2 campaign | `PERSONAL-PERF-EVAL-012` closed. B0 did not pass fairness. C1 O/P and C2a Write ran; C2a Patch O fail retained. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Parent: [personal-performance-benchmark-execution-plan.md](../evaluation/personal-performance-benchmark-execution-plan.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | none — campaign closed |
| Active task lease | `none` | `PERSONAL-PERF-EVAL-012` closed; evaluation lease closed | wait for owner delivery instruction |
...
| Benchmark readiness product train | `P2-T21` … `P2-T37` **done**; **P9-T08 done** (`main@f24c282e`); `PERSONAL-PERF-EVAL-012` **closed** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Packages 1–14 delivered. EVAL-012 B0 fairness fail blocked B1/B2. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | none — wait for owner delivery instruction |
