...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | EVAL-007 C1/C2 freeze in progress after P2-T31. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-007` **active**. Frozen product target `main@2a8d4d2f` (P2-T31 closed). C1/C2 paired B0/B1/B2 `not-run`. Claim ceiling `hypothesis`; `not_reviewed`. Evaluation routing ON. `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260817-personal-perf-eval-007-preregistration.md](../checkpoints/20260817-personal-perf-eval-007-preregistration.md). Running: [personal-performance-assessment-20260817-eval-007.md](../evaluation/personal-performance-assessment-20260817-eval-007.md). Do not reuse EVAL-004/005/006 roots, ports `48286`/`48288`/`48290`/`48386`/`48388`/`48390`, or SecretStore `/12`/`/13`/`/14`/`/15` | freeze: archive `2a8d4d2f`, guest root `/home/hal9001/perfeval007-20260817`, daemon `48292`, new SecretStore item via stdin |
...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-007 **active**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T31 merged at `main@da6fca2e` / closure `2a8d4d2f`. Do not reuse EVAL-004/005/006 roots, ports, or SecretStore `/12`/`/13`/`/14`/`/15`. Claim ceiling hypothesis/`not_reviewed` | freeze guest root `/home/hal9001/perfeval007-20260817` daemon `48292` |
| Active task lease | `lease/personal/EVAL-007/c1-c2-paired-freeze` | EVAL-007 C1/C2 paired freeze after P2-T31; branch `evaluation/EVAL-007-freeze` | freeze archive + guest root `48292` + stdin SecretStore; measurement-only |
| Benchmark readiness product train | `P2-T21` **done** … `P2-T31` **done** at `da6fca2e` / PR [#236](https://github.com/agentkernel/cognitive-os/pull/236) | Live HTTP admit acquires a scheduler lease. CI `32038273275` at `49cdfc0c`; linux-002 focused 1/1, bin 337/337. Product evidence only, not EVAL/Gate/release/Profile/B01 | next measurement is EVAL-007 |
