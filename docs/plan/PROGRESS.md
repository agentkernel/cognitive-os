...
| Active task lease | `lease/personal/P2-T02/pi-sidecar-parity` | `P2-T02/D04` is implementing Pi Shell access to the same private daemon Task/resource read/watch surfaces using isolated Task/management sessions. Pi remains a non-authority client. | run TS channel/isolation negatives, daemon-side integration, exact Linux and required CI before P2-T02 closure assessment |
...
| `P2-T02/D04` | `in-progress` | Pi Shell private sidecar parity is adding isolated Task/management sessions and the same private Task/resource read/watch daemon calls; focused TS and daemon-side evidence remains pending | run TS channel/isolation negatives, daemon-side integration, exact Linux and required CI before P2-T02 closure assessment |
