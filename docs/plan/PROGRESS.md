...
| Active task lease | `lease/personal/P8-T04/harness-hooks` | P8-T04 owns harness_hooks + plan/checkpoint paths on Draft PR #188. | Linux D02 validation; then D03 graded loading |
| P8-T04 Deterministic harness hooks | `in-progress` | Draft PR #188. D01 lifecycle hook registry Linux 3/3 + Clippy at `3103a80`; D02 digest-bound management-channel invocation. | exact native Linux focused tests + Clippy for D02 |
...
slice `P8-T04/D02`. Formal task completion remains independent from every
...
| `P8-T04/D02` | `in-progress` | digest-bound owner-programmable invocation + management-channel isolation | implement D02 |
