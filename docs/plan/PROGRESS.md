...
| Active task lease | `lease/personal/P2-T04/private-worker-composition`; `lease/personal/P2-T05/native-tool-registry-validation` | P2-T04/D01 owns the scheduler/Pi Context-before-candidate integration path, and P2-T05 owns the native catalog/validator review boundary. P3-T01/D01's prerequisite lease is closed after the merged PR #153 integration; its next durable ContextView emission slice is blocked on a non-overlapping P2-T04 continuation lease. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | P2-T04 owner: persist the resolved ContextView before private candidate admission, then add the P3-T01 integration negative proving revoked sources never reach Pi |
