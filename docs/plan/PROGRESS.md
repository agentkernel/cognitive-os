...
| Active task lease | `none` | P7-T01 D01–D04 acceptance mapped; lease closed in this delivery before PR #184 ready/merge. | mark PR #184 ready, merge, delete task branch, reconcile local main; claim next ready task |
...
| P7-T01 Release pipeline, six-resource manifest, SBOM & attestation | **done** | D01–D04 closed. Signed six-family manifest, SBOM/artifact digest binding, immutable toolchain pins, and acceptance mapping. Exact native Linux `release_manifest` 11/11 + Clippy at `34812f8`; closure checkpoint `20260811-personal-p7-t01-release-pipeline-closure.md`; Draft PR #184. | retain closure evidence; no Gate/release/Profile/GMVP-LINUX claim |
...
`P7-T01` is `done`. `P5-T05` is `done` with B09 MVP `pass` under ADR-0047.
Formal task completion remains independent from every product Gate except where
the plan explicitly binds Gate disposition to task acceptance.
...
| `P7-T01/D04` | `done` | acceptance mapping + closure checkpoint; no Gate/release/Profile claim | consumed by completed P7-T01 task |
