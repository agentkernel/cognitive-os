...
| Active task lease | `lease/personal/P2-T20/mutation-carriers` — `P2-T20/D05` on `personal/P2-T20-mutation-carriers` | C2 parameter-bearing mutation request carriers; owner-directed 2026-08-14. D01–D04 complete (all six families have production carriers; required Ubuntu/Windows CI green at `4eae2d91`) | complete the acceptance assessment and merge PR #219; no Gate/release/Profile claim |
| P2-T20 Parameter-bearing mutation request carriers (C2) | **in-progress** | Owner-directed 2026-08-14. All six registered families now have a production request carrier: WorkspaceRead, query-bearing WorkspaceSearch, preimage-bearing WorkspaceWrite/Patch, ProcessCheck (fail-closed supervisor), and HttpFetchReadOnly (empty origin allowlist). D01–D04 green on required CI | complete the acceptance assessment and merge (D05) |
...
| `P2-T20/D05` | `in-progress` | complete the task acceptance assessment, merge PR #219, close the lease, and reconcile branch/main | run the final acceptance mapping and merge |
