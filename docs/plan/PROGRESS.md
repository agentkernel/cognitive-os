...
| Active task lease | `lease/personal/P4-T06/memory-skill-correctness` | P4-T06/D01 owns daemon-private Memory/Skill correctness and same-task consumption evidence on `personal/P4-T06-memory-skill-correctness` | implement authority-backed same-task consumption and failure-first privacy/lifecycle/eligibility negatives; B08 remains an independent Gate campaign |
...
| `P4-T06/D02` | `not-started` | — | connect eligible Memory and Skill facts to a same-task Context/Task trace without client authority |
| `P4-T06/D03` | `not-started` | — | complete final acceptance mapping and non-claim evidence |
