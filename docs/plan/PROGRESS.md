...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-005` **active** 2026-08-17. Frozen product `main@b16d2955` (P2-T29 closed). Guest `/home/hal9001/perfeval005-20260817`, daemon `127.0.0.1:48288` pid 267060, SecretStore `/14` (not `/12`/`/13`), Pi `0.81.1` pinned. Do not reuse EVAL-004 roots or ports `48286`/`48386`. `PERSONAL-PERF-EVAL-004` remains **closed**. Continuation events resume this campaign; do not auto-claim `P*-T*` tasks | Same execution plan as EVAL-004: [personal-performance-benchmark-execution-plan.md](../evaluation/personal-performance-benchmark-execution-plan.md). Target `B01-Desktop-Linux-002` via `wuz@192.168.1.2` ProxyJump `hal9001@192.168.123.160`. Claim ceiling `hypothesis`; `not_reviewed`. Measurement-only: no product-code changes. Preregistration: [20260817-personal-perf-eval-005-preregistration.md](../checkpoints/20260817-personal-perf-eval-005-preregistration.md). Running report: [personal-performance-assessment-20260817-eval-005.md](../evaluation/personal-performance-assessment-20260817-eval-005.md). EVAL-004 final remains [personal-performance-assessment-20260817-full-os-only.md](../evaluation/personal-performance-assessment-20260817-full-os-only.md) | C1/C2 paired skip `scheduler_row_skip_before_lease`; B1/B2 `not-run`; MS-AUTH Memory 10/10 pass; campaign active until owner close |
...
| Active task lease | `lease/personal/EVAL-005/c1-c2-paired-freeze` | Owner-directed `PERSONAL-PERF-EVAL-005` after P2-T29 merge. Measurement-only. Writable: `docs/evaluation/`, EVAL-005 preregistration, `docs/plan/PROGRESS.md`. Guest `/home/hal9001/perfeval005-20260817`; daemon `48288`; SecretStore `/14`; do not reuse EVAL-004 `perfeval004`, `48286`/`48386`, or items `/12`/`/13` | C1/C2 paired skip recorded; MS-AUTH Memory pass; wait for owner close (no B1/B2 Provider spend) |
