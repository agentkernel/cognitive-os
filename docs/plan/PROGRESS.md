...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | Owner delivery instruction 2026-08-20 executes [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md) to completion. Evaluation routing remains OFF. P2-T36 is closed on `main@08819a82`. P2-T37/D03 is the current C2a closure slice. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | C1/C2 readiness **delivery** is active under [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). This is not a new EVAL ID. `PERSONAL-PERF-EVAL-010` **closed** (2026-08-18). Pin `289eebad`. Long root `/home/hal9001/perfeval010-20260818` / daemon `48298` / SecretStore `/19`. UNIX_PATH_MAX product fix **confirmed**. B0 C1-search **partial** (`candidate_has_missing_fields_or_an_invalid_parameters_digest`; Task `DRAFT`; `lease_acquired` 0; real adapter spawned). Evaluation routing OFF. EVAL-004 through EVAL-010 remain **closed**. | Preregistration: [20260818-personal-perf-eval-010-preregistration.md](../checkpoints/20260818-personal-perf-eval-010-preregistration.md). Final: [personal-performance-assessment-20260818-eval-010.md](../evaluation/personal-performance-assessment-20260818-eval-010.md). Do not reopen EVAL-004/005/006/007/008/009/010. Do not reuse those roots, ports `48286`/`48288`/`48290`/`48292`/`48294`/`48296`/`48298`/`48386`/`48388`/`48390`/`48392`/`48394`/`48396`/`48398`, or SecretStore `/12`–`/19`. Claim ceiling `hypothesis`; `not_reviewed` | Ready/merge PR [#246](https://github.com/agentkernel/cognitive-os/pull/246) at `3662d2b9` (CI `32290876044` green), then close lease/branch/main and reconfirm C2b–d. Do not reopen EVAL-010 |
| Owner-directed C1/C2 campaign | Owner-authorized C1/C2 readiness **delivery** is active. C1 public O-arm is complete (P2-T36 merged). C2a public WorkspaceWrite and WorkspacePatch are complete on `P2-T37` D02. C2b-d, P-arm, frozen assets, B0 fairness, and a new campaign assessment remain later plan packages. EVAL-004 through EVAL-010 remain **closed**. | This delivery is product readiness, not a paired benchmark. Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | Finish P2-T37/D03 merge/lease/branch, then reconfirm C2b-d; do not reuse closed EVAL assets |
| Active task lease | `lease/personal/P2-T37/c2a-public-mutation-path` | P2-T37/D02 is complete on `personal/P2-T37-c2a-public-mutation-path` / Draft PR [#246](https://github.com/agentkernel/cognitive-os/pull/246). Public Write and Patch both reached `COMPLETED` / `lease_acquired: 1` / verification passed / acceptance current. Patch daemon stopped. | D03: Clippy repair, required CI, acceptance mapping, ready/merge #246, close lease, delete task branch if safe, fast-forward local main. |
...
| Benchmark readiness product train | `P2-T21` … `P2-T36` **done** (`main@08819a82`); `P2-T37` **in progress** (D02 complete) | The durable navigation is [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). EVAL-011 is closed and does not make readiness complete. P2-T37 public WorkspaceWrite and WorkspacePatch completed the full authority chain. No EVAL, Gate, release, Profile, B01, or Agent-benefit conclusion follows. | Finish D03 merge/lease/branch, then C2b-d reconfirm. |
...
| `P2-T37/D03` | `in-progress` | Required CI `32290876044` passed Ubuntu, Windows, and required-ci at `3662d2b9`. D02 public Write/Patch evidence is in the running report. | Ready/merge PR [#246](https://github.com/agentkernel/cognitive-os/pull/246), close lease, delete task branch if safe, fast-forward local main; then C2b-d reconfirm. |
