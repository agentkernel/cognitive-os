...
| P3-T05 UCR-01 benefit runner and stable baseline | `in-progress` | `lease/personal/P3-T05/ucr-runner` owns the daemon-private workload runner on `personal/P3-T05-ucr-runner`; raw measurements remain non-claim evidence and cannot advance any Gate or release state. | implement the fixed-scenario raw-run and pinned baseline boundary |
...
| Active task lease | `lease/personal/P3-T05/ucr-runner` | P3-T05 is active on `personal/P3-T05-ucr-runner`; the ignored local `/artifacts/` directory remains protected from modification, deletion, commitment, or implicit use. | implement and validate the daemon-private UCR-01 runner boundary |
...
| `P3-T05/D01` | `in-progress` | Establish the fixed-scenario UCR-01 raw-run and stable-baseline artifact boundary with bounded/redacted measurements and explicit non-claim semantics. | add runner contract, raw-run, baseline-drift, and no-Gate-authority negatives |
