...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-007 **active**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T31 merged at `main@da6fca2e` / closure `2a8d4d2f`. Do not reuse EVAL-004/005/006 roots, ports, or SecretStore `/12`/`/13`/`/14`/`/15`. Claim ceiling hypothesis/`not_reviewed` | B0 C1/C2 paired; freeze pass at daemon `48292` pid 277358 SecretStore `/16` |
| Active task lease | `lease/personal/EVAL-007/c1-c2-paired-freeze` | EVAL-007 C1/C2 paired freeze after P2-T31; branch `evaluation/EVAL-007-freeze` | B0 C1/C2 paired (measurement-only); freeze pass |
