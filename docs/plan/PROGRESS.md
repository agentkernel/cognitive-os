...
| Active task lease | `lease/personal/P8-T04/harness-hooks` | P8-T04 owns harness_hooks + plan/checkpoint paths on Draft PR (pending). | implement D01 lifecycle hook registry; Linux focused tests + Clippy |
| P8-T04 Deterministic harness hooks | `in-progress` | `lease/personal/P8-T04/harness-hooks` on `personal/P8-T04-harness-hooks`. D01 private lifecycle hook registry (admission/pre-dispatch/post-effect/verification). | exact native Linux focused tests + Clippy for D01 |
...
slice `P8-T04/D01`. Formal task completion remains independent from every
...
| `P8-T04/D01` | `in-progress` | daemon-owned lifecycle hook registry for admission/pre-dispatch/post-effect/verification; axiom-relaxation negatives | exact native Linux focused tests + Clippy |
| `P8-T04/D02` | `ready` | not started | waits for D01 |
| `P8-T04/D03` | `ready` | not started | waits for D02 |
