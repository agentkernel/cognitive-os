...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **paused before B1; evaluation lease closed** | B0 target and runtime readiness were qualified without any B1/B2/B3/B4 sample. The campaign discovered a product gap: the private candidate carrier persists only parameters_digest, while the production WorkspaceSearch/WorkspaceWrite/WorkspacePatch router requires canonical governed parameters. EVAL-002 remains closed and unchanged; claim ceiling remains hypothesis/non-claim | P2-T28 D03 linux-002 matrix recorded at `c7d4c7f7`; unique next is ready/merge of Draft PR [#227](https://github.com/agentkernel/cognitive-os/pull/227). EVAL-004 re-freeze only after BR-08 merge; no prior campaign asset or SecretStore entry is reused |
| Benchmark readiness product train | `P2-T21` **done** at `5d1f5c2643d82807eb96f2c615d460dbdca749c3` / PR #220; `P2-T22` **done** at `03bc530d692649a00efa7918bfeadddf8ba0ebea` / PR [#221](https://github.com/agentkernel/cognitive-os/pull/221); `P2-T23` **done** at `795bfac8d8ee77b1b3be4137d33399fc817d20eb` / PR [#222](https://github.com/agentkernel/cognitive-os/pull/222); `P2-T24` **done** at `2b803e0fb955d03374e10569b4d9aecd0b4162d7` / PR [#223](https://github.com/agentkernel/cognitive-os/pull/223); `P2-T25` **done** at `4b10db9a64584bda42ae249bd1df289475bd6324` / PR [#224](https://github.com/agentkernel/cognitive-os/pull/224); `P2-T26` **done** at `9e1404a1b262a0e8588dbc2d1daac08ce419bd33` / PR [#225](https://github.com/agentkernel/cognitive-os/pull/225); `P2-T27` **done** at `70980131c34e514c8bfba681ca0ee7c8a8f92fdc` / PR [#226](https://github.com/agentkernel/cognitive-os/pull/226); `P2-T28` D03 in progress | Owner instruction 2026-08-15 approved BR-01..BR-08 and the Linux-only product-validation route. Ubuntu is supporting CI; exact pushed-revision `DEV-LINUX-NATIVE-01` is required acceptance evidence for these product tasks; `B01-Desktop-Linux-002` remains owner-directed EVAL-004-only. Windows is `not-run by owner-directed Linux-only route`. This is product implementation evidence only, not EVAL/Gate/release/Profile/B01 evidence | ready/merge P2-T28 PR [#227](https://github.com/agentkernel/cognitive-os/pull/227). EVAL-004 re-freeze happens only after BR-08 merge |
...
| Active task lease | `lease/personal/P2-T28/journey-capability-truth` | Unique in-progress slice `P2-T28/D03`. Draft PR [#227](https://github.com/agentkernel/cognitive-os/pull/227). Ubuntu `31941999146` **pass** at `c7d4c7f7`. `DEV-LINUX-NATIVE-01` bins 336/336, named UJ oracles, workspace 0-failed, Clippy `-D warnings`, fmt. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched (EVAL-004-only) | ready/merge PR [#227](https://github.com/agentkernel/cognitive-os/pull/227) after docs-head Ubuntu; keep D03 `in-progress` until merge |
...
| P2-T28 End-to-end journey and capability truth | **in-progress** | Unique slice `P2-T28/D03`. D01 freeze + D02 public-caller smoke + D03 linux-002 aggregate at `c7d4c7f7` / Draft PR [#227](https://github.com/agentkernel/cognitive-os/pull/227). Ubuntu `31941999146` pass. Local Node 6/6. Web UI/Multi-Agent stay scope-excluded. Windows `not-run by owner-directed Linux-only route`. Claim ceiling `hypothesis`; no Gate/release/Profile/B01/EVAL promotion | ready/merge PR [#227](https://github.com/agentkernel/cognitive-os/pull/227); keep D03 `in-progress` until merge |
...
| `P2-T28/D03` | `in-progress` | Exact-revision `DEV-LINUX-NATIVE-01` at `c7d4c7f7`: named UJ oracles, bins 336/336, workspace 0-failed, Clippy `-D warnings`, fmt. Ubuntu `31941999146` green at the same SHA. Slice stays `in-progress` until ready/merge. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched | ready/merge PR [#227](https://github.com/agentkernel/cognitive-os/pull/227) |
