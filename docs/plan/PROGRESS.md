...
| Benchmark readiness product train | `P2-T21` **done** … `P2-T34` **done** (`main@106cfcc0`) | Public launcher + stub Workspace* on a long root leaves DRAFT and acquires a lease. EVAL-010 measured the digest skip; P2-T34 recomputes JSON-fallback digests. Claim ceiling `hypothesis` | EVAL-011 B0 C1-search; no Gate/B01 promotion |
