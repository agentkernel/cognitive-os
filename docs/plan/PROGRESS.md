...
| Active task lease | `none` | P2-T05 is closed in the lease register with native Linux and required CI evidence. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | select a non-overlapping ready formal task and create its dedicated branch, Draft PR, and lease before writing implementation |
