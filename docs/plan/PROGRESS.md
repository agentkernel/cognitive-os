...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | P9-T08 packages 6–14 have supported evidence. Keep Draft PR #247 until required CI is green, then ready/merge/lease/branch/main. Do not activate EVAL-012. Do not start B01 samples. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | C1/C2 readiness delivery **packages 6–14 delivered** (2026-08-20). This is **not** an EVAL ID. Packages 1–5 remain historical O-arm product evidence. Packages 15–17 are the future measurement campaign. `PERSONAL-PERF-EVAL-012` is **reserved, not active**. Evaluation routing OFF. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Amendment: [20260820-personal-c1-c2-readiness-programme-amendment.md](../checkpoints/20260820-personal-c1-c2-readiness-programme-amendment.md). Running report: [20260820-personal-p9-t08-c1-c2-paired-readiness-report.md](../checkpoints/20260820-personal-p9-t08-c1-c2-paired-readiness-report.md). Linux pin `7dc8c999729028ddb850ab858e88e2f1ba8d5bf9`. Do not reopen EVAL-004/005/006/007/008/009/010/011. Do not reuse those roots, ports `48286`–`48298` / `48386`–`48398` / `48383`, SecretStore `/12`–`/19`, or P2-T37 roots `p2-t37-c2a-write-20260820` / `p2-t37-c2a-patch-20260820`. Claim ceiling `hypothesis`; `not_reviewed` | unique next action: required CI on PR #247, then P9-T08 ready/merge/lease/branch/main. Do not start B01 samples. |
| Owner-directed C1/C2 campaign | Owner-authorized C1/C2 readiness **packages 6–14 delivered**. C1 and C2a public O-arm remain merged. EVAL-004 through EVAL-011 remain **closed**. EVAL-012 reserved, not active. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | Do not activate EVAL-012. Do not start B0. |
| Active task lease | `lease/personal/P9-T08/c1-c2-paired-readiness` | P9-T08/D01–D04 evidence on `personal/P9-T08-c1-c2-paired-readiness`. Draft PR [#247](https://github.com/agentkernel/cognitive-os/pull/247). | required CI then ready/merge; EVAL-012 not active |
...
| Benchmark readiness product train | `P2-T21` … `P2-T37` **done** (`main@286f7538`); **P9-T08 in-progress** (packages 6–14 evidence landed; merge remaining) | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Public C1 Read/Search and C2a Write/Patch completed the O-arm authority chain. P-arm broker Secret Service get, freeze, fairness, B01 procedure, bind runbook, EVAL-012 scaffolding delivered. No EVAL, Gate, release, Profile, B01, or Agent-benefit conclusion follows. | Merge P9-T08 after required CI. Do not activate EVAL-012. |
...
| `P9-T08/D04` | `in-progress` | B01 procedure, bind runbook, `cells.json`, EVAL-012 scaffolding (not activated), leftover remote branch deleted. E7–E9 `not-run` (EVAL start gate). Packages 6–14 have supported evidence. | required CI then ready/merge/lease/branch/main; do not activate EVAL-012 |
