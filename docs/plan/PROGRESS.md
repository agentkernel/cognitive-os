...
| Active task lease | `lease/personal/P2-T05/native-tool-registry-validation`; `lease/personal/P3-T01/context-request-binding` | P2-T04/D01 is closed at `a8ef5c0`; its lease is moved to the closed-lease register. P2-T05 owns the native catalog/validator review boundary. P3-T01/D01 owns the ContextRequest binding/persistence prerequisite. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | select work only under an active non-overlapping lease |
...
`P2-T01`, `P2-T02`, and `P2-T04` are done because their original acceptance
criteria and required evidence were satisfied without removing or weakening
any criterion. P1-T09, P2-T03, and P3-T01 remain in progress; P2-T03/D05 and P2-T07/D01 are done with
