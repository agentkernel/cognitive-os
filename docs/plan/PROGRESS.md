...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-005` **closed 2026-08-17**. Frozen product `main@b16d2955`. C1/C2 paired B0 **partial** (`scheduler_row_skip_before_lease`; Tasks `DRAFT`; `lease_acquired` 0/0; no Pi child). B1/B2 `not-run`. MS-AUTH Memory 10/10 pass. Cleanup **pass**. Claim ceiling `hypothesis`; `not_reviewed`. Evaluation routing OFF. `PERSONAL-PERF-EVAL-004` remains **closed**. | Final: [personal-performance-assessment-20260817-eval-005.md](../evaluation/personal-performance-assessment-20260817-eval-005.md). Preregistration: [20260817-personal-perf-eval-005-preregistration.md](../checkpoints/20260817-personal-perf-eval-005-preregistration.md). Do not reuse EVAL-004/005 roots, ports `48286`/`48288`/`48386`/`48388`, or SecretStore `/12`/`/13`/`/14` | retain closed campaign; product mutex is P2-T30 |
...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **closed 2026-08-17**; PERSONAL-PERF-EVAL-005 **closed 2026-08-17** after owner-authorized measurement close | EVAL-004: C1/C2 paired `not-run`. EVAL-005: C1/C2 paired B0 **partial** (`scheduler_row_skip_before_lease`); B1/B2 `not-run`; MS-AUTH Memory 10/10 pass; cleanup **pass**. Final: [personal-performance-assessment-20260817-eval-005.md](../evaluation/personal-performance-assessment-20260817-eval-005.md). Claim ceiling hypothesis/`not_reviewed` | P2-T30 then a new freeze; do not reuse EVAL-004/005 roots or ports |
| Active task lease | `lease/personal/P2-T30/scheduler-lease-acquisition` | P2-T30/D01 public-admit scheduler lease acquisition on `personal/P2-T30-scheduler-lease-acquisition` | continue D01/D02 implementation and Ubuntu + `DEV-LINUX-NATIVE-01` validation |
| Benchmark readiness product train | `P2-T21` **done** at `5d1f5c2643d82807eb96f2c615d460dbdca749c3` / PR #220; `P2-T22` **done** at `03bc530d692649a00efa7918bfeadddf8ba0ebea` / PR [#221](https://github.com/agentkernel/cognitive-os/pull/221); `P2-T23` **done** at `795bfac8d8ee77b1b3be4137d33399fc817d20eb` / PR [#222](https://github.com/agentkernel/cognitive-os/pull/222); `P2-T24` **done** at `2b803e0fb955d03374e10569b4d9aecd0b4162d7` / PR [#223](https://github.com/agentkernel/cognitive-os/pull/223); `P2-T25` **done** at `4b10db9a64584bda42ae249bd1df289475bd6324` / PR [#224](https://github.com/agentkernel/cognitive-os/pull/224); `P2-T26` **done** at `9e1404a1b262a0e8588dbc2d1daac08ce419bd33` / PR [#225](https://github.com/agentkernel/cognitive-os/pull/225); `P2-T27` **done** at `70980131c34e514c8bfba681ca0ee7c8a8f92fdc` / PR [#226](https://github.com/agentkernel/cognitive-os/pull/226); `P2-T28` **done** at `1e71344a7b2c4a443fd0581e7fd33f21e970efbd` / PR [#227](https://github.com/agentkernel/cognitive-os/pull/227); `P2-T29` **done** at `98cb23d1dc548929e727259fa4d3109cfe38f5ee` / PR [#230](https://github.com/agentkernel/cognitive-os/pull/230) | Owner 2026-08-17 delivery after EVAL-004 closure filled the two product mutexes. Ubuntu/Windows CI `32000735588` at `dbbd176f`; linux-002 at `a317d817`. Product evidence only, not EVAL/Gate/release/Profile/B01 | retain closure; next measurement is a new owner-directed freeze, not a development task |
...
| P2-T30 Public-admit scheduler lease acquisition | **in-progress** | Owner 2026-08-17 delivery: EVAL-005 closed so product work can start. D01 persists owner-local Context authorization at public admit and walks Loop START→DECIDE before Pi. Failure-first: public C1 admit must leave DRAFT until a later tick acquires a lease. Branch `personal/P2-T30-scheduler-lease-acquisition`. Lease `lease/personal/P2-T30/scheduler-lease-acquisition`. Windows GNU Rust `not-run`. | continue D01/D02; Ubuntu CI + `DEV-LINUX-NATIVE-01` |
...
|---|---|---|---|
| `P2-T30/D01` | `in-progress` | Public `POST /task/admit` must persist owner-local Context authorization and revocation so the first scheduler tick can walk Loop START→DECIDE and admit a private Pi candidate. Failure-first: admitted C1 Task stays DRAFT until a later tick acquires a lease. Windows GNU Rust `not-run`. | Ubuntu CI + exact-revision `DEV-LINUX-NATIVE-01` focused kernel-server tests |
| `P2-T30/D02` | `ready` | Later tick must acquire a scheduler lease, spawn daemon-governed Workspace* Pi on the P2-T29 path, and leave DRAFT. | wait for D01 validation; then linux-002 leased-dispatch proof |
| `P2-T30/D03` | `ready` | Task acceptance assessment, docs-sync, Ubuntu + linux-002, merge. | wait for D01/D02 |
