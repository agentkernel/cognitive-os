...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-015` **active** (2026-08-21) on `evaluation/EVAL-015-freeze`. Evaluation routing ON. Carries closed EVAL-014 C1/C2a B0/B1/B2 on pin `adc40499` (not re-run). C0 B0 **pass**. C0 B1 **pass** (90/90). C0 B2 running (270 pairs). Remainder: B3–B5, T/S/O/UJ, C2b resume/Skill, C2c fault profile. EVAL-002 and EVAL-004 through EVAL-014 remain **closed**. | Plan: [execution plan](../evaluation/personal-performance-benchmark-execution-plan.md). Preregistration: [EVAL-015](../evaluation/personal-perf-eval-015-preregistration.md). Report: [EVAL-015 assessment](../evaluation/personal-performance-assessment-20260821-eval-015.md). Claim ceiling `hypothesis`; `not_reviewed`. No Gate / release / Profile / B01 / Agent-benefit promotion. | finish C0 B2 confirmatory 270 pairs; then MS-AUTH/T-GOV/UJ; then B3–B5 |
| Owner-directed C1/C2 campaign | EVAL-014 C1/C2a **carried** (B0 pass; B1 5/5; B2 30/30 on `adc40499`). EVAL-015 does not re-run those counted cells. C2b–d remaining on this freeze. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | C2b session-2/Skill and C2c fault profile after C0 B0 |
