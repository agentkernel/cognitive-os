...
| Active task lease | `lease/personal/EVAL-005/c1-c2-paired-freeze` | Owner-directed `PERSONAL-PERF-EVAL-005` after P2-T29 merge. Measurement-only. Writable: `docs/evaluation/`, EVAL-005 preregistration, `docs/plan/PROGRESS.md`. New guest root/port/SecretStore; do not reuse EVAL-004 `perfeval004`, `48286`/`48386`, or items `/12`/`/13` | freeze archive + exact-source binaries, then C1/C2 paired B0 |
