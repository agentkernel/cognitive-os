...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-008 **active**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | Freeze **pass** at `fb85cfff` / daemon `48294` / SecretStore `/17`. Doctor ready is not C1/C2. Claim ceiling hypothesis/`not_reviewed` | B0 C1-search **partial**; cleanup then final assessment |
| Active task lease | `lease/personal/EVAL-008/c1-c2-paired-freeze` | EVAL-008 C1/C2 paired freeze after P2-T32 lease close; branch `evaluation/EVAL-008-freeze` | B0 C1-search **partial**; cleanup then final assessment |
