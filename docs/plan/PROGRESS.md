...
| Active task lease | `lease/personal/EVAL-20260816/full-os-only-refreeze` | P2-T28 merged via PR [#227](https://github.com/agentkernel/cognitive-os/pull/227) at `main@1e71344a`. Evaluation lease for `PERSONAL-PERF-EVAL-004` re-freeze. Writable: evaluation plan/addendum, new preregistration, `PROGRESS.md` only. No product code. Claim ceiling `hypothesis` | produce clean source archive of `1e71344a` on `DEV-LINUX-NATIVE-01`; new guest root/port; do not reuse old SecretStore |
