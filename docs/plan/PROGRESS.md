...
| Active task lease | `none` | P2-T29 merged via PR [#230](https://github.com/agentkernel/cognitive-os/pull/230) at `main@98cb23d1`; the P2-T29 enablement lease is closed | owner-directed EVAL freeze next (do not auto-claim another `P*-T*`) |
