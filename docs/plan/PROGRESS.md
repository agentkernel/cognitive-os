...
| Active task lease | `none` | `P2-T02/D03` is done at `af2f6c9b261efe5014ac829e872653244fb22ef2`: deterministic CLI resource/task read-watch paths use isolated management/task tokens and cursor query namespaces, with no mutation replay behavior. Exact Linux process test and required CI passed. | claim D04 sidecar parity; D03 creates no P2 Gate, release, or Profile claim |
