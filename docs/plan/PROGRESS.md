...
| Personal 产品化计划 | **planning；P0-T01..T05/T07 + P1-T01..T06 done；无 Profile 声明** | P0-T03 done：PR [#99](https://github.com/agentkernel/cognitive-os/pull/99) / `main@fd6ff6b`；CI [30180002937](https://github.com/agentkernel/cognitive-os/actions/runs/30180002937) Ubuntu/Windows-MSVC SUCCESS；Apache-2.0 + Linux/Windows x86_64 首发 + GitHub Release（不 vendor Pi/Node）；ADR-0025。Personal Gate/B01-B12 仍 `not-run`；**G0 仍待 P0-T06**。 | 正式台账：[PERSONAL-DEVELOPMENT-PLAN.md](PERSONAL-DEVELOPMENT-PLAN.md)；[PERS-PR trace](personal-trace.yaml) 独立于 registry matrix。Personal `done` 不代表 G0、B01-B12 或 Profile 已符合。 |
