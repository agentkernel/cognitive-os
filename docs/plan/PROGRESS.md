...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | C1/C2 readiness packages 1–14 are delivered. Owner may activate `PERSONAL-PERF-EVAL-012` to start B0. Do not start B01 samples until that row is active. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | C1/C2 readiness delivery **complete** (2026-08-20). This is **not** an EVAL ID. Packages 1–14 have supported evidence. Packages 15–17 remain the measurement campaign. `PERSONAL-PERF-EVAL-012` is **reserved, not active**. Evaluation routing OFF. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Amendment: [20260820-personal-c1-c2-readiness-programme-amendment.md](../checkpoints/20260820-personal-c1-c2-readiness-programme-amendment.md). Running report: [20260820-personal-p9-t08-c1-c2-paired-readiness-report.md](../checkpoints/20260820-personal-p9-t08-c1-c2-paired-readiness-report.md). Merged PR [#247](https://github.com/agentkernel/cognitive-os/pull/247) at `main@f24c282e`. Do not reopen EVAL-004/005/006/007/008/009/010/011. Do not reuse those roots, ports `48286`–`48298` / `48386`–`48398` / `48383`, SecretStore `/12`–`/19`, or P2-T37 roots `p2-t37-c2a-write-20260820` / `p2-t37-c2a-patch-20260820`. Claim ceiling `hypothesis`; `not_reviewed` | unique next action: owner activates EVAL-012 before any B0 sample. Do not start B01 samples while routing is OFF. |
| Owner-directed C1/C2 campaign | Owner-authorized C1/C2 readiness **complete**. Packages 1–14 delivered. EVAL-012 reserved, not active. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | Owner activates EVAL-012 to start B0. |
| Active task lease | `none` | P9-T08 merged via PR [#247](https://github.com/agentkernel/cognitive-os/pull/247) at `main@f24c282e`; lease closed | none — owner may activate EVAL-012; do not start B0 while routing is OFF |
...
| Benchmark readiness product train | `P2-T21` … `P2-T37` **done**; **P9-T08 done** (`main@f24c282e`) | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Packages 1–14 delivered. No EVAL, Gate, release, Profile, B01, or Agent-benefit conclusion follows. | Owner activates EVAL-012 before B0. |
...
| `P9-T08/D04` | `done` | B01 procedure, bind runbook, `cells.json`, EVAL-012 scaffolding (not activated), leftover remote branch deleted. E7–E9 `not-run` (EVAL start gate). Merged PR [#247](https://github.com/agentkernel/cognitive-os/pull/247) at `main@f24c282e`. Required CI `32316092401` passed Ubuntu, Windows, and required-ci. | retain; owner activates EVAL-012 before B0 |
