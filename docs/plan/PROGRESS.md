...
| Active task lease | `lease/personal/P4-T05/resource-api` | P4-T05/D04 owns daemon-private remember admission and local Skill import/bind command callers on `personal/P4-T05-resource-api` | implement source mismatch, digest drift, unsafe import, incompatible binding, duplicate identity, and no-partial-write command negatives; public contract generation and B08 remain separate |
