...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | continue `P7-T01/D03` on `personal/P7-T01-release-pipeline` / Draft PR #184 |
| Active task lease | `lease/personal/P7-T01/release-pipeline` | P7 owns release-manifest/lib/PROGRESS/plan/checkpoints/tools-test paths on `personal/P7-T01-release-pipeline` / Draft PR #184 | validate D03 on DEV-LINUX-NATIVE-01; then D04 acceptance closure |
...
| P7-T01 Release pipeline, six-resource manifest, SBOM & attestation | `in-progress` | `lease/personal/P7-T01/release-pipeline` on `personal/P7-T01-release-pipeline` / Draft PR #184. D01–D02 closed at `c1f06f4` (Linux `release_manifest` 9/9 + Clippy). D03 adds immutable toolchain/environment/action pins + acquisition-lock trust ref without floating refs. | exact native Linux focused tests + Clippy; then D04 |
...
`P7-T01` is `in-progress` with unique slice `P7-T01/D03`. `P5-T05` is `done`
...
| `P7-T01/D03` | `in-progress` | immutable toolchain/environment/action pins + acquisition-lock trust ref without floating refs | exact native Linux focused module tests + Clippy; required CI |
