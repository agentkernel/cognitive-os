...
| Active task lease | `lease/personal/P2-T04/private-worker-composition`; `lease/personal/P2-T05/native-tool-registry-validation`; `lease/personal/P3-T01/context-request-binding` | P2-T04/D01 is active under `lane/personal-p2-t04-context-view` and owns the ContextView persistence continuation. Exact native Linux has passed for `8f2d6e5`; required Ubuntu/Windows CI passed for `3a6d19f`. P2-T05 owns the native catalog/validator review boundary. P3-T01/D01 owns the ContextRequest binding/persistence prerequisite. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | add the revoked-source integration negative for the ContextView-before-Pi boundary |
