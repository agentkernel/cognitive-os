...
| Active task lease | `lease/personal/P2-T04/private-worker-composition` | P2-T04/D01 is blocked under its narrow private-worker-composition lease. Pi remains candidate-only and the existing scheduler/verified-continuation authority remains daemon-owned. B02/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | decide the pre-admission candidate and durable Context binding path before implementation |
...
P1-T09 and P2-T03 remain in progress; P2-T03/D05 and P2-T07/D01 are done with
...
| `P2-T04/D01` | `blocked` | D05 native Linux closure is complete, but the existing WIA is post-admission while P2-T04 needs Pi candidate proposal before admission. The required durable Context source binding and Rust-to-Pi candidate bridge do not exist. | choose the daemon-owned pre-admission candidate and Context binding path; do not consume WIA merely to call Pi |
