...
| `P5-T01/D03` | `in-progress` | D02 activation and rollback authority is available at `f63a5c8916089ac8dbcbc0be741ebd92c4fc28ef`; uninstall/quarantine state and deletion guards do not yet exist. | implement durable pointer/package quarantine with lifecycle fail-closed checks, preserving user data/secrets and unrelated installations |
