...
| Active task lease | `none` | P7-T07 recorded its blocked closure on 2026-08-12 and released its lease; branch `personal/P7-T07-windows-install-surface` and Draft PR #200 are retained for resumption | claim one ready Personal task before editing |
