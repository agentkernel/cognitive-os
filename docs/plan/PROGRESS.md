...
| Active task lease | `lease/personal/P4-T05/resource-api` | P4-T05/D02 owns daemon-private Memory/Skill lifecycle application operations over existing authority facts on `personal/P4-T05-resource-api` | implement missing/stale/revoked/forgotten operation negatives and no-partial-write authority outcomes; public contract generation and B08 remain separate |
...
| P4-T05 Memory/Skill API and unified projection | `in-progress` | `P4-T05/D01` passed its task-channel, task-reference, management-crossing, and supported CI boundary; `P4-T05/D02` now owns the first authority-backed lifecycle application operations | implement missing/stale/revoked/forgotten operation negatives and no-partial-write authority outcomes; public contract generation and B08 remain separate |
...
| `P4-T05/D02` | `in-progress` | — | implement the first authority-backed Memory/Skill lifecycle application operations and failure-first no-partial-write negatives |
