...
| Active task lease | `lease/personal/P2-T03/scheduler-runtime-closure` | The dedicated P2-T03 task branch owns only the final acceptance mapping, closure evidence, and task-status reconciliation paths. P2-T03 is done; Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B05/B12, release, Profile, and Task completion remain separate/incomplete. | wait for required PR #160 CI, then merge and close the lease |
...
`P2-T01`, `P2-T02`, `P2-T03`, `P2-T04`, and `P2-T05` are done because their original
