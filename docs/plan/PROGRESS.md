...
| Active task lease | `lease/personal/P7-T01/release-pipeline`; `lease/personal/P5-T05/b09-managed-pi` | P7 owns release-manifest/lib/PROGRESS/plan/checkpoints paths; P5 retains B09 implementation paths without overlapping plan docs | await required CI on Draft PR #184 at `da0df7d`; then close D01 and start D02 |
