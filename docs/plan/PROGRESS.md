...
| P3-T06 B03 Context correctness and benefit collection | `in-progress` | `lease/personal/P3-T06/context-correctness` owns the preregistered B03 observation manifest and non-claim evaluator on `personal/P3-T06-context-correctness`; B03 remains `not-run` without a supported campaign execution. | implement and validate the B03 observation manifest boundary |
...
| Active task lease | `lease/personal/P3-T06/context-correctness` | P3-T06 is active on `personal/P3-T06-context-correctness`; the ignored local `/artifacts/` directory remains protected from modification, deletion, commitment, or implicit use. | implement the preregistered B03 observation manifest |
...
| `P3-T06/D01` | `in-progress` | Define a preregistered B03 observation manifest and non-claim evaluator that refuses incomplete Context correctness observations or any Gate authority. | add stale/unauthorized/required-source/false-completion and no-Gate-authority negatives |
