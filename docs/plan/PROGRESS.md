...
| Active task lease | `lease/personal/P4-T05/resource-api` | P4-T05/D05 owns final daemon-private Memory/Skill acceptance mapping on `personal/P4-T05-resource-api` | complete exact acceptance mapping and final supported validation evidence; public contract generation, B08, Gate, release, and Profile remain separate |
...
| P4-T05 Memory/Skill API and unified projection | `in-progress` | `P4-T05/D01-D04` provide task-bound projection, authority-backed explain reads, durable Memory forget/remember, Skill revoke/import/bind callers, and supported CI run `31335218082` passed on both required platforms | complete final acceptance mapping, evidence synchronization, and explicit non-claims; public contract generation and B08 remain separate |
...
| `P4-T05/D05` | `in-progress` | — | complete final P4-T05 acceptance mapping and closure evidence |
