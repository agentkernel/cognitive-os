...
| `P2-T37/D02` | `in-progress` | Public launcher and Extension mapping now expose WorkspaceWrite/Patch beside C1 tools without granting Pi-native filesystem/process tools. Exact public mutation Tasks and daemon lifecycle evidence remain outstanding. | run separate fresh public WorkspaceWrite and WorkspacePatch Tasks on exact pushed native-Linux revision |
