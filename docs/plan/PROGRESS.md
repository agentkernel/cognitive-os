...
| Active task lease | `lease/personal/P8-T01/doc-restructure` | `P8-T01/D03` is active on `personal/P8-T01-doc-restructure`; D01-D02 documentation sets are complete locally. Remaining: acceptance mapping, closure checkpoint, Draft PR/required CI, and task reconciliation. Documentation-only. | complete D03 closure mapping, push Draft PR, and reconcile after required CI |
...
| `P8-T01/D03` | `in-progress` | plan.md/traceability sync and local consistency/diff passed; Draft PR/required CI and final acceptance/lease reconciliation pending | push Draft PR, wait for required CI, then close task |
