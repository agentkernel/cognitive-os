...
| Active task lease | `lease/personal/P2-T27/user-lifecycle-backup` | P2-T26 merged via PR #225 at `main@9e1404a1`. Unique in-progress slice `P2-T27/D03`. Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226). D03 linux-002 at `5a561fbf`: store 23/23, CLI 2/2, HTTP 1/1, Pi lifecycle 1/1, recover 3/3, fencing 4/4, bins 329/329, workspace 0-failed, fmt, Clippy. Ubuntu `31939336791` **pass** at `5a561fbf`. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched (EVAL-004-only) | ready/merge Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226) after docs-closure CI |
...
| P2-T27 User lifecycle and backup/restore | **in-progress** | D01 public backup/restore complete at `6eea42c4`. D02 Pi install→recover complete at `cf7dd501`. D03 linux-002 matrix **pass** at `5a561fbf` (store 23/23, CLI 2/2, HTTP 1/1, Pi lifecycle 1/1, recover 3/3, fencing 4/4, bins 329/329, workspace 0-failed, fmt, Clippy `-D warnings`). Ubuntu [`31939336791`](https://github.com/agentkernel/cognitive-os/actions/runs/31939336791) **pass**. Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226). Windows `not-run by owner-directed Linux-only route`. Claim ceiling `hypothesis`; no Gate/release/Profile/B01/EVAL promotion | ready/merge after docs-closure CI |
...
| `P2-T27/D03` | `done` | Exact-revision `DEV-LINUX-NATIVE-01` at `5a561fbf`: `personal_backup` 23/23, CLI backup 2/2, HTTP 1/1, `p2_t27_pi_lifecycle` 1/1, fmt, Clippy `-D warnings`. Ubuntu `31939336791` at `5a561fbf` and `31939577639` at `9468c3b2` green. Windows `not-run by owner-directed Linux-only route` | ready/merge/lease/branch/main of PR [#226](https://github.com/agentkernel/cognitive-os/pull/226) |
