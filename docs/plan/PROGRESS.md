...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0 on the old freeze found a product gap that BR-01..BR-08 closed on `main`. New freeze must use a new campaign root, port, SecretStore entry, broker, runner, and denominator. Claim ceiling remains hypothesis/non-claim. Source archive `sha256:a871f5d32…` and guest root `/home/hal9001/perfeval004-20260816` are pinned; port `48286` unused; old `48284`/`48181` untouched. Exact-source `kernel-server` `sha256:ecc1bf39…` and `cognitive` `sha256:760ad2c7…` are in the new root | start campaign daemon on `127.0.0.1:48286`; new SecretStore item; do not start Provider samples |
| Benchmark readiness product train | `P2-T21` **done** at `5d1f5c2643d82807eb96f2c615d460dbdca749c3` / PR #220; `P2-T22` **done** at `03bc530d692649a00efa7918bfeadddf8ba0ebea` / PR [#221](https://github.com/agentkernel/cognitive-os/pull/221); `P2-T23` **done** at `795bfac8d8ee77b1b3be4137d33399fc817d20eb` / PR [#222](https://github.com/agentkernel/cognitive-os/pull/222); `P2-T24` **done** at `2b803e0fb955d03374e10569b4d9aecd0b4162d7` / PR [#223](https://github.com/agentkernel/cognitive-os/pull/223); `P2-T25` **done** at `4b10db9a64584bda42ae249bd1df289475bd6324` / PR [#224](https://github.com/agentkernel/cognitive-os/pull/224); `P2-T26` **done** at `9e1404a1b262a0e8588dbc2d1daac08ce419bd33` / PR [#225](https://github.com/agentkernel/cognitive-os/pull/225); `P2-T27` **done** at `70980131c34e514c8bfba681ca0ee7c8a8f92fdc` / PR [#226](https://github.com/agentkernel/cognitive-os/pull/226); `P2-T28` **done** at `1e71344a7b2c4a443fd0581e7fd33f21e970efbd` / PR [#227](https://github.com/agentkernel/cognitive-os/pull/227) | Owner instruction 2026-08-15 approved BR-01..BR-08 and the Linux-only product-validation route. Ubuntu is supporting CI; exact pushed-revision `DEV-LINUX-NATIVE-01` is required acceptance evidence for these product tasks; `B01-Desktop-Linux-002` remains owner-directed EVAL-004-only. Windows is `not-run by owner-directed Linux-only route`. This is product implementation evidence only, not EVAL/Gate/release/Profile/B01 evidence | BR train closed; continue EVAL-004 re-freeze under `lease/personal/EVAL-20260816/full-os-only-refreeze` |
...
| Active task lease | `lease/personal/EVAL-20260816/full-os-only-refreeze` | P2-T28 merged via PR [#227](https://github.com/agentkernel/cognitive-os/pull/227) at `main@1e71344a`. EVAL claim docs merged via PR [#228](https://github.com/agentkernel/cognitive-os/pull/228) at `main@f1fa00a1`. Evaluation lease for `PERSONAL-PERF-EVAL-004` re-freeze. Writable: evaluation plan/addendum, new preregistration, `PROGRESS.md` only. No product code. Claim ceiling `hypothesis` | start campaign daemon on `127.0.0.1:48286` from pinned binaries; new SecretStore item; do not reuse old SecretStore |
