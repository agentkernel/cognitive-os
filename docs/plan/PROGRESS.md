...
| Active task lease | `none` | P4-T04 is merged and its task lease is closed; no other Personal task lease is active | select the next implementation-ready formal task from the Personal plan |
