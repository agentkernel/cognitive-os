...
| Active task lease | `none` | P1-T09 remains `in-progress`; Attempt 10 succeeded and was cleaned up. B01 remains `running` with 10 completed attempts (2 successes, 8 failures). | continue with fresh Attempt 11 |
