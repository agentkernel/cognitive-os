...
| Personal P1-T04 | **bounded daemon + local auth in progress / local linker blocked** | `lane/personal-p1-t04-bounded-daemon-auth` | `--personal` front door + ADR-0022；CI pending for `p1_t04_personal_daemon`；非 G0/Profile claim |
