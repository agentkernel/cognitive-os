...
| Active task lease | `lease/personal/P4-T06/memory-skill-correctness` | P4-T06/D02 owns daemon-private same-task Memory/Skill consumption evidence on `personal/P4-T06-memory-skill-correctness`; D01 policy-binding boundary passed supported CI | add same-task trace/eligibility negatives and actual consumption evidence; B08 remains an independent Gate campaign |
...
| `P4-T06/D02` | `in-progress` | — | connect eligible Memory and Skill facts to a same-task Context/Task trace without client authority |
| `P4-T06/D03` | `ready` | — | complete final acceptance mapping and non-claim evidence |
