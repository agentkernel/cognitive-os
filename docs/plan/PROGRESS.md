...
| Active task lease | `lease/personal/P9-T12/live-paired-executor` | P9-T12 live campaign-only paired executor; evaluation routing OFF | keep Draft PR until full task acceptance |
...
| P9-T12 Live C1/C2 paired executor | **in-progress** (`P9-T12/D03`) | Branch `personal/P9-T12-live-paired-executor`; lease `lease/personal/P9-T12/live-paired-executor`. Running report: [P9-T12 validation](../checkpoints/20260820-personal-p9-t12-live-paired-executor-report.md). Claim ceiling `hypothesis`; no Gate/EVAL/release/Profile/B01/Agent-benefit promotion | complete supported validation, docs sync, Draft PR, and task closure; do not start EVAL-014 |
...
| `P9-T12/D03` | `in-progress` | Local `c1_c2_paired_p_arm` **24/24**; tools suite **88/88**; `check-consistency` / `check-handbook` / `generate-handbook --check` **pass**. Required CI / Draft PR / merge still open. | complete Draft PR, required CI, and ready/merge/lease/branch/main; do not start a new EVAL |
