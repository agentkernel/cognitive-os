...
| Active task lease | `none` | P3-T06/B03 MVP passed under ADR-0040 and PR #171 merged at `main@175b1974183fcfd4063bc5a3cd8e9f110af3980e`; the task lease is closed and no task branch remains active. | select the next ready Personal task; B03 MVP does not pass GMVP-LINUX, release, Profile, B06/B07, or UCR-01 utility |
