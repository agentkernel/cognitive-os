...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-012` and `PERSONAL-PERF-EVAL-013` **closed**. `P9-T12` **in-progress** (live paired executor). Do not reopen EVAL-012/013. Do not claim P7-T07 (blocked on B01-W) or jump to post-1.0 P6 / P7-T05 |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-013` **closed** (2026-08-20) on `evaluation/EVAL-013-freeze`. Evaluation routing OFF. B0 C1/C2a P/O fairness **pass**; B1/B2 **not-run** because `paired-runner.mjs` was dry-run only (execution plan §2.5). EVAL-012 remains **closed**. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Product pin `6c415625c0ca12e9f8e51d139da601eb475ee231`. Claim ceiling `hypothesis`; `not_reviewed`. Freeze-branch report is not required on `main` for this product task | none for this campaign — product follow-up is **P9-T12** |
| Owner-directed C1/C2 campaign | EVAL-012 closed (B0 fairness fail). EVAL-013 closed (B0 C1/C2a pass; B1/B2 not-run, missing live paired executor). | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | complete **P9-T12**; do not start a new EVAL in this task |
| Active task lease | `lease/personal/P9-T12/live-paired-executor` | Draft PR [#252](https://github.com/agentkernel/cognitive-os/pull/252); evaluation routing OFF | required CI, then keep Draft until full task acceptance |
| Benchmark readiness product train | `P2-T21` … `P2-T38` **done**; **P9-T08 done**; **P9-T09 done**; **P9-T10 done**; **P9-T11 done**; **P9-T12 in-progress**; `PERSONAL-PERF-EVAL-012` and `PERSONAL-PERF-EVAL-013` **closed** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Live `--append-system-prompt` and comparable C2a unified-diff Patch are merged. Remaining mutex before B1/B2 is a frozen live paired executor. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | finish P9-T12; a later owner-activated EVAL may run B1/B2 |
| P9-T12 Live C1/C2 paired executor | **in-progress** (`P9-T12/D03`) | Draft PR [#252](https://github.com/agentkernel/cognitive-os/pull/252) at `f58f2b8e`. Local `c1_c2_paired_p_arm` **24/24**; tools suite **88/88**. Running report: [P9-T12 validation](../checkpoints/20260820-personal-p9-t12-live-paired-executor-report.md). Claim ceiling `hypothesis`; no Gate/EVAL/release/Profile/B01/Agent-benefit promotion | required CI on the Draft PR head, then ready/merge/lease/branch/main; do not start EVAL-014 |
| P9-T11 Comparable C2a Patch unified-diff | **done** | Merged PR [#251](https://github.com/agentkernel/cognitive-os/pull/251) at `main@49b66200`. Local `c1_c2_paired_p_arm` **19/19**; tools suite **83/83**. Required CI `32359826035` at `6fe018cf` passed Ubuntu, Windows, and required-ci. Lease closed. Running report: [P9-T11 validation](../checkpoints/20260820-personal-p9-t11-c2a-patch-unified-diff-report.md). | retain; next is P9-T12 live paired executor |
...
| `P9-T12/D03` | `in-progress` | Draft PR [#252](https://github.com/agentkernel/cognitive-os/pull/252) at `f58f2b8e`. Local `c1_c2_paired_p_arm` **24/24**; tools suite **88/88**; `check-consistency` / `check-handbook` / `generate-handbook --check` **pass**. Required CI still open. | required CI green, then ready/merge/lease/branch/main; do not start a new EVAL |
