...
| Active task lease | `none` | P2-T15's task-scoped lease is closed in the [Parallel Lanes](PARALLEL-LANES.md) archive after complete supported/native validation and a no-findings final review. All evaluation leases remain closed; P7-T07 remains blocked on B01-W prerequisites | retain P2-T15 closure evidence; after PR #208 merges, reconcile branch/main cleanly |
