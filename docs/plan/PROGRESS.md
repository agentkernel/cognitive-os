...
| Active task lease | `lease/personal/P2-T37/c2a-public-mutation-path` | P2-T37/D02 is in progress on `personal/P2-T37-c2a-public-mutation-path` / Draft PR [#246](https://github.com/agentkernel/cognitive-os/pull/246) at `40787044`. Public Write passed. Patch Provider bind passed. Three public Patch Tasks acquired a lease then `NOT_EXECUTED`. | Use the new production-sink fixture test plus a fresh public Task once Linux/CI oracle lands. |
