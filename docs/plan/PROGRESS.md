...
| Active task lease | `lease/personal/P2-T29/c1-c2-enablement` | Draft PR [#230](https://github.com/agentkernel/cognitive-os/pull/230) at `a317d817`. D01/D02 done; D03 linux-002 matrix pass; Ubuntu `31999496789` pass; windows-latest pending | wait Windows CI, then ready/merge/lease/branch/main; then owner-directed EVAL freeze (do not auto-claim another `P*-T*`) |
...
|---|---|---|---|
| `P2-T29/D01` | `done` | Local Node 92/92; linux-002 `daemon_candidate_protocol` 14/14; Ubuntu `31999496789` green at `a317d817` | consumed by D03 closure |
| `P2-T29/D02` | `done` | linux-002 `p4_t05_resource_api` 7/7 unsealed remember + caller-header 400 | consumed by D03 closure |
| `P2-T29/D03` | `in-progress` | Exact `a317d817` on `DEV-LINUX-NATIVE-01`: p4 7/7, adapter 14/14, workspace 0-failed, bin 336/336, Clippy `-D warnings`, fmt. Ubuntu `31999496789` pass. Keep in-progress until ready/merge | wait windows-latest on run `31999496789`, then ready/merge/lease/branch/main |
