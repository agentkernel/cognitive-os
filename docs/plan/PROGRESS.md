...
| `P5-T01/D02` | `in-progress` | D01's authoritative immutable lock is available at `39b0e06e804947f9bd6c4a67295ffd4f4ccd3231`; no installation-root activation state exists yet. | implement a durable, acquisition-lock-only versioned activation transaction with failure-first upgrade/rollback negatives and no P5-T02 identity/supervision scope |
