...
| Active task lease | `lease/personal/P2-T03/worker-input-contract` | P2-T03/D05 public worker-input authority contract, immutable candidate persistence, and scheduler consumption is the sole active P2 slice; B02/B04/B05/B12, release, and Profile remain separate and incomplete | implement immutable authorization issuance/consumption and restart-safe worker recovery without minting progress or completion from worker output |
