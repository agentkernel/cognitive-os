...
| Active task lease | `lease/personal/EVAL-011/c1-c2-b0-qualification` | Owner-directed EVAL-011 supersedes P2-T36 continuation while active. It writes only the EVAL-011 preregistration, one running report, and this snapshot; no product task, code, contract, test, generated handbook source, or P2-T36 path is writable in the campaign. Source is immutable pushed `979e52e4c6681d0fc8c6431c965e3267a7a0d917`. | record B01 baseline/snapshot facts, then freeze the exact source and isolated guest allocation as preregistered |
