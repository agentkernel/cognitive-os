...
| Active task lease | `lease/personal/P2-T33/private-candidate-host-path` | P2-T33/D01 private-candidate host path after EVAL-009 close; branch `personal/P2-T33-private-candidate-host-path` | push D01 then exact-revision linux-002 focused `p2_t33` |
