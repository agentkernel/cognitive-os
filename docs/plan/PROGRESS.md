...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **paused before B1; evaluation lease closed** | B0 target and runtime readiness were qualified without any B1/B2/B3/B4 sample. The campaign discovered a product gap: the private candidate carrier persists only parameters_digest, while the production WorkspaceSearch/WorkspaceWrite/WorkspacePatch router requires canonical governed parameters. EVAL-002 remains closed and unchanged; claim ceiling remains hypothesis/non-claim | P2-T27 **in-progress** D03 on PR [#226](https://github.com/agentkernel/cognitive-os/pull/226). Unique next: equality/migration/RTO/RPO/lifecycle/cleanup matrix and task close. EVAL-004 re-freeze only after BR-02..BR-08 are merged; no prior campaign asset or SecretStore entry is reused |
| Benchmark readiness product train | `P2-T21` **done** at `5d1f5c2643d82807eb96f2c615d460dbdca749c3` / PR #220; `P2-T22` **done** at `03bc530d692649a00efa7918bfeadddf8ba0ebea` / PR [#221](https://github.com/agentkernel/cognitive-os/pull/221); `P2-T23` **done** at `795bfac8d8ee77b1b3be4137d33399fc817d20eb` / PR [#222](https://github.com/agentkernel/cognitive-os/pull/222); `P2-T24` **done** at `2b803e0fb955d03374e10569b4d9aecd0b4162d7` / PR [#223](https://github.com/agentkernel/cognitive-os/pull/223); `P2-T25` **done** at `4b10db9a64584bda42ae249bd1df289475bd6324` / PR [#224](https://github.com/agentkernel/cognitive-os/pull/224); `P2-T26` **done** at `9e1404a1b262a0e8588dbc2d1daac08ce419bd33` / PR [#225](https://github.com/agentkernel/cognitive-os/pull/225); `P2-T27` D03 in progress; `P2-T28` registered and not started | Owner instruction 2026-08-15 approved BR-01..BR-08 and the Linux-only product-validation route. Ubuntu is supporting CI; exact pushed-revision `DEV-LINUX-NATIVE-01` is required acceptance evidence for these product tasks; `B01-Desktop-Linux-002` remains owner-directed EVAL-004-only. Windows is `not-run by owner-directed Linux-only route`. This is product implementation evidence only, not EVAL/Gate/release/Profile/B01 evidence | wait Ubuntu `31939336791` at `5a561fbf` then close P2-T27. EVAL-004 re-freeze happens only after every BR product task is merged |
...
| Active task lease | `lease/personal/P2-T27/user-lifecycle-backup` | P2-T26 merged via PR #225 at `main@9e1404a1`. Unique slice `P2-T27/D03` complete. Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226). D03 linux-002 at `5a561fbf`: store 23/23, CLI 2/2, HTTP 1/1, Pi lifecycle 1/1, recover 3/3, fencing 4/4, fmt, Clippy. Ubuntu `31939336791` at `5a561fbf` and `31939577639` at `9468c3b2` **pass**. Windows `not-run by owner-directed Linux-only route`. `B01-Desktop-Linux-002` untouched (EVAL-004-only) | ready/merge Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226) |
...
| P2-T27 User lifecycle and backup/restore | **in-progress** | D01 public backup/restore complete at `6eea42c4`. D02 Pi install→recover complete at `cf7dd501`. D03 linux-002 matrix **pass** at `5a561fbf` (store 23/23, CLI 2/2, HTTP 1/1, Pi lifecycle 1/1, recover 3/3, fencing 4/4, fmt, Clippy `-D warnings`). Ubuntu [`31939336791`](https://github.com/agentkernel/cognitive-os/actions/runs/31939336791) and [`31939577639`](https://github.com/agentkernel/cognitive-os/actions/runs/31939577639) **pass**. Draft PR [#226](https://github.com/agentkernel/cognitive-os/pull/226). Windows `not-run by owner-directed Linux-only route`. Claim ceiling `hypothesis`; no Gate/release/Profile/B01/EVAL promotion | ready/merge PR [#226](https://github.com/agentkernel/cognitive-os/pull/226) |
...
| `P2-T27/D03` | `in-progress` | Exact-revision `DEV-LINUX-NATIVE-01` at `5a561fbf`: `personal_backup` 23/23, CLI backup 2/2, HTTP 1/1, `p2_t27_pi_lifecycle` 1/1, recover 3/3, fencing 4/4, bins 329/329, workspace 0-failed, fmt, Clippy `-D warnings`. Ubuntu `31939336791` at `5a561fbf` and `31939577639` at `9468c3b2` green. Windows `not-run by owner-directed Linux-only route` | ready/merge/lease/branch/main of PR [#226](https://github.com/agentkernel/cognitive-os/pull/226) |
| `P2-T28/D01` | `ready` | Registered formal slice; implementation has not started | waits for P2-T27 closure and its own task lease |
| `P2-T28/D02` | `ready` | Registered formal slice; implementation has not started | waits for D01 within the same future task branch and lease |
