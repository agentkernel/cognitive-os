...
| Active task lease | `none` | the coherent-bundle implementation slice is closed; deployment needs a separate lease and authorized protected signing-material workflow | claim a deployment-only P1-T09 lease after the signing workflow is available |
