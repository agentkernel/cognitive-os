...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0/B1/B2 C0 **pass**. UJ3/T-GOV/B4 local **pass**; MS-AUTH **partial**; B3 **partial**; B5 1 h **pass** (1620/1620). B5 8 h soak in progress (pid 241537). Remaining O/T/UJ cells dispositioned `not-run`/`not_available`/queued-after-soak. Claim ceiling hypothesis/non-claim | wait for B5 8 h `CELL_DONE`; then UJ4/T2/UJ2, cleanup |
