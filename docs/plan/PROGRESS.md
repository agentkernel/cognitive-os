...
| Active task lease | `lease/personal/P4-T04/skill-package` | P4-T04/D03 owns immutable same-package revision lineage and exact-pin stability on `personal/P4-T04-skill-package` | validate supersession at exact native Linux and required CI, then complete the task acceptance assessment without a public API/projection claim |
...
| `P4-T04/D03` | `in-progress` | SQLite v23 same-package revision supersession preserves old exact pins and rejects competing lineage locally; supported validation has not run for this revision. | run focused native Linux store/Clippy validation and required CI, then map the completed package/revision/import/binding/supersede/revoke/explain acceptance |
