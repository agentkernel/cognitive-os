...
| Active task lease | `none` | P2-T03 closed in merged PR #160 after required Ubuntu and Windows/MSVC CI passed. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B05/B12, release, Profile, and Task completion remain separate/incomplete. | select a non-overlapping ready formal task and create its dedicated branch, Draft PR, and lease before writing implementation |
