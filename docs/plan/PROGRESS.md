...
| Active task lease | `lease/personal/P3-T02/context-builder` | P3-T02 acceptance and validation are complete; its lease remains active only until PR #166 merges and branch closure completes. This does not alter B01's `running` state, ledger, or claim boundary. | merge PR #166, close the lease, and reconcile the task branch |
