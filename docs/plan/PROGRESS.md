...
| Active task lease | `lease/personal/P2-T05/native-tool-registry-validation` | P2-T05 acceptance is complete and PR #159 has its required CI evidence. Its lease remains active only until the ready/merge/branch-closure procedure completes. Pi remains candidate-only and scheduler/verified-continuation authority remains daemon-owned. B02/B03/B04/B05/B12, release, Profile, and Task completion remain separate/incomplete. | complete P2-T05 PR closure; no new formal task may join the legacy shared branch |
...
`P2-T01`, `P2-T02`, `P2-T04`, and `P2-T05` are done because their original acceptance
criteria and required evidence were satisfied without removing or weakening
any criterion. P1-T09, P2-T03, P2-T07, and P3-T01 remain in progress; P2-T03/D05 and P2-T07/D01 are done with
