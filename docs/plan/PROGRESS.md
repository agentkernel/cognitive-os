...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | EVAL-008 **closed**. P2-T32 remains in-progress pending Windows merge (lease already closed). P7-T07 remains blocked on B01-W prerequisites. Campaign closure does not resume development |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-008` **closed** (owner 2026-08-18). Public `cognitive daemon start` + real adapter C1/C2 B0 stayed `DRAFT` (`lease_acquired` 0, no Pi child; skip class `private_completion_socket_could_not_be_created` on `daemon.log`). Evaluation routing OFF. `PERSONAL-PERF-EVAL-007`, `PERSONAL-PERF-EVAL-006`, `PERSONAL-PERF-EVAL-005`, and `PERSONAL-PERF-EVAL-004` remain **closed**. | Final: [personal-performance-assessment-20260818-eval-008.md](../evaluation/personal-performance-assessment-20260818-eval-008.md). Preregistration: [20260818-personal-perf-eval-008-preregistration.md](../checkpoints/20260818-personal-perf-eval-008-preregistration.md). Do not reopen EVAL-004/005/006/007/008. Do not reuse those roots, ports `48286`/`48288`/`48290`/`48292`/`48294`/`48386`/`48388`/`48390`/`48392`/`48394`, or SecretStore `/12`–`/17`. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — closure does not resume development |
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-008 **closed**; PERSONAL-PERF-EVAL-007 **closed**; PERSONAL-PERF-EVAL-006 **closed**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | P2-T32 stub pass ≠ real adapter. EVAL-008 B0 partial on `fb85cfff` / `48294` / `/17`. Claim ceiling hypothesis/`not_reviewed` | none — do not reuse EVAL-004/005/006/007/008 assets |
| Active task lease | `none` | EVAL-008 closed; P2-T32 lease already closed pending Windows merge of PR [#239](https://github.com/agentkernel/cognitive-os/pull/239) | none — campaign closure does not resume development |
