...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-012` **closed**. `P2-T38` and `P9-T09` **done**. **P9-T10 D03** ready/merge of PR [#250](https://github.com/agentkernel/cognitive-os/pull/250). P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-012` **closed** (2026-08-20) on `evaluation/EVAL-012-freeze` @ `177669b7`. Evaluation routing OFF. B0 fairness **fail** (`system_task_prompt_bytes`) blocked B1/B2. C2a O Patch fail retained. Cleanup **pass**. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Report and freeze live on `evaluation/EVAL-012-freeze` (`docs/evaluation/personal-performance-assessment-20260820-eval-012.md`, `docs/checkpoints/20260820-personal-perf-eval-012-preregistration.md`). Product pin `370b26fcc05976c7c1c97e5510a99ed3ebc23f2c`. Claim ceiling `hypothesis`; `not_reviewed` | none for this campaign — product follow-up is P9-T10 |
| Owner-directed C1/C2 campaign | `PERSONAL-PERF-EVAL-012` closed. B0 did not pass fairness. C1 O/P and C2a Write ran; C2a Patch O fail retained. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | P9-T10 live `--append-system-prompt`; do not reopen EVAL-012 |
| Active task lease | `lease/personal/P9-T10/live-prompt-injection` | unique in-progress slice `P9-T10/D03`; evaluation routing OFF | ready/merge PR [#250](https://github.com/agentkernel/cognitive-os/pull/250) then lease/branch/main |
| Benchmark readiness product train | `P2-T21` … `P2-T38` **done**; **P9-T08 done**; **P9-T09 done**; **P9-T10 D01–D02 done / D03 in-progress**; `PERSONAL-PERF-EVAL-012` **closed** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Packages 1–14 delivered. Live `--append-system-prompt` injection is proven on Linux and required CI. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | merge P9-T10; do not activate a new EVAL until after closure |
| P9-T10 Live P/O `--append-system-prompt` | **in-progress** (`P9-T10/D03`) | Branch `personal/P9-T10-live-prompt-injection`. Lease `lease/personal/P9-T10/live-prompt-injection`. Draft PR [#250](https://github.com/agentkernel/cognitive-os/pull/250). Local `c1_c2_paired_p_arm` **16/16**. Linux exact `745c60d8`: admin-cli `append_system_prompt` **3/3**, print-mode regression **1/1**, Clippy `-D warnings`, fmt. Required CI `32350029054` passed Ubuntu, Windows, and required-ci. Running report: [P9-T10 validation](../checkpoints/20260820-personal-p9-t10-live-prompt-injection-report.md). | ready/merge, then lease/branch/main |
...
| `P9-T10/D03` | `in-progress` | Required CI `32350029054` passed Ubuntu, Windows, and required-ci at `745c60d8`. Draft PR [#250](https://github.com/agentkernel/cognitive-os/pull/250) `CLEAN`. | ready/merge, then lease/branch/main |
