...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-012` **active** (2026-08-20). Measurement-only. Evaluation routing ON. Packages 1–14 remain historical/readiness evidence. Package 15 (B0) is the unique next measurement step; B1/B2 wait on B0 pass. EVAL-002 and EVAL-004 through EVAL-011 remain **closed**. | Plan: [personal-perf-eval-012-preregistration.md](../evaluation/personal-perf-eval-012-preregistration.md). Freeze: [20260820-personal-perf-eval-012-preregistration.md](../checkpoints/20260820-personal-perf-eval-012-preregistration.md). Running report: [personal-performance-assessment-20260820-eval-012.md](../evaluation/personal-performance-assessment-20260820-eval-012.md). Product pin `370b26fcc05976c7c1c97e5510a99ed3ebc23f2c`. Isolation: root `/home/hal9001/perfeval012-20260820`, daemon `127.0.0.1:48300`, broker `127.0.0.1:48400`, SecretStore `/24` (≠ `/12`–`/19`). Do not reopen EVAL-004/005/006/007/008/009/010/011. Do not reuse those roots, ports `48286`–`48298` / `48386`–`48398` / `48383`, SecretStore `/12`–`/19`, or P2-T37 roots `p2-t37-c2a-write-20260820` / `p2-t37-c2a-patch-20260820`. Claim ceiling `hypothesis`; `not_reviewed` | unique next action: E9/doctor **pass**. B0 C1 O-arm Search+Read **pass** (seed `sha256:a194b2f561562663`; `lease_acquired: 1`; `COMPLETED`). Start P-arm broker `48400` and C1 P-arm, then C2a–d (`retry=0`; retain every started sample). |
| Owner-directed C1/C2 campaign | Owner-activated `PERSONAL-PERF-EVAL-012`. Freeze/E9/doctor **pass**. B0 C1 O-arm **pass**. P-arm and C2a–d not started. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | Start C1 P-arm broker `48400`; then C2a–d. |
| Active task lease | `lease/personal/EVAL-012/c1-c2-paired-b0` | `PERSONAL-PERF-EVAL-012` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | C1 P-arm then C2a–d B0 cells |
...
| `EVAL-012/B0` | `in-progress` | E9/doctor **pass**. B0 C1 O-arm Search+Read **pass** at seed `sha256:a194b2f561562663` (`COMPLETED`, `lease_acquired: 1`). SecretStore `/24`. Daemon `48300` pid 326605. C1 P-arm and C2a–d not started. | Start broker `48400` and C1 P-arm; then C2a–d |
