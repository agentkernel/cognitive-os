...
|---|---|---|---|
| Project focus | `cognitiveos-personal`: active and sole implementation project | CognitiveOS architecture assets remain reference/contract inputs; no second product backlog | `PERSONAL-PERF-EVAL-013` **active**. Complete the parent execution plan on this freeze. Do not reopen EVAL-012. P7-T07 remains blocked on B01-W prerequisites |
| Owner-directed campaign | `PERSONAL-PERF-EVAL-013` **active** (2026-08-20) on `evaluation/EVAL-013-freeze`. Evaluation routing ON. Product pin `6c415625c0ca12e9f8e51d139da601eb475ee231`. Isolation: `/home/hal9001/perfeval013-20260820`, daemon `48302` pid 336122, SecretStore `/25`. Freeze/doctor **pass**. B0 **pass** (C1/C2a comparable + fairness 13/13). B1–B5/C0 `not-run`. EVAL-002 and EVAL-004 through EVAL-012 remain **closed**. | Preregistration: [EVAL-013 freeze](../checkpoints/20260820-personal-perf-eval-013-preregistration.md), [EVAL-013 preregistration](../evaluation/personal-perf-eval-013-preregistration.md). Running report: [EVAL-013 assessment](../evaluation/personal-performance-assessment-20260820-eval-013.md). Claim ceiling `hypothesis`; `not_reviewed` | cleanup then close; do not cobble B1 |
| Owner-directed C1/C2 campaign | Owner-activated `PERSONAL-PERF-EVAL-013`. Packages 1–14 and P9-T09–T11 closed. EVAL-012 packages 15–17 remain closed measurement. | Plan: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Claim ceiling `hypothesis`; no Gate, release, Profile, B01, or Agent-benefit promotion. | guest freeze then B0 qualification on this pin |
| Active task lease | `lease/personal/EVAL-013/execution-plan-b0` | `PERSONAL-PERF-EVAL-013` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | cleanup: stop `48302`/`48402`; clear `/25` only |
| Benchmark readiness product train | `P2-T21` … `P2-T38` **done**; **P9-T08 done**; **P9-T09 done**; **P9-T10 done**; **P9-T11 done**; `PERSONAL-PERF-EVAL-012` **closed**; `PERSONAL-PERF-EVAL-013` **active** | Navigation: [PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md](PERSONAL-C1-C2-READINESS-DELIVERY-PLAN.md). Packages 1–14 delivered. Live `--append-system-prompt` and comparable C2a unified-diff Patch are merged. No Gate, release, Profile, B01, or Agent-benefit conclusion follows. | execute parent plan on EVAL-013; missing runner = `not-run` |
| P9-T11 Comparable C2a Patch unified-diff | **done** | Merged PR [#251](https://github.com/agentkernel/cognitive-os/pull/251) at `main@49b66200`. Local `c1_c2_paired_p_arm` **19/19**; tools suite **83/83**. Required CI `32359826035` at `6fe018cf` passed Ubuntu, Windows, and required-ci. Lease closed. Running report: [P9-T11 validation](../checkpoints/20260820-personal-p9-t11-c2a-patch-unified-diff-report.md). | retain; next is a new EVAL |
