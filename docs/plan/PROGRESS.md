...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-013` **active** (2026-08-20) on `evaluation/EVAL-013-freeze`. Evaluation routing ON. Product pin `6c415625c0ca12e9f8e51d139da601eb475ee231`. Isolation: `/home/hal9001/perfeval013-20260820`, daemon `48302` pid 336122, SecretStore `/25`. Freeze/doctor **pass**. EVAL-002 and EVAL-004 through EVAL-012 remain **closed**. | Preregistration: [EVAL-013 freeze](../checkpoints/20260820-personal-perf-eval-013-preregistration.md), [EVAL-013 preregistration](../evaluation/personal-perf-eval-013-preregistration.md). Running report: [EVAL-013 assessment](../evaluation/personal-performance-assessment-20260820-eval-013.md). Claim ceiling `hypothesis`; `not_reviewed` | B0 qualification; do not open B1 until B0 fairness passes |
...
| Active task lease | `lease/personal/EVAL-013/execution-plan-b0` | `PERSONAL-PERF-EVAL-013` measurement-only; writable paths limited to EVAL docs, the freeze checkpoint, and `PROGRESS.md` | B0 C1 O-arm with live `--append-system-prompt`, then P-arm broker `48402` |
