...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0/B1/B2 C0 **pass**. UJ3/T-GOV/B4 local **pass**; MS-AUTH **partial**; B3 **partial**; B5 1 h **pass** (1620/1620). B5 8 h soak in progress. C1/C2 paired adapter `not-run`. Claim ceiling hypothesis/non-claim | wait for B5 8 h soak pid on guest |
