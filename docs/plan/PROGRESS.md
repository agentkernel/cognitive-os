...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-004 **active re-freeze**; prior 2026-08-15 lease closed and not reused | B0/B1/B2 C0 **pass**. UJ3/T-GOV/B4 local **pass**; MS-AUTH **partial**; B3 **partial**; B5 1 h **pass**; B5 8 h **pass** (12960/12960, 0 non-OK, 7/7 restarts, RSS −20 kB/8 h). B5 24 h **`not-run`**. C1/C2 paired adapter `not-run`. Claim ceiling hypothesis/non-claim | UJ4 30 admissions, then T2, then UJ2 cold with `--bind`, then cleanup |
