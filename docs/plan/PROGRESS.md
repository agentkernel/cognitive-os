...
| Active task lease | `lease/personal/P8-T11/provider-stream-dsh-runtime` | P8-T10 remains `done` on PR [#256](https://github.com/agentkernel/cognitive-os/pull/256). P8-T09 remains `done`. EVAL-015 remains closed. | D04: required CI + ready/merge/lease/branch/main; do not auto-claim P6 / P7-T05 / P7-T06 / P7-T07 |
| P8-T11 Provider streaming + dsh runtime inspect | **in-progress** (`P8-T11/D04`) | linux-002 identity pass at `4b191740`. Root cause of P8-T10 ~10.5 s: tsx-from-source on the 2 vCPU guest, not Provider TTFB (raw stream 1056 ms / TTFB 270 ms). Compiled dsh CLI Path A p50 3181 ms vs Path B 3654 ms (overhead 473 ms); n=5/5 discarded 0. Public SSE pass-through; `cognitive dsh status` ACTIVE→CRASHED→INACTIVE. Cleanup **pass**. Draft PR [#257](https://github.com/agentkernel/cognitive-os/pull/257). Running report: [P8-T11 report](../checkpoints/20260822-personal-p8-t11-provider-stream-dsh-runtime-report.md). Claim ceiling `hypothesis`. | D04: required CI green, then ready/merge/lease/branch/main |
...
Owner follow-on `P8-T11` is `in-progress` at `P8-T11/D04` (D01–D03 evidence
on linux-002 at `4b191740`). Provider SSE pass-through, dsh OS runtime
inspect, compiled-lib latency fix, and real-task Path A/B. Do not auto-claim
P6 / P7-T05 / P7-T06 / P7-T07.
...
| `P8-T11/D04` | `in-progress` | Running report written. Jump-host Rust **pass** at `4b191740`. Prior CI `32549721560` failed unique-slice consistency (D01+D02 both in-progress). | required CI on this docs head, then ready/merge/lease/branch/main |
