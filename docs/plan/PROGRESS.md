...
| Active task lease | `none` | P2-T18 lease closed after PR [#215](https://github.com/agentkernel/cognitive-os/pull/215) merged as `main@203b3fca69b9a879fcbb5e933a5305141fcfb442`; the closed row is archived in Parallel Lanes. No P2-T14 path or root worktree change was included | retain P2-T18 closure evidence; active work continues only through separately owned branches/leases |
