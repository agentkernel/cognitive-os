...
| Active task lease | `none` | EVAL-010 lease closed 2026-08-18; P2-T33 remains in-progress pending Windows merge of PR [#240](https://github.com/agentkernel/cognitive-os/pull/240) | next product task is the digest/fields skip; campaign closure does not by itself resume development |
