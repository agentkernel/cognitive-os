...
| Owner-directed campaign | `PERSONAL-PERF-EVAL-006` **active**. Frozen product target `main@103fe776` (P2-T30 closed). Freeze **pass** (root `/home/hal9001/perfeval006-20260817`, daemon `127.0.0.1:48290` pid 273829, SecretStore `/15`, Pi `0.81.1`). C1/C2 paired B0 next. Claim ceiling `hypothesis`; `not_reviewed`. Evaluation routing ON. Measurement-only: no product-code patch. `PERSONAL-PERF-EVAL-005` and `PERSONAL-PERF-EVAL-004` remain **closed**. | Preregistration: [20260817-personal-perf-eval-006-preregistration.md](../checkpoints/20260817-personal-perf-eval-006-preregistration.md). Running report: [personal-performance-assessment-20260817-eval-006.md](../evaluation/personal-performance-assessment-20260817-eval-006.md). Do not reuse EVAL-004/005 roots, ports `48286`/`48288`/`48386`/`48388`, or SecretStore `/12`/`/13`/`/14` | run C1/C2 paired B0 |
...
| Owner-directed C1/C2 campaign | PERSONAL-PERF-EVAL-006 **active**; PERSONAL-PERF-EVAL-004 **closed**; PERSONAL-PERF-EVAL-005 **closed** | EVAL-006 freeze pass; C1/C2 paired B0 next. Do not reuse EVAL-004/005 roots, ports, or SecretStore `/12`/`/13`/`/14`. Claim ceiling hypothesis/`not_reviewed` | B0 C1/C2 paired |
| Active task lease | `lease/personal/EVAL-006/c1-c2-paired-freeze` | `PERSONAL-PERF-EVAL-006` C1/C2 paired freeze on `evaluation/EVAL-006-freeze`; product `main@103fe776` | B0 C1/C2 paired |
