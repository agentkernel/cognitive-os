...
| Active task lease | `lease/personal/P2-T07/checkpoint-artifact-verifier` | P2-T06 is merged and its lease is closed. P2-T07/D01 remains the completed private continuation prerequisite; this lease owns the next daemon-private checkpoint/artifact/evidence/verifier path. B05/B12, release, Profile, and managed-Pi production supervision remain separate/incomplete. | implement the smallest vertical P2-T07 checkpoint/artifact/verifier slice; keep all outputs non-authoritative until independently verified |
