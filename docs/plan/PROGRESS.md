...
| Active task lease | `lease/personal/P7-T04/performance-governance` | `P7-T04/D02` closed at exact revision `7738471f4a2934facfff71a50d221194b991c4b5` with native Linux stage-collector evidence at `b605386` and required CI run `31375051991`. `P7-T04/D03` is now the unique in-progress Slice on Draft PR #179 for B06/B07 non-claim raw observations versus full replay. | finish D03 observation report/tests, validate with tools tests and required CI, then enter D04 |
...
| P7-T04 Performance campaign and regression floor | `in-progress` | `P7-T04/D01` and `P7-T04/D02` are closed on Draft PR #179. D02 exact native Linux `perf::tests` 5/5 plus required CI run `31375051991` passed at `7738471`. `P7-T04/D03` is the unique in-progress Slice for B06/B07 non-claim observations. | complete D03-D05; B06/B07 remain observations and do not become GMVP-LINUX hard gates |
...
| `P7-T04/D03` | `in-progress` | Collect B06/B07 stable/changed raw observations against full replay with complete denominator and safety accounting; non-claim only. | implement and validate the UCR-bound B06/B07 observation report, then continue D04 |
