...
| Active task lease | `lease/personal/P2-T30/scheduler-lease-acquisition` | P2-T30/D03 ready/merge of PR #233 on `personal/P2-T30-scheduler-lease-acquisition` at `85d6a2bb` | ready/merge PR #233 after D03 report commit |
...
| P2-T30 Public-admit scheduler lease acquisition | **in-progress** | D01–D02 implemented. Exact `85d6a2bb` linux-002: focused public-admit test pass, kernel-server bin 337/337, workspace 0-failed, Clippy `-D warnings`, fmt. CI `32020479890` Ubuntu/Windows/`required-ci` green. Draft PR [#233](https://github.com/agentkernel/cognitive-os/pull/233). Windows GNU Rust `not-run`. | ready/merge PR #233, then close lease |
...
| `P2-T30/D03` | `in-progress` | Exact `85d6a2bb` linux-002: focused 1/1, kernel-server bin 337/337, workspace 0-failed, Clippy `-D warnings`, fmt. CI `32020479890` Ubuntu/Windows/`required-ci` green. | ready/merge PR #233 |
