...
|---|---|---|---|---|---|---|---|
| `lease/personal/P2-T21/governed-candidate-parameters-terminal-evidence` | `P2-T21/D01-D03` governed candidate parameters and terminal evidence | Lane-CTR | `personal/P2-T21-candidate-parameters-terminal-evidence` | `specs/schemas/operation-candidate-proposal.schema.json`; generated contract bindings; `apps/pi-agent-adapter/src/lib.rs`; `apps/pi-agent-adapter/src/main.rs`; `apps/kernel-server/src/personal/{pi_runtime.rs,task_api.rs,server.rs,scheduler_authority/**,tool_executor/router.rs}`; `apps/admin-cli/src/personal_cli/{client.rs,mod.rs}`; focused tests; `docs/plan/{PERSONAL-DEVELOPMENT-PLAN.md,PROGRESS.md,personal-trace.yaml}`; task checkpoint/handbook paths if contract surface requires them | Cursor product delivery session | 2026-08-15 / 2026-08-15 | active |
