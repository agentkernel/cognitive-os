...
|---|---|---|---|---|---|---|---|
| `lease/personal/P9-T05/pi-nested-stage-timing` | P9-T05/D01-D04 Pi route nested per-request stage timing and Provider usage exposure | Lane-PERS | `personal/P9-T05-pi-nested-stage-timing` | `packages/pi-cognitiveos/src/pi-route-observation.ts`, `packages/pi-cognitiveos/src/pi-route-observation.test.ts`, `packages/pi-cognitiveos/src/daemon-client.ts`, `packages/pi-cognitiveos/src/daemon-client.test.ts`, `packages/pi-cognitiveos/src/daemon-provider.ts`, `packages/pi-cognitiveos/src/daemon-provider.test.ts`, `packages/pi-cognitiveos/src/extension.ts`, `packages/pi-cognitiveos/src/index.ts`, `packages/pi-cognitiveos/src/test-support.ts`, `apps/kernel-server/src/personal/route_observation.rs`, `apps/kernel-server/src/personal/provider_proxy.rs`, `apps/kernel-server/src/personal/server.rs`, `apps/kernel-server/src/personal/mod.rs`, `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`, `docs/plan/PROGRESS.md`, `docs/checkpoints/20260813-personal-p9-t05-pi-nested-stage-timing-validation-report.md`, `docs/checkpoints/20260813-personal-p9-t05-pi-nested-stage-timing-closure.md`, `handbook/en/user/pi-shell.md`, `handbook/zh-CN/user/pi-shell.md`, `handbook/en/developer/typescript-clients.md`, `handbook/zh-CN/developer/typescript-clients.md`, `handbook/en/developer/daemon-and-http.md`, `handbook/zh-CN/developer/daemon-and-http.md`, `handbook/en/reference/environment-variables.md`, `handbook/zh-CN/reference/environment-variables.md`, `handbook/en/reference/http-api.md`, `handbook/zh-CN/reference/http-api.md`, `handbook/_meta/annotations/env-vars.json`, `handbook/_meta/annotations/http-routes.json`, `tools/src/generate-handbook.mjs` | personal-agent | 2026-08-13 / 2026-08-13 | active |
