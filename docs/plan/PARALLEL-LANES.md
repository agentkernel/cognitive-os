...
|---|---|---|---|---|---|---|---|
| `lease/personal/P2-T19/memory-skill-agent-consumer` | P2-T19/D01-D05 production governed Memory/Skill Agent consumer | Lane-RUN | `personal/P2-T19-memory-skill-consumer` | `apps/kernel-server/src/personal/resource_api.rs`; `apps/kernel-server/src/personal/server.rs`; `apps/kernel-server/src/personal/scheduler_authority/context.rs`; `apps/kernel-server/src/personal/scheduler_authority/types.rs`; `apps/kernel-server/src/personal/scheduler_authority/tests.rs`; `apps/kernel-server/tests/p4_t05_resource_api.rs`; `crates/cognitive-kernel/src/ports.rs`; `crates/cognitive-store/src/sqlite/schema.rs`; `crates/cognitive-store/src/sqlite/store.rs`; `crates/cognitive-store/src/sqlite/context.rs`; `crates/cognitive-store/src/sqlite/memory.rs`; `crates/cognitive-store/src/sqlite/harness_skill.rs`; `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`; `docs/plan/PROGRESS.md`; `docs/checkpoints/20260813-personal-p2-t19-memory-skill-agent-consumer-validation.md`; `handbook/en/developer/daemon-and-http.md`; `handbook/zh-CN/developer/daemon-and-http.md`; `handbook/en/developer/execution-chain-status.md`; `handbook/zh-CN/developer/execution-chain-status.md`; `handbook/en/developer/task-pipeline.md`; `handbook/zh-CN/developer/task-pipeline.md`; `handbook/en/developer/memory-and-skill.md`; `handbook/zh-CN/developer/memory-and-skill.md`; `handbook/en/developer/context-and-artifact.md`; `handbook/zh-CN/developer/context-and-artifact.md`; `handbook/en/reference/http-api.md`; `handbook/zh-CN/reference/http-api.md`; `handbook/en/reference/capability-status.md`; `handbook/zh-CN/reference/capability-status.md`; `handbook/en/user/operations-and-recovery.md`; `handbook/zh-CN/user/operations-and-recovery.md`; `handbook/en/ai/validation-commands.md`; `handbook/zh-CN/ai/validation-commands.md` | `cursor-subagent-msconsumer-20260813` | 2026-08-13 / 2026-08-13 | active |
