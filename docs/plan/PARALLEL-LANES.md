...
|---|---|---|---|---|---|---|---|
| `lease/personal/P9-T04/comprehensive-performance-campaign` | P9-T04/D10 remaining T2-T8 governed-Task scenario definitions | Lane-RUN | `personal/P9-T04-comprehensive-performance-campaign` | `crates/cognitive-runtime/Cargo.toml`; `crates/cognitive-runtime/src/lib.rs`; `crates/cognitive-runtime/src/campaign_report.rs`; `crates/cognitive-runtime/src/task_scenario_harness.rs`; `crates/cognitive-runtime/src/provider_route_policy.rs`; `crates/cognitive-runtime/src/campaign_runner.rs`; `crates/cognitive-runtime/src/loopback_transport.rs`; `crates/cognitive-runtime/src/resource_sampler.rs`; `crates/cognitive-runtime/src/task_scenario_harness.rs`; `crates/cognitive-runtime/src/provider_route_policy.rs`; `tools/personal/p9-t04-l3-provider-route-runner.mjs`; `tools/personal/p9-t04-l3-cold-journey-runner.sh`; `tools/personal/p1-t09-product-route-smoke.sh`; `crates/cognitive-runtime/src/performance_campaign.rs`; `crates/cognitive-runtime/src/bin/p9_t04_l0_l1_campaign_runner.rs`; `apps/kernel-server/src/personal/provider_proxy.rs`; `apps/kernel-server/src/personal/server.rs`; `packages/pi-cognitiveos/src/daemon-client.ts`; `packages/pi-cognitiveos/src/daemon-client.test.ts`; `packages/pi-cognitiveos/src/daemon-provider.ts`; `packages/pi-cognitiveos/src/daemon-provider.test.ts`; `packages/pi-cognitiveos/src/pi-api.ts`; `packages/pi-cognitiveos/src/test-support.ts`; `docs/adr/0051-comprehensive-performance-campaign.md`; `docs/checkpoints/20260812-personal-p9-t04-performance-campaign-preregistration.md`; `docs/evaluation/personal-performance-benchmark-execution-plan.md`; `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`; `docs/plan/PROGRESS.md`; `docs/plan/personal-trace.yaml`; `plan.md` | Cursor continuous campaign session | 2026-08-12 / 2026-08-12 | active |
