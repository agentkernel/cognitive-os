...
|---|---|---|---|---|---|---|---|
| `lease/personal/P7-T02/lifecycle-backup` | P7-T02/D02 Memory/Skill/bindings export | Lane-RUN | `personal/P7-T02-lifecycle-backup` | `crates/cognitive-store/src/personal_backup.rs`; `crates/cognitive-store/src/lib.rs`; `docs/plan/PROGRESS.md`; `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`; `docs/checkpoints/` | cursor-agent/P7-T02-D02 | 2026-08-11 / 2026-08-11 | active |
