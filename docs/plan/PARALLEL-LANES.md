...
|---|---|---|---|---|---|---|---|
| `lease/personal/P8-T03/non-pi-agent` | P8-T03/D01 Codex fixture identity | Lane-RUN | `personal/P8-T03-non-pi-agent` | `crates/cognitive-runtime/src/non_pi_agent.rs`; `crates/cognitive-runtime/src/lib.rs`; `docs/plan/PROGRESS.md`; `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`; `docs/checkpoints/` | cursor-agent/P8-T03-D01 | 2026-08-11 / 2026-08-11 | active |
