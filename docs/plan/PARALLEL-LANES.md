...
|---|---|---|---|---|
| `lease/personal/P7-T07/windows-install-surface` | P7-T07/D01-D04 Windows install surface | `personal/P7-T07-windows-install-surface` | 2026-08-12 | D01 Windows Credential Manager backend, D02 inspectable installer/scheduled-task templates, and D03 B01-W gate authoring are complete with required CI `31570126985` passed at `13e772a` (Draft PR #200). The task is **blocked** on B01-W execution prerequisites (Windows release artifacts, `B01-W-DESKTOP-001` provisioning, operator); branch and Draft PR are retained. Blocked-closure record: `docs/checkpoints/20260812-personal-p7-t07-windows-install-closure.md`. |
