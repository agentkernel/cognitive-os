...
|---|---|---|---|---|---|---|---|
| `lease/personal/P9-T01/windows-ci-recovery` | P9-T01/D01 corrective required-CI recovery | Lane-RUN | `personal/P9-T01-async-decision-gate` | `.github/workflows/ci.yml`; `apps/kernel-server/tests/p1_t07_provider_proxy.rs`; `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`; `docs/plan/PROGRESS.md` | Cursor performance campaign session | 2026-08-12 / 2026-08-12 | active |
