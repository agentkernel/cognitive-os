...
| `crates/cognitive-conformance`、`tools/`、`.github/workflows/` | Lane-CFR | `lane/cfr-m5-intent-authority-slice` | CFR-M5 Intent Authority 已交付（INTENT-SUPERSEDE-002 / INTENT-ACCEPTANCE-007）；pins 57/27；clients 自动防漂移任务待领取 |
