...
|---|---|---|---|
| `crates/cognitive-contracts`、`packages/contracts-ts`、`tests/golden/`、`specs/schemas/`（迁移期） | Lane-CTR | `lane/ctr-config-authority-contract` | CA-0 合同充分性裁决 **NO-GO**；D-022 open，阻断 CA-1～CA-8；未改 normative 机器资产 |
