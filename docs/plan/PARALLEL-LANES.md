...
|---|---|---|---|---|---|---|---|
| `lease/personal/P9-T07/pi-nested-stage-timing` | P9-T07/D04 terminal schema, acceptance mapping and required CI | Lane-RUN | `personal/P9-T05-pi-nested-stage-timing` (legacy name retained after corrective task renumber; no history rewrite) | `packages/pi-cognitiveos/src/pi-route-observation.ts`, `packages/pi-cognitiveos/src/pi-route-observation.test.ts`, `packages/pi-cognitiveos/src/pi-route-observation-negatives.test.ts`, `packages/pi-cognitiveos/src/daemon-client.ts`, `packages/pi-cognitiveos/src/daemon-client.test.ts`, `packages/pi-cognitiveos/src/daemon-provider.ts`, `packages/pi-cognitiveos/src/daemon-provider.test.ts`, `packages/pi-cognitiveos/src/extension.ts`, `packages/pi-cognitiveos/src/index.ts`, `packages/pi-cognitiveos/src/test-support.ts`, `apps/kernel-server/src/personal/route_observation.rs`, `apps/kernel-server/src/personal/provider_proxy.rs`, `apps/kernel-server/src/personal/server.rs`, `apps/kernel-server/src/personal/mod.rs`, `apps/kernel-server/tests/p9_t07_route_observation.rs`, `docs/plan/PERSONAL-DEVELOPMENT-PLAN.md`, `docs/plan/PROGRESS.md`, `docs/checkpoints/20260813-personal-p9-t07-pi-nested-stage-timing-validation-report.md`, `docs/checkpoints/20260813-personal-p9-t07-pi-nested-stage-timing-closure.md`, `handbook/en/user/pi-shell.md`, `handbook/zh-CN/user/pi-shell.md`, `handbook/en/user/provider-and-secrets.md`, `handbook/zh-CN/user/provider-and-secrets.md`, `handbook/en/developer/typescript-clients.md`, `handbook/zh-CN/developer/typescript-clients.md`, `handbook/en/developer/architecture-overview.md`, `handbook/zh-CN/developer/architecture-overview.md`, `handbook/en/developer/daemon-and-http.md`, `handbook/zh-CN/developer/daemon-and-http.md`, `handbook/en/developer/execution-chain-status.md`, `handbook/zh-CN/developer/execution-chain-status.md`, `handbook/en/reference/capability-status.md`, `handbook/zh-CN/reference/capability-status.md`, `handbook/en/reference/environment-variables.md`, `handbook/zh-CN/reference/environment-variables.md`, `handbook/en/reference/http-api.md`, `handbook/zh-CN/reference/http-api.md`, `handbook/en/user/known-limitations.md`, `handbook/zh-CN/user/known-limitations.md`, `handbook/en/user/what-is-personal.md`, `handbook/zh-CN/user/what-is-personal.md`, `handbook/_meta/annotations/env-vars.json`, `handbook/_meta/annotations/http-routes.json`, `tools/src/generate-handbook.mjs` | cursor-gpt-5.6-sol-20260814 | 2026-08-13 / 2026-08-14 | active |
