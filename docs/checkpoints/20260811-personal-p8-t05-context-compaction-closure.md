...
| final acceptance / docs / PR / lease / branch closure | this checkpoint; required CI pending on Draft PR #189 HEAD `e15492a` |
...
Required Ubuntu/Windows CI for HEAD `e15492aa2c64d109b70623e3ab3b3e60590f3f73`
is recorded when green. PR #189 is the task closure PR. Lease
`lease/personal/P8-T05/context-compaction` closes with merge; task branch
