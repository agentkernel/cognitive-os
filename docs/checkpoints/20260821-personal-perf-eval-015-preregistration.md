...
| B5 | 1 h **pass**; 8 h running (continuation) | 60/60 1 h; 8 h min 0–59 retained then CLI 5 s kill on ~1.09 GiB store copy; continuation pid 403482 kernel-server-direct restart health 200; 24 h default deferred |
