...
| 2026-08-31 | `cargo test -p cognitive-store --test p11_t11_memory` | **pass** 4/4 | `DEV-LINUX-NATIVE-01` | `f1dca3e038104c0f03879a2a368a635d4b876a2c` | Retest after fixture bound at `eb6ee7d6`. FAIL_TAIL none. N5 remains T10 `p11_t10_memory_admission_cannot_swallow_vault_files`. |
| 2026-08-31 | `cargo test -p kernel-server --bin kernel-server -- p11_t11` | **pass** 2/2 | `DEV-LINUX-NATIVE-01` | `f1dca3e038104c0f03879a2a368a635d4b876a2c` | `p11_t11_management_correct_is_fail_closed_for_cross_scope_and_secret`; `p11_t11_scoped_recall_privacy_forget_and_task_channel`. FAIL_TAIL none. |
| 2026-08-31 | Host filesystem / privacy-rebuild E2E | **not-run** | unqualified | `f1dca3e038104c0f03879a2a368a635d4b876a2c` | Card allows `not-run` until the host route is qualified. Never pass. |
