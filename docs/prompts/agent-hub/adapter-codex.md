...
- dossier：[adapters/tier1/codex.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/tier1/codex.md)
- 计划：[docs/plan/agent-hub/adapter-codex.md](../../plan/agent-hub/adapter-codex.md)
