...
- canonical：[adapters/README.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/README.md)、[capability-matrix.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/capability-matrix.md)、[interface-layering.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/interface-layering.md)、[sources/provider-interfaces-ledger.md](../../../apps/cognitiveos-console/docs/agent-hub/sources/provider-interfaces-ledger.md)
- 计划：[docs/plan/agent-hub/lane-contract-capability.md](../../plan/agent-hub/lane-contract-capability.md)
