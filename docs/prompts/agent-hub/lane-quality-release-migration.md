...
- canonical：[traceability/evidence-index.md](../../../apps/cognitiveos-console/docs/agent-hub/traceability/evidence-index.md)、[architecture/relay-pairing-and-migration.md §6](../../../apps/cognitiveos-console/docs/agent-hub/architecture/relay-pairing-and-migration.md#6-direct--governed-迁移evidence-only)
- 计划：[docs/plan/agent-hub/lane-quality-release-migration.md](../../plan/agent-hub/lane-quality-release-migration.md)
