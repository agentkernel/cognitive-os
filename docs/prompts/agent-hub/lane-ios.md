...
- canonical：[product/journeys-and-screens.md §5](../../../apps/cognitiveos-console/docs/agent-hub/product/journeys-and-screens.md#5-手机-remote-companion-旅程要点)、[states-content-and-accessibility.md §4.2](../../../apps/cognitiveos-console/docs/agent-hub/product/states-content-and-accessibility.md#42-iphone)
- 计划：[docs/plan/agent-hub/lane-ios.md](../../plan/agent-hub/lane-ios.md)
