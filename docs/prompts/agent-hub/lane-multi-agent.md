...
- canonical：[collaboration/lead-workers.md](../../../apps/cognitiveos-console/docs/agent-hub/collaboration/lead-workers.md)
- 计划：[docs/plan/agent-hub/lane-multi-agent.md](../../plan/agent-hub/lane-multi-agent.md)
