...
- dossier：[adapters/tier1/openhands.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/tier1/openhands.md)
- 计划：[docs/plan/agent-hub/adapter-openhands.md](../../plan/agent-hub/adapter-openhands.md)
