...
- canonical：[architecture/session-and-file-adoption.md](../../../apps/cognitiveos-console/docs/agent-hub/architecture/session-and-file-adoption.md)
- 计划：[docs/plan/agent-hub/lane-session-file.md](../../plan/agent-hub/lane-session-file.md)
