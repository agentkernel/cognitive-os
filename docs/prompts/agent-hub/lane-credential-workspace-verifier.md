...
- canonical：[security/security-and-credentials.md](../../../apps/cognitiveos-console/docs/agent-hub/security/security-and-credentials.md)、[collaboration/lead-workers.md](../../../apps/cognitiveos-console/docs/agent-hub/collaboration/lead-workers.md)
- 计划：[docs/plan/agent-hub/lane-credential-workspace-verifier.md](../../plan/agent-hub/lane-credential-workspace-verifier.md)
