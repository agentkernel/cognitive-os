...
- canonical：[states-content-and-accessibility.md §4.3](../../../apps/cognitiveos-console/docs/agent-hub/product/states-content-and-accessibility.md#43-android-phone)
- 计划：[docs/plan/agent-hub/lane-android.md](../../plan/agent-hub/lane-android.md)
