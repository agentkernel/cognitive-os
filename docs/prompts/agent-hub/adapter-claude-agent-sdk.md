...
- dossier：[adapters/tier1/claude-agent-sdk.md](../../../apps/cognitiveos-console/docs/agent-hub/adapters/tier1/claude-agent-sdk.md)
- 计划：[docs/plan/agent-hub/adapter-claude-agent-sdk.md](../../plan/agent-hub/adapter-claude-agent-sdk.md)
