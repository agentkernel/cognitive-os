...
- canonical：[architecture/takeover-architecture.md](../../../apps/cognitiveos-console/docs/agent-hub/architecture/takeover-architecture.md)、[security/security-and-credentials.md](../../../apps/cognitiveos-console/docs/agent-hub/security/security-and-credentials.md)
- 计划：[docs/plan/agent-hub/lane-host-control-ledger.md](../../plan/agent-hub/lane-host-control-ledger.md)
