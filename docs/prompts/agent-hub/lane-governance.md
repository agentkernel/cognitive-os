...
- canonical：[apps/cognitiveos-console/docs/agent-hub/GOVERNANCE.md](../../../apps/cognitiveos-console/docs/agent-hub/GOVERNANCE.md)、[decisions/decision-log.md](../../../apps/cognitiveos-console/docs/agent-hub/decisions/decision-log.md)
- 计划：[docs/plan/agent-hub/lane-governance.md](../../plan/agent-hub/lane-governance.md)
