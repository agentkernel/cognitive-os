...
- canonical：[architecture/relay-pairing-and-migration.md](../../../apps/cognitiveos-console/docs/agent-hub/architecture/relay-pairing-and-migration.md)
- 计划：[docs/plan/agent-hub/lane-relay-pairing.md](../../plan/agent-hub/lane-relay-pairing.md)
