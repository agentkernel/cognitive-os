...
1. 每份提示词已内联公共前缀（源头 [../common-prefix.md](../common-prefix.md)）。
2. 先读 canonical 文档（[apps/cognitiveos-console/docs/agent-hub/README.md](../../../apps/cognitiveos-console/docs/agent-hub/README.md)）、Master 计划（[../../plan/agent-hub-development-plan.md](../../plan/agent-hub-development-plan.md)）与对应车道计划。
