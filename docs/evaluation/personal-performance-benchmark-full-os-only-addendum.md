...
- Status: **2026-08-16 re-freeze in B0** at `main@1e71344a` under `lease/personal/EVAL-20260816/full-os-only-refreeze`. C0 qualification recorded (9/9 retained). C1/C2 fixtures `not-run`. Independent reviewer `not_reviewed` (B1 forbidden). Do not reuse `/home/hal9001/perfeval004`, `48284`, or the 2026-08-15 SecretStore item.
