...
| B5 8 h | running (pid 408358) | Minutes 0–303 contiguous, `local_non_ok=0`; 31/31 G1 pairs both True; 0 arm timeouts. Minute-300: `stop_rc=1`, stale lock pid 409767 cleared, health 200 in **148.8 s**, kernel **411171**. Broker 369469 on `48406`. Residue untouched. 24 h default deferred |
...
minute **303**, next hourly restart at 360). Do not start a second
