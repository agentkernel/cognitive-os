...
| B5 8 h | running (pid 408358) | Minutes 0–324 contiguous, `local_non_ok=0`; 33/33 G1 pairs both True; 0 arm timeouts. Kernel **411171** still live after minute-300 restart (health 200 in 148.8 s). Broker 369469 on `48406`. Residue untouched. 24 h default deferred |
...
minute **324**, next hourly restart at 360). Do not start a second
