...
| B5 8 h | running (pid 408358) | Minutes 0–363 contiguous, `local_non_ok=0`; 37/37 G1 pairs both True; 0 arm timeouts. Minute-360: `stop_rc=1`, stale lock pid 411171 cleared, health 200 in **164.3 s**, kernel **412608**. Broker 369469 on `48406`. Residue untouched. 24 h default deferred |
...
minute **363**, next hourly restart at 420). Do not start a second
