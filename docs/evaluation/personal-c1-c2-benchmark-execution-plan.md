...
- Status: **2026-08-16 re-freeze; B0 C0 pass; B1 C0 pass** at `main@1e71344a`; C1/C2 workspace bytes frozen, paired adapter `not-run`; reviewer `not_reviewed` (claim ceiling, not a B1 mutex)
