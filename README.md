...
| 路径 | 内容 |
|---|---|
| [docs/architecture/cognitiveos/CognitiveOS-Architecture.md](./docs/architecture/cognitiveos/CognitiveOS-Architecture.md) | 白皮书 v1.0.2（informative，非机器合同） |
| [docs/architecture/cognitiveos/RFC-0001-cognitiveos-governance-context-access.md](./docs/architecture/cognitiveos/RFC-0001-cognitiveos-governance-context-access.md) | 治理/Context/访问 normative companion RFC v0.2 |
| [specs/](./specs) | companion 规范、registry、状态迁移表与 JSON Schema（draft 2020-12）；具体数量由一致性检查报告 |
| [docs/architecture/cognitiveos/CognitiveOS-Review-Conclusions.md](./docs/architecture/cognitiveos/CognitiveOS-Review-Conclusions.md) · [docs/architecture/cognitiveos/CognitiveOS-Architecture-Independent-Review.md](./docs/architecture/cognitiveos/CognitiveOS-Architecture-Independent-Review.md) | 两轮评审（V1–V17 / IMP-01~18 / F-001~F-030） |
...
| [docs/architecture/cognitiveos/](./docs/architecture/cognitiveos) | CognitiveOS 白皮书、RFC-0001、冻结评审 |
