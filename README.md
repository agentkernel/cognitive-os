...
| [apps/cognitiveos-console/](apps/cognitiveos-console/) | Console 产品设计（`planned`，独立车道，见其 PRODUCT-DESIGN.md） |
...
| [docs/clients/](docs/clients/) | PC + 手机客户端目录的 canonical 索引、边界与阅读导航 |
