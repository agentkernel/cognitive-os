...
fn empty_layout_migrates_both_databases_to_latest() {
    ...
    assert!(table_exists(
        &layout.authority_database_path(),
        "skill_binding_revocations"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "skill_revision_lineage"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
    ...
    assert!(table_exists(
        &layout.authority_database_path(),
        "memory_skill_consumption_records"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "provider_accounts"
    ...
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_standing_approval_policy"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_hosted_dsh_child"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_vault_document"
    ...
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_routine_revision"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_routine_occurrence"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_windows_host_home"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_windows_host_daemon"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_windows_host_recovery"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_x_connector_account"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p11_x_connector_preview"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
    ...
    assert!(table_exists(
        &layout.authority_database_path(),
        "p13_attempt_artifact"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p13_artifact_evidence"
    ));
    assert!(table_exists(
        &layout.authority_database_path(),
        "p13_run_acceptance"
