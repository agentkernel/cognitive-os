...
- Prototype identity: owner-approved 2026-08-30 current chrome is
  personal-20-opc-e2e-optimized-v9. v8 is the prior approved baseline (not overwritten). Archived V2 is not current chrome. Resource Manager family semantics are unchanged.
