...
- UI is Today/Projects/Knowledge with bottom Settings and one persistent
  ...
  exists; Project aggregate walking skeleton is Personal-private; Markdown Vault import/index/conflict (`P11-T10`) is on `main` (files are not Project authority); scoped Memory admission/privacy/forget (`P11-T11`) is on `main`; `P11-T02`/`T08`/`T13` remain separate claims). Development-prep index
...
- `P11-T02`–`T15` plan cards were **aligned to Personal 2.0.0 chrome on
  ...
  `P11-T02`/`T08`/`T13` remain separate claims. Prep index:
  [`personal-2.0.0-dev-prep-index.md`](../../../docs/architecture/personal-2.0.0-dev-prep-index.md).
