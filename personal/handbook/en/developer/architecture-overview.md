...
- `P11-T02`–`T15` plan cards were **aligned to Personal 2.0.0 chrome on
  ...
  X/Twitter connector walking skeleton (`P11-T14`) is on `main` (live X `not-run`; not P0 hero). Phase 12 is registered (`P12-T01` done; `P12-T02` wizard on `main`; `P12-T03` four submenus on `main`; `P12-T04` member-config on `main`; `P12-T05` Today packets in-progress; not T15). Prep index:
  [`personal-2.0.0-dev-prep-index.md`](../../../docs/architecture/personal-2.0.0-dev-prep-index.md).
