...
scheduler tick. Two databases under XDG state: **authority** (migrations v1–v38) and
...
## Authority migration map (v1–v38)
...
v1–v17 only; v18–v38 tables exist only after `prepare_personal_databases` runs the
