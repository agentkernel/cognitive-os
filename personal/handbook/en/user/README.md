...
Product origin is daemon `/ui/`. Canvas v9 is the design authority and
completion target for that `/ui/` (IA + visual + Owner-facing copy). Honesty /
fail-closed and axioms stay. NVDA/200%/host-theme remain `not-run`.
