...
| `crates/cognitive-store` | SQLite WAL adapter: migrations v1–v25 (+installation v1–v4), scheduler leases, Memory/Skill/Context/Artifact stores, Provider Control Plane, secret-excluding backup archives | `sqlite/`, `migration.rs`, `personal_db.rs` (`prepare_personal_databases`), `scheduler.rs`, `provider_control_plane.rs`, `personal_backup.rs` |
