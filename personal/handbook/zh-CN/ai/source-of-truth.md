...
fingerprint: "sha256:977107815ba39ebf2930fa163e08ef28280f9525ddc7bc7386359a62157cbbdf"
non_claims:
...
合同语义方面：精确机器资产（`core/specs/registry/`、`core/specs/schemas/`、`core/specs/transitions/`、
`core/conformance/vectors/`）优先于 normative 伴随文档（`core/specs/*/README.md`、
[`RFC-0001`](../../../../core/docs/architecture/RFC-0001-cognitiveos-governance-context-access.md)、
[`docs/standards/`](../../../../docs/standards/normative-source-and-versioning.md)），后者又优先于 informative 白皮书
（[`core/docs/architecture/CognitiveOS-Architecture.md`](../../../../core/docs/architecture/CognitiveOS-Architecture.md)）。不可变公理只存在于
