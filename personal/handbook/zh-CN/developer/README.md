...
native mobile/E2E relay remote 属于 2.1。owner 批准的当前交互原型是
`personal-20-opc-e2e-optimized-v9`（Canvas 规格，不是 `/ui/`）。单模块维护入口：
...
6. [存储与迁移](store-and-migrations.md) —— SQLite 布局 v1–v26
