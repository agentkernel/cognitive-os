...
| v28 | Personal-private 对话档案（`p11_conversation_archive`），新标识 `cognitiveos.personal.conversation-archive/0.1`。白名单投递发言落档案行；chatter 只留 `p11_speech_audit`。ADR-0058 `conversation-projection/0.1` 不被 coerce。档案行只是观察，不是 Task/Project 完成。 |
