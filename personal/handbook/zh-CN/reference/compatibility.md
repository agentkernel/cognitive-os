...
`Requires-environment`。native Windows OPC 开发宿主已于 2026-09-05 指定为本机
（OS 版本不是供给门槛），尚未由 `P13-T13` 资格化。B01-W 未 provision。目标 runtime 是 preinstalled managed DSH；Pi 是 hidden Personal
