...
资格化为本机（OS 版本不是供给门槛）；`P11-T15` 在本机 **done**（N=15 冻结于 `main@4ca9b046`；1 pass / 1 partial / 13 not-run）；缺能力的挂单格保持 `not-run`。B01-W 未 provision。目标 runtime 是 preinstalled managed DSH；Pi 是 hidden Personal
