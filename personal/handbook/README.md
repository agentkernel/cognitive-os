...
- Machine contracts / 机器合同: [`specs/`](../specs/core/README.md), [`conformance/`](../conformance/README.md), [`docs/standards/`](../docs/standards/docs-sync-contract.md)
- Stable product/architecture design / 产品与架构设计: [`docs/product/personal/`](../docs/product/personal/README.md), [`docs/architecture/personal/`](../docs/architecture/personal/README.md)
...
- Sync obligations / 同步义务: [`handbook/_meta/sync-policy.md`](./_meta/sync-policy.md)
