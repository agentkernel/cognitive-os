...
- 既有 conformance vectors：计数以 [PROGRESS](https://github.com/agentkernel/cognitive-os/blob/main/docs/plan/PROGRESS.md) 实测为准（2026-07-26：85 份 60 `pass` / 25 `not-run`）；这些结果不是 Agent Hub 平台或实现证据。
