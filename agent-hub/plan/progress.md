...
>
> 只跟踪 Agent Hub 计划/文档进度；工程里程碑真相以全局 [../PROGRESS.md](https://github.com/agentkernel/cognitive-os/blob/main/docs/plan/PROGRESS.md) 为准。不在此声明实现/测试/Profile 状态。
...
- 既有 conformance vectors：计数以 [PROGRESS](https://github.com/agentkernel/cognitive-os/blob/main/docs/plan/PROGRESS.md) 实测为准（2026-07-26：85 份 60 pass / 25 not-run）；Agent Hub 平台证据仍为 none。
