...
- **内容**：
  ...
  - 证据分类与五态结果口径 canonical：[docs/standards/conformance-evidence.md](https://github.com/agentkernel/cognitive-os/blob/main/docs/standards/conformance-evidence.md)（只引用不复制）。
