...
| conformance 向量 | 声明式向量集（计数以 [PROGRESS](../../../docs/plan/PROGRESS.md) 实测为准）、15 测试层 | Lane-CFR runner；[conformance/README.md](../../../conformance/README.md) | 2026-07-26 快照：85 份 60 `pass` / 25 `not-run`；已执行项不构成客户端平台证据 |
