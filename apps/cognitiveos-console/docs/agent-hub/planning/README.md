...
- Master Development Plan：[docs/plan/agent-hub-development-plan.md](../../../../../docs/plan/agent-hub-development-plan.md)
- 宏车道与子车道计划目录：[docs/plan/agent-hub/](../../../../../docs/plan/agent-hub/)
  - README、milestones、dependency-dag、progress、risk-register、evidence-index
  - 12 个宏车道计划 + 6 个 Tier 1 Adapter 子车道计划
- 提示词目录：[docs/prompts/agent-hub/](../../../../../docs/prompts/agent-hub/)
