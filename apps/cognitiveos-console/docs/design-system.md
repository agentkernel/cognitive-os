...
> 品牌关键词：亲和易懂、未来感、强大可控
>
> Agent Hub 关系：Agent Hub 复用本设计系统，并额外要求 Direct/Governed 模式、接管层级与事实来源的视觉不可混同（见 [agent-hub/product/states-content-and-accessibility.md](./agent-hub/product/states-content-and-accessibility.md)）；不新增并列设计系统。
